...
export class MessageForwardNode extends CommonBase {
	...
	public static constructor_new(node_id_arg: Uint8Array, short_channel_id_arg: Option_u64Z): MessageForwardNode {
		const ret: bigint = bindings.MessageForwardNode_new(bindings.encodeUint8Array(bindings.check_arr_len(node_id_arg, 33)), CommonBase.get_ptr_of(short_channel_id_arg));
