 ...
 */
export class LSPS1ClientHandler extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS1ClientHandler_free);
	}
	 ...
	 */
	public request_supported_options(counterparty_node_id: Uint8Array): LSPSRequestId {
		const ret: bigint = bindings.LSPS1ClientHandler_request_supported_options(this.ptr, bindings.encodeUint8Array(counterparty_node_id));
		const ret_hu_conv: LSPSRequestId = new LSPSRequestId(null, ret);
	 ...
	 */
	public create_order(counterparty_node_id: Uint8Array, order: LSPS1OrderParams, refund_onchain_address: Option_AddressZ): LSPSRequestId {
		const ret: bigint = bindings.LSPS1ClientHandler_create_order(this.ptr, bindings.encodeUint8Array(counterparty_node_id), CommonBase.get_ptr_of(order), CommonBase.get_ptr_of(refund_onchain_address));
		const ret_hu_conv: LSPSRequestId = new LSPSRequestId(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		CommonBase.add_ref_from(this, refund_onchain_address);
		return ret_hu_conv;
	}
	 ...
	 */
	public check_order_status(counterparty_node_id: Uint8Array, order_id: LSPS1OrderId): LSPSRequestId {
		const ret: bigint = bindings.LSPS1ClientHandler_check_order_status(this.ptr, bindings.encodeUint8Array(counterparty_node_id), CommonBase.get_ptr_of(order_id));
		const ret_hu_conv: LSPSRequestId = new LSPSRequestId(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
