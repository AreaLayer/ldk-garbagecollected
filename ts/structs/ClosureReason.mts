...
export class ClosureReason extends CommonBase {
	 ...
	 */
	public static constructor_holder_force_closed(broadcasted_latest_txn: Option_boolZ): ClosureReason {
		const ret: bigint = bindings.ClosureReason_holder_force_closed(CommonBase.get_ptr_of(broadcasted_latest_txn));
		const ret_hu_conv: ClosureReason = ClosureReason.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_htlcs_timed_out(): ClosureReason {
		const ret: bigint = bindings.ClosureReason_htlcs_timed_out();
		const ret_hu_conv: ClosureReason = ClosureReason.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
