...
export class ChannelMonitor extends CommonBase {
	 ...
	 */
	public process_pending_events(handler: EventHandler): Result_NoneReplayEventZ {
		const ret: bigint = bindings.ChannelMonitor_process_pending_events(this.ptr, CommonBase.get_ptr_of(handler));
	 ...
	 */
	public is_fully_resolved(logger: Logger): boolean {
		const ret: boolean = bindings.ChannelMonitor_is_fully_resolved(this.ptr, CommonBase.get_ptr_of(logger));
		CommonBase.add_ref_from(this, logger);
		return ret;
	}
