 ...
 */
export class LSPS0ListProtocolsRequest extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS0ListProtocolsRequest_free);
	}

	/**
	 * Constructs a new LSPS0ListProtocolsRequest given each field
	 */
	public static constructor_new(): LSPS0ListProtocolsRequest {
		const ret: bigint = bindings.LSPS0ListProtocolsRequest_new();
		const ret_hu_conv: LSPS0ListProtocolsRequest = new LSPS0ListProtocolsRequest(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS0ListProtocolsRequest_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS0ListProtocolsRequest {
		const ret: bigint = bindings.LSPS0ListProtocolsRequest_clone(this.ptr);
		const ret_hu_conv: LSPS0ListProtocolsRequest = new LSPS0ListProtocolsRequest(null, ret);
	 ...
	 */
	public eq(b: LSPS0ListProtocolsRequest): boolean {
		const ret: boolean = bindings.LSPS0ListProtocolsRequest_eq(this.ptr, CommonBase.get_ptr_of(b));
