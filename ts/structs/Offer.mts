...
export class Offer extends CommonBase {
	 ...
	 */
	public request_invoice_deriving_payer_id(expanded_key: ExpandedKey, entropy_source: EntropySource, payment_id: Uint8Array): Result_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ {
		const ret: bigint = bindings.Offer_request_invoice_deriving_payer_id(this.ptr, CommonBase.get_ptr_of(expanded_key), CommonBase.get_ptr_of(entropy_source), bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)));
		const ret_hu_conv: Result_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ = Result_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ.constr_from_ptr(ret);
	 ...
	 * [`InvoiceRequest::payer_id`]: crate::offers::invoice_request::InvoiceRequest::payer_id
	 */
	public request_invoice_deriving_metadata(payer_id: Uint8Array, expanded_key: ExpandedKey, entropy_source: EntropySource, payment_id: Uint8Array): Result_InvoiceRequestWithExplicitPayerIdBuilderBolt12SemanticErrorZ {
		const ret: bigint = bindings.Offer_request_invoice_deriving_metadata(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(payer_id, 33)), CommonBase.get_ptr_of(expanded_key), CommonBase.get_ptr_of(entropy_source), bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)));
		const ret_hu_conv: Result_InvoiceRequestWithExplicitPayerIdBuilderBolt12SemanticErrorZ = Result_InvoiceRequestWithExplicitPayerIdBuilderBolt12SemanticErrorZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(this, expanded_key);
		CommonBase.add_ref_from(this, entropy_source);
		return ret_hu_conv;
	}
	 ...
	 * [`InvoiceRequest`]: crate::offers::invoice_request::InvoiceRequest
	 */
	public request_invoice(metadata: Uint8Array, payer_id: Uint8Array): Result_InvoiceRequestWithExplicitPayerIdBuilderBolt12SemanticErrorZ {
		const ret: bigint = bindings.Offer_request_invoice(this.ptr, bindings.encodeUint8Array(metadata), bindings.encodeUint8Array(bindings.check_arr_len(payer_id, 33)));
		const ret_hu_conv: Result_InvoiceRequestWithExplicitPayerIdBuilderBolt12SemanticErrorZ = Result_InvoiceRequestWithExplicitPayerIdBuilderBolt12SemanticErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
