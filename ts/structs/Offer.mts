...
export class Offer extends CommonBase {
	 ...
	 */
	public request_invoice_deriving_payer_id(expanded_key: ExpandedKey, nonce: Nonce, payment_id: Uint8Array): Result_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ {
		const ret: bigint = bindings.Offer_request_invoice_deriving_payer_id(this.ptr, CommonBase.get_ptr_of(expanded_key), CommonBase.get_ptr_of(nonce), bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)));
	 ...
	 * [`InvoiceRequest::payer_id`]: crate::offers::invoice_request::InvoiceRequest::payer_id
	 */
	public request_invoice_deriving_metadata(payer_id: Uint8Array, expanded_key: ExpandedKey, nonce: Nonce, payment_id: Uint8Array): Result_InvoiceRequestWithExplicitPayerIdBuilderBolt12SemanticErrorZ {
		const ret: bigint = bindings.Offer_request_invoice_deriving_metadata(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(payer_id, 33)), CommonBase.get_ptr_of(expanded_key), CommonBase.get_ptr_of(nonce), bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)));
