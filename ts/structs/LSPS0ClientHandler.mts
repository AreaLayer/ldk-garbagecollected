 ...
 */
export class LSPS0ClientHandler extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS0ClientHandler_free);
	}
	 ...
	 */
	public list_protocols(counterparty_node_id: Uint8Array): void {
		bindings.LSPS0ClientHandler_list_protocols(this.ptr, bindings.encodeUint8Array(counterparty_node_id));
	}
