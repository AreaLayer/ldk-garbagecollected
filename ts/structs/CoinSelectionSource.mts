...
export class CoinSelectionSource extends CommonBase {
	...
	public select_confirmed_utxos(claim_id: Uint8Array, must_spend: Input[], must_pay_to: TxOut[], target_feerate_sat_per_1000_weight: number): Result_CoinSelectionNoneZ {
		const ret: bigint = bindings.CoinSelectionSource_select_confirmed_utxos(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(claim_id, 32)), bindings.encodeUint64Array(must_spend.map(must_spend_conv_7 => CommonBase.get_ptr_of(must_spend_conv_7))), bindings.encodeUint64Array(must_pay_to.map(must_pay_to_conv_7 => CommonBase.get_ptr_of(must_pay_to_conv_7))), target_feerate_sat_per_1000_weight);
