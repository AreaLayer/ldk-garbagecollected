...
export interface ChangeDestinationSourceInterface {
...
class LDKChangeDestinationSourceHolder {
	held: ChangeDestinationSource|null = null;
}
...
export class ChangeDestinationSource extends CommonBase {
	/* @internal */
	public bindings_instance: bindings.LDKChangeDestinationSource|null;
	...
	public static new_impl(arg: ChangeDestinationSourceInterface): ChangeDestinationSource {
		const impl_holder: LDKChangeDestinationSourceHolder = new LDKChangeDestinationSourceHolder();
		...
		} as bindings.LDKChangeDestinationSource;
		const ptr_idx: [bigint, number] = bindings.LDKChangeDestinationSource_new(structImplementation);
	...
	public get_change_destination_script(): Result_CVec_u8ZNoneZ {
		const ret: bigint = bindings.ChangeDestinationSource_get_change_destination_script(this.ptr);
