...
export class InitFeatures extends CommonBase {
	...
	public eq(b: InitFeatures): boolean {
		const ret: boolean = bindings.InitFeatures_eq(this.ptr, CommonBase.get_ptr_of(b));
	 ...
	 */
	public required_unknown_bits_from(other: InitFeatures): bigint[] {
	 ...
	 */
	public clear_upfront_shutdown_script(): InitFeatures {
		const ret: bigint = bindings.InitFeatures_clear_upfront_shutdown_script(this.ptr);
		const ret_hu_conv: InitFeatures = new InitFeatures(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public clear_shutdown_anysegwit(): InitFeatures {
		const ret: bigint = bindings.InitFeatures_clear_shutdown_anysegwit(this.ptr);
		const ret_hu_conv: InitFeatures = new InitFeatures(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public clear_wumbo(): InitFeatures {
		const ret: bigint = bindings.InitFeatures_clear_wumbo(this.ptr);
		const ret_hu_conv: InitFeatures = new InitFeatures(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
