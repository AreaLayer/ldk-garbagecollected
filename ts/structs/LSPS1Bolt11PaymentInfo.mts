 ...
 */
export class LSPS1Bolt11PaymentInfo extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS1Bolt11PaymentInfo_free);
	}

	/**
	 * Indicates the current state of the payment.
	 */
	public get_state(): LSPS1PaymentState {
		const ret: LSPS1PaymentState = bindings.LSPS1Bolt11PaymentInfo_get_state(this.ptr);
		return ret;
	}
	 ...
	 * Indicates the current state of the payment.
	 */
	public set_state(val: LSPS1PaymentState): void {
	 ...
	 */
	public get_expires_at(): LSPSDateTime {
		const ret: bigint = bindings.LSPS1Bolt11PaymentInfo_get_expires_at(this.ptr);
	 ...
	 * The datetime when the payment option expires.
	 */
	public set_expires_at(val: LSPSDateTime): void {
		bindings.LSPS1Bolt11PaymentInfo_set_expires_at(this.ptr, CommonBase.get_ptr_of(val));
	}

	/**
	 * The total fee the LSP will charge to open this channel in satoshi.
	 */
	public get_fee_total_sat(): bigint {
		const ret: bigint = bindings.LSPS1Bolt11PaymentInfo_get_fee_total_sat(this.ptr);
		return ret;
	}
	 ...
	 * The total fee the LSP will charge to open this channel in satoshi.
	 */
	public set_fee_total_sat(val: bigint): void {
	 ...
	 */
	public get_order_total_sat(): bigint {
		const ret: bigint = bindings.LSPS1Bolt11PaymentInfo_get_order_total_sat(this.ptr);
		return ret;
	}
	 ...
	 * The amount the client needs to pay to have the requested channel openend.
	 */
	public set_order_total_sat(val: bigint): void {
	 ...
	 */
	public get_invoice(): Bolt11Invoice {
		const ret: bigint = bindings.LSPS1Bolt11PaymentInfo_get_invoice(this.ptr);
	 ...
	 * A BOLT11 invoice the client can pay to have to channel opened.
	 */
	public set_invoice(val: Bolt11Invoice): void {
		bindings.LSPS1Bolt11PaymentInfo_set_invoice(this.ptr, CommonBase.get_ptr_of(val));
	}

	/**
	 * Constructs a new LSPS1Bolt11PaymentInfo given each field
	 */
	public static constructor_new(state_arg: LSPS1PaymentState, expires_at_arg: LSPSDateTime, fee_total_sat_arg: bigint, order_total_sat_arg: bigint, invoice_arg: Bolt11Invoice): LSPS1Bolt11PaymentInfo {
		const ret: bigint = bindings.LSPS1Bolt11PaymentInfo_new(state_arg, CommonBase.get_ptr_of(expires_at_arg), fee_total_sat_arg, order_total_sat_arg, CommonBase.get_ptr_of(invoice_arg));
		const ret_hu_conv: LSPS1Bolt11PaymentInfo = new LSPS1Bolt11PaymentInfo(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS1Bolt11PaymentInfo_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS1Bolt11PaymentInfo {
		const ret: bigint = bindings.LSPS1Bolt11PaymentInfo_clone(this.ptr);
		const ret_hu_conv: LSPS1Bolt11PaymentInfo = new LSPS1Bolt11PaymentInfo(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS1Bolt11PaymentInfo): boolean {
		const ret: boolean = bindings.LSPS1Bolt11PaymentInfo_eq(this.ptr, CommonBase.get_ptr_of(b));
