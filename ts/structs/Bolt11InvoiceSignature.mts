...
export class Bolt11InvoiceSignature extends CommonBase {
	...
	public set_a(val: Uint8Array): void {
		bindings.Bolt11InvoiceSignature_set_a(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 68)));
	}
	...
	public static constructor_new(a_arg: Uint8Array): Bolt11InvoiceSignature {
		const ret: bigint = bindings.Bolt11InvoiceSignature_new(bindings.encodeUint8Array(bindings.check_arr_len(a_arg, 68)));
