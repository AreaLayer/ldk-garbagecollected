...
export class OnionMessageHandler extends CommonBase {
	...
	public peer_connected(their_node_id: Uint8Array, init: Init, inbound: boolean): Result_NoneNoneZ {
		const ret: bigint = bindings.OnionMessageHandler_peer_connected(this.ptr, bindings.encodeUint8Array(their_node_id), CommonBase.get_ptr_of(init), inbound);
	...
	public provided_init_features(their_node_id: Uint8Array): InitFeatures {
		const ret: bigint = bindings.OnionMessageHandler_provided_init_features(this.ptr, bindings.encodeUint8Array(their_node_id));
