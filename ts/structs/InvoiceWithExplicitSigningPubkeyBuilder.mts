...
export class InvoiceWithExplicitSigningPubkeyBuilder extends CommonBase {
	...
	public fallback_v0_p2wsh(script_hash: Uint8Array): void {
		bindings.InvoiceWithExplicitSigningPubkeyBuilder_fallback_v0_p2wsh(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(script_hash, 32)));
	}
	...
	public fallback_v0_p2wpkh(pubkey_hash: Uint8Array): void {
		bindings.InvoiceWithExplicitSigningPubkeyBuilder_fallback_v0_p2wpkh(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(pubkey_hash, 20)));
	}
	...
	public fallback_v1_p2tr_tweaked(utput_key: Uint8Array): void {
		bindings.InvoiceWithExplicitSigningPubkeyBuilder_fallback_v1_p2tr_tweaked(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(utput_key, 32)));
	}
