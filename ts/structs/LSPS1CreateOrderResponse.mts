 ...
 */
export class LSPS1CreateOrderResponse extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS1CreateOrderResponse_free);
	}

	/**
	 * The id of the channel order.
	 */
	public get_order_id(): LSPS1OrderId {
		const ret: bigint = bindings.LSPS1CreateOrderResponse_get_order_id(this.ptr);
		const ret_hu_conv: LSPS1OrderId = new LSPS1OrderId(null, ret);
	 ...
	 * The id of the channel order.
	 */
	public set_order_id(val: LSPS1OrderId): void {
		bindings.LSPS1CreateOrderResponse_set_order_id(this.ptr, CommonBase.get_ptr_of(val));
	}

	/**
	 * The parameters of channel order.
	 */
	public get_order(): LSPS1OrderParams {
		const ret: bigint = bindings.LSPS1CreateOrderResponse_get_order(this.ptr);
		const ret_hu_conv: LSPS1OrderParams = new LSPS1OrderParams(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 * The parameters of channel order.
	 */
	public set_order(val: LSPS1OrderParams): void {
		bindings.LSPS1CreateOrderResponse_set_order(this.ptr, CommonBase.get_ptr_of(val));
	}

	/**
	 * The datetime when the order was created
	 */
	public get_created_at(): LSPSDateTime {
		const ret: bigint = bindings.LSPS1CreateOrderResponse_get_created_at(this.ptr);
		const ret_hu_conv: LSPSDateTime = new LSPSDateTime(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 * The datetime when the order was created
	 */
	public set_created_at(val: LSPSDateTime): void {
		bindings.LSPS1CreateOrderResponse_set_created_at(this.ptr, CommonBase.get_ptr_of(val));
	}

	/**
	 * The current state of the order.
	 */
	public get_order_state(): LSPS1OrderState {
		const ret: LSPS1OrderState = bindings.LSPS1CreateOrderResponse_get_order_state(this.ptr);
		return ret;
	}
	 ...
	 * The current state of the order.
	 */
	public set_order_state(val: LSPS1OrderState): void {
	 ...
	 */
	public get_payment(): LSPS1PaymentInfo {
		const ret: bigint = bindings.LSPS1CreateOrderResponse_get_payment(this.ptr);
		const ret_hu_conv: LSPS1PaymentInfo = new LSPS1PaymentInfo(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 * Contains details about how to pay for the order.
	 */
	public set_payment(val: LSPS1PaymentInfo): void {
		bindings.LSPS1CreateOrderResponse_set_payment(this.ptr, CommonBase.get_ptr_of(val));
	}
	 ...
	 */
	public get_channel(): LSPS1ChannelInfo {
		const ret: bigint = bindings.LSPS1CreateOrderResponse_get_channel(this.ptr);
		const ret_hu_conv: LSPS1ChannelInfo = new LSPS1ChannelInfo(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public set_channel(val: LSPS1ChannelInfo|null): void {
		bindings.LSPS1CreateOrderResponse_set_channel(this.ptr, val == null ? 0n : CommonBase.get_ptr_of(val));
	}
	 ...
	 */
	public static constructor_new(order_id_arg: LSPS1OrderId, order_arg: LSPS1OrderParams, created_at_arg: LSPSDateTime, order_state_arg: LSPS1OrderState, payment_arg: LSPS1PaymentInfo, channel_arg: LSPS1ChannelInfo|null): LSPS1CreateOrderResponse {
		const ret: bigint = bindings.LSPS1CreateOrderResponse_new(CommonBase.get_ptr_of(order_id_arg), CommonBase.get_ptr_of(order_arg), CommonBase.get_ptr_of(created_at_arg), order_state_arg, CommonBase.get_ptr_of(payment_arg), channel_arg == null ? 0n : CommonBase.get_ptr_of(channel_arg));
		const ret_hu_conv: LSPS1CreateOrderResponse = new LSPS1CreateOrderResponse(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS1CreateOrderResponse_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS1CreateOrderResponse {
		const ret: bigint = bindings.LSPS1CreateOrderResponse_clone(this.ptr);
		const ret_hu_conv: LSPS1CreateOrderResponse = new LSPS1CreateOrderResponse(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS1CreateOrderResponse): boolean {
		const ret: boolean = bindings.LSPS1CreateOrderResponse_eq(this.ptr, CommonBase.get_ptr_of(b));
