 ...
 */
export class LSPS2ClientConfig extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS2ClientConfig_free);
	}

	/**
	 * Constructs a new LSPS2ClientConfig given each field
	 */
	public static constructor_new(): LSPS2ClientConfig {
		const ret: bigint = bindings.LSPS2ClientConfig_new();
		const ret_hu_conv: LSPS2ClientConfig = new LSPS2ClientConfig(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS2ClientConfig_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS2ClientConfig {
		const ret: bigint = bindings.LSPS2ClientConfig_clone(this.ptr);
		const ret_hu_conv: LSPS2ClientConfig = new LSPS2ClientConfig(null, ret);
