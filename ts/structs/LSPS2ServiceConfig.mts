 ...
 */
export class LSPS2ServiceConfig extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS2ServiceConfig_free);
	}
	 ...
	 */
	public get_promise_secret(): Uint8Array {
		const ret: number = bindings.LSPS2ServiceConfig_get_promise_secret(this.ptr);
	 ...
	 * Note: If this changes then old promises given out will be considered invalid.
	 */
	public set_promise_secret(val: Uint8Array): void {
		bindings.LSPS2ServiceConfig_set_promise_secret(this.ptr, bindings.encodeUint8Array(val));
	}

	/**
	 * Constructs a new LSPS2ServiceConfig given each field
	 */
	public static constructor_new(promise_secret_arg: Uint8Array): LSPS2ServiceConfig {
		const ret: bigint = bindings.LSPS2ServiceConfig_new(bindings.encodeUint8Array(promise_secret_arg));
		const ret_hu_conv: LSPS2ServiceConfig = new LSPS2ServiceConfig(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS2ServiceConfig_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS2ServiceConfig {
		const ret: bigint = bindings.LSPS2ServiceConfig_clone(this.ptr);
		const ret_hu_conv: LSPS2ServiceConfig = new LSPS2ServiceConfig(null, ret);
