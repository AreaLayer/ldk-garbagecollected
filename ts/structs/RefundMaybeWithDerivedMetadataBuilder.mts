...
export class RefundMaybeWithDerivedMetadataBuilder extends CommonBase {
	 ...
	 */
	public static constructor_new(metadata: Uint8Array, payer_id: Uint8Array, amount_msats: bigint): Result_RefundMaybeWithDerivedMetadataBuilderBolt12SemanticErrorZ {
		const ret: bigint = bindings.RefundMaybeWithDerivedMetadataBuilder_new(bindings.encodeUint8Array(metadata), bindings.encodeUint8Array(bindings.check_arr_len(payer_id, 33)), amount_msats);
	 ...
	 */
	public static constructor_deriving_payer_id(node_id: Uint8Array, expanded_key: ExpandedKey, entropy_source: EntropySource, amount_msats: bigint, payment_id: Uint8Array): Result_RefundMaybeWithDerivedMetadataBuilderBolt12SemanticErrorZ {
		const ret: bigint = bindings.RefundMaybeWithDerivedMetadataBuilder_deriving_payer_id(bindings.encodeUint8Array(bindings.check_arr_len(node_id, 33)), CommonBase.get_ptr_of(expanded_key), CommonBase.get_ptr_of(entropy_source), amount_msats, bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)));
		const ret_hu_conv: Result_RefundMaybeWithDerivedMetadataBuilderBolt12SemanticErrorZ = Result_RefundMaybeWithDerivedMetadataBuilderBolt12SemanticErrorZ.constr_from_ptr(ret);
	 ...
	 */
	public path(path: BlindedPath): void {
