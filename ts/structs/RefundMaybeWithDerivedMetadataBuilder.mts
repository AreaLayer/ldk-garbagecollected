...
export class RefundMaybeWithDerivedMetadataBuilder extends CommonBase {
	 ...
	 */
	public static constructor_deriving_payer_id(node_id: Uint8Array, expanded_key: ExpandedKey, nonce: Nonce, amount_msats: bigint, payment_id: Uint8Array): Result_RefundMaybeWithDerivedMetadataBuilderBolt12SemanticErrorZ {
		const ret: bigint = bindings.RefundMaybeWithDerivedMetadataBuilder_deriving_payer_id(bindings.encodeUint8Array(bindings.check_arr_len(node_id, 33)), CommonBase.get_ptr_of(expanded_key), CommonBase.get_ptr_of(nonce), amount_msats, bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)));
		const ret_hu_conv: Result_RefundMaybeWithDerivedMetadataBuilderBolt12SemanticErrorZ = Result_RefundMaybeWithDerivedMetadataBuilderBolt12SemanticErrorZ.constr_from_ptr(ret);
