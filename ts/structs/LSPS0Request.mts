...
export class LSPS0Request extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.LSPS0Request_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): LSPS0Request {
		const raw_ty: number = bindings.LDKLSPS0Request_ty_from_ptr(ptr);
		switch (raw_ty) {
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS0Request_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS0Request {
		const ret: bigint = bindings.LSPS0Request_clone(this.ptr);
		const ret_hu_conv: LSPS0Request = LSPS0Request.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_list_protocols(a: LSPS0ListProtocolsRequest): LSPS0Request {
		const ret: bigint = bindings.LSPS0Request_list_protocols(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS0Request = LSPS0Request.constr_from_ptr(ret);
	 ...
	 */
	public eq(b: LSPS0Request): boolean {
		const ret: boolean = bindings.LSPS0Request_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}
	...
	public method(): string {
		const ret: number = bindings.LSPS0Request_method(this.ptr);
...
export class LSPS0Request_ListProtocols extends LSPS0Request {
	public list_protocols: LSPS0ListProtocolsRequest;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const list_protocols: bigint = bindings.LDKLSPS0Request_ListProtocols_get_list_protocols(ptr);
		const list_protocols_hu_conv: LSPS0ListProtocolsRequest = new LSPS0ListProtocolsRequest(null, list_protocols);
