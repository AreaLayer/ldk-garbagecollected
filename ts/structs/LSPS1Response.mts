...
export class LSPS1Response extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.LSPS1Response_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): LSPS1Response {
		const raw_ty: number = bindings.LDKLSPS1Response_ty_from_ptr(ptr);
		switch (raw_ty) {
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS1Response_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS1Response {
		const ret: bigint = bindings.LSPS1Response_clone(this.ptr);
		const ret_hu_conv: LSPS1Response = LSPS1Response.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_get_info(a: LSPS1GetInfoResponse): LSPS1Response {
		const ret: bigint = bindings.LSPS1Response_get_info(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS1Response = LSPS1Response.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_get_info_error(a: LSPSResponseError): LSPS1Response {
		const ret: bigint = bindings.LSPS1Response_get_info_error(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS1Response = LSPS1Response.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_create_order(a: LSPS1CreateOrderResponse): LSPS1Response {
		const ret: bigint = bindings.LSPS1Response_create_order(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS1Response = LSPS1Response.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_create_order_error(a: LSPSResponseError): LSPS1Response {
		const ret: bigint = bindings.LSPS1Response_create_order_error(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS1Response = LSPS1Response.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_get_order(a: LSPS1CreateOrderResponse): LSPS1Response {
		const ret: bigint = bindings.LSPS1Response_get_order(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS1Response = LSPS1Response.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_get_order_error(a: LSPSResponseError): LSPS1Response {
		const ret: bigint = bindings.LSPS1Response_get_order_error(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS1Response = LSPS1Response.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS1Response): boolean {
		const ret: boolean = bindings.LSPS1Response_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}
...
export class LSPS1Response_GetInfo extends LSPS1Response {
	public get_info: LSPS1GetInfoResponse;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const get_info: bigint = bindings.LDKLSPS1Response_GetInfo_get_get_info(ptr);
		const get_info_hu_conv: LSPS1GetInfoResponse = new LSPS1GetInfoResponse(null, get_info);
...
export class LSPS1Response_GetInfoError extends LSPS1Response {
	public get_info_error: LSPSResponseError;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const get_info_error: bigint = bindings.LDKLSPS1Response_GetInfoError_get_get_info_error(ptr);
		const get_info_error_hu_conv: LSPSResponseError = new LSPSResponseError(null, get_info_error);
...
export class LSPS1Response_CreateOrder extends LSPS1Response {
	public create_order: LSPS1CreateOrderResponse;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const create_order: bigint = bindings.LDKLSPS1Response_CreateOrder_get_create_order(ptr);
		const create_order_hu_conv: LSPS1CreateOrderResponse = new LSPS1CreateOrderResponse(null, create_order);
...
export class LSPS1Response_CreateOrderError extends LSPS1Response {
	public create_order_error: LSPSResponseError;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const create_order_error: bigint = bindings.LDKLSPS1Response_CreateOrderError_get_create_order_error(ptr);
		const create_order_error_hu_conv: LSPSResponseError = new LSPSResponseError(null, create_order_error);
...
export class LSPS1Response_GetOrder extends LSPS1Response {
	public get_order: LSPS1CreateOrderResponse;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const get_order: bigint = bindings.LDKLSPS1Response_GetOrder_get_get_order(ptr);
		const get_order_hu_conv: LSPS1CreateOrderResponse = new LSPS1CreateOrderResponse(null, get_order);
...
export class LSPS1Response_GetOrderError extends LSPS1Response {
	public get_order_error: LSPSResponseError;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const get_order_error: bigint = bindings.LDKLSPS1Response_GetOrderError_get_get_order_error(ptr);
		const get_order_error_hu_conv: LSPSResponseError = new LSPSResponseError(null, get_order_error);
