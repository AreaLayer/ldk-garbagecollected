...
export class Persister extends CommonBase {
	...
	public persist_manager(channel_manager: ChannelManager): Result_NoneIOErrorZ {
		const ret: bigint = bindings.Persister_persist_manager(this.ptr, CommonBase.get_ptr_of(channel_manager));
	...
	public persist_graph(network_graph: NetworkGraph): Result_NoneIOErrorZ {
		const ret: bigint = bindings.Persister_persist_graph(this.ptr, CommonBase.get_ptr_of(network_graph));
		const ret_hu_conv: Result_NoneIOErrorZ = Result_NoneIOErrorZ.constr_from_ptr(ret);
