...
export class CommitmentSignedBatch extends CommonBase {
	...
	public get_batch_size(): number {
		const ret: number = bindings.CommitmentSignedBatch_get_batch_size(this.ptr);
		return ret;
	}
	...
	public get_funding_txid(): Uint8Array {
		const ret: number = bindings.CommitmentSignedBatch_get_funding_txid(this.ptr);
	 ...
	 */
	public static constructor_new(batch_size_arg: number, funding_txid_arg: Uint8Array): CommitmentSignedBatch {
		const ret: bigint = bindings.CommitmentSignedBatch_new(batch_size_arg, bindings.encodeUint8Array(bindings.check_arr_len(funding_txid_arg, 32)));
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.CommitmentSignedBatch_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): CommitmentSignedBatch {
		const ret: bigint = bindings.CommitmentSignedBatch_clone(this.ptr);
		const ret_hu_conv: CommitmentSignedBatch = new CommitmentSignedBatch(null, ret);
	 ...
	 */
	public hash(): bigint {
		const ret: bigint = bindings.CommitmentSignedBatch_hash(this.ptr);
		return ret;
	}
	 ...
	 */
	public eq(b: CommitmentSignedBatch): boolean {
		const ret: boolean = bindings.CommitmentSignedBatch_eq(this.ptr, CommonBase.get_ptr_of(b));
	...
	public write(): Uint8Array {
		const ret: number = bindings.CommitmentSignedBatch_write(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
	 ...
	 */
	public static constructor_read(ser: Uint8Array): Result_CommitmentSignedBatchDecodeErrorZ {
		const ret: bigint = bindings.CommitmentSignedBatch_read(bindings.encodeUint8Array(ser));
