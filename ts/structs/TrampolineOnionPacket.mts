...
export class TrampolineOnionPacket extends CommonBase {
	...
	public set_public_key(val: Uint8Array): void {
		bindings.TrampolineOnionPacket_set_public_key(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 33)));
	}
	...
	public set_hmac(val: Uint8Array): void {
		bindings.TrampolineOnionPacket_set_hmac(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	...
	public static constructor_new(version_arg: number, public_key_arg: Uint8Array, hop_data_arg: Uint8Array, hmac_arg: Uint8Array): TrampolineOnionPacket {
		const ret: bigint = bindings.TrampolineOnionPacket_new(version_arg, bindings.encodeUint8Array(bindings.check_arr_len(public_key_arg, 33)), bindings.encodeUint8Array(hop_data_arg), bindings.encodeUint8Array(bindings.check_arr_len(hmac_arg, 32)));
