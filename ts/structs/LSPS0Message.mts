...
export class LSPS0Message extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.LSPS0Message_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): LSPS0Message {
		const raw_ty: number = bindings.LDKLSPS0Message_ty_from_ptr(ptr);
		switch (raw_ty) {
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS0Message_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS0Message {
		const ret: bigint = bindings.LSPS0Message_clone(this.ptr);
		const ret_hu_conv: LSPS0Message = LSPS0Message.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_request(a: LSPSRequestId, b: LSPS0Request): LSPS0Message {
		const ret: bigint = bindings.LSPS0Message_request(CommonBase.get_ptr_of(a), CommonBase.get_ptr_of(b));
		const ret_hu_conv: LSPS0Message = LSPS0Message.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_response(a: LSPSRequestId, b: LSPS0Response): LSPS0Message {
		const ret: bigint = bindings.LSPS0Message_response(CommonBase.get_ptr_of(a), CommonBase.get_ptr_of(b));
		const ret_hu_conv: LSPS0Message = LSPS0Message.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS0Message): boolean {
		const ret: boolean = bindings.LSPS0Message_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}
...
export class LSPS0Message_Request extends LSPS0Message {
	...
	public _1: LSPS0Request;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const _0: bigint = bindings.LDKLSPS0Message_Request_get__0(ptr);
		const _0_hu_conv: LSPSRequestId = new LSPSRequestId(null, _0);
			CommonBase.add_ref_from(_0_hu_conv, this);
		this._0 = _0_hu_conv;
		const _1: bigint = bindings.LDKLSPS0Message_Request_get__1(ptr);
		const _1_hu_conv: LSPS0Request = LSPS0Request.constr_from_ptr(_1);
...
export class LSPS0Message_Response extends LSPS0Message {
	public _0: LSPSRequestId;
	public _1: LSPS0Response;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const _0: bigint = bindings.LDKLSPS0Message_Response_get__0(ptr);
		const _0_hu_conv: LSPSRequestId = new LSPSRequestId(null, _0);
			CommonBase.add_ref_from(_0_hu_conv, this);
		this._0 = _0_hu_conv;
		const _1: bigint = bindings.LDKLSPS0Message_Response_get__1(ptr);
		const _1_hu_conv: LSPS0Response = LSPS0Response.constr_from_ptr(_1);
			CommonBase.add_ref_from(_1_hu_conv, this);
		this._1 = _1_hu_conv;
	}
}
