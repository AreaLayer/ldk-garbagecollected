...
export class LSPS1ChannelInfo extends CommonBase {
	 ...
	 */
	public get_funded_at(): LSPSDateTime {
		const ret: bigint = bindings.LSPS1ChannelInfo_get_funded_at(this.ptr);
	 ...
	 * The datetime when the funding transaction has been published.
	 */
	public set_funded_at(val: LSPSDateTime): void {
	...
	public get_funding_outpoint(): OutPoint {
		const ret: bigint = bindings.LSPS1ChannelInfo_get_funding_outpoint(this.ptr);
	...
	public get_expires_at(): LSPSDateTime {
		const ret: bigint = bindings.LSPS1ChannelInfo_get_expires_at(this.ptr);
		const ret_hu_conv: LSPSDateTime = new LSPSDateTime(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_new(funded_at_arg: LSPSDateTime, funding_outpoint_arg: OutPoint, expires_at_arg: LSPSDateTime): LSPS1ChannelInfo {
		const ret: bigint = bindings.LSPS1ChannelInfo_new(CommonBase.get_ptr_of(funded_at_arg), CommonBase.get_ptr_of(funding_outpoint_arg), CommonBase.get_ptr_of(expires_at_arg));
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS1ChannelInfo_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS1ChannelInfo {
		const ret: bigint = bindings.LSPS1ChannelInfo_clone(this.ptr);
		const ret_hu_conv: LSPS1ChannelInfo = new LSPS1ChannelInfo(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS1ChannelInfo): boolean {
		const ret: boolean = bindings.LSPS1ChannelInfo_eq(this.ptr, CommonBase.get_ptr_of(b));
