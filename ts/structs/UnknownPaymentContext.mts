 ...
 */
export class UnknownPaymentContext extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.UnknownPaymentContext_free);
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.UnknownPaymentContext_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): UnknownPaymentContext {
		const ret: bigint = bindings.UnknownPaymentContext_clone(this.ptr);
		const ret_hu_conv: UnknownPaymentContext = new UnknownPaymentContext(null, ret);
	 ...
	 */
	public eq(b: UnknownPaymentContext): boolean {
		const ret: boolean = bindings.UnknownPaymentContext_eq(this.ptr, CommonBase.get_ptr_of(b));
	...
	public write(): Uint8Array {
		const ret: number = bindings.UnknownPaymentContext_write(this.ptr);
	 ...
	 */
	public static constructor_read(ser: Uint8Array): Result_UnknownPaymentContextDecodeErrorZ {
		const ret: bigint = bindings.UnknownPaymentContext_read(bindings.encodeUint8Array(ser));
