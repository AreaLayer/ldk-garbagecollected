...
export class ReleaseHeldHtlc extends CommonBase {
	...
	public get_payment_release_secret(): Uint8Array {
		const ret: number = bindings.ReleaseHeldHtlc_get_payment_release_secret(this.ptr);
	 ...
	 */
	public static constructor_new(payment_release_secret_arg: Uint8Array): ReleaseHeldHtlc {
		const ret: bigint = bindings.ReleaseHeldHtlc_new(bindings.encodeUint8Array(bindings.check_arr_len(payment_release_secret_arg, 32)));
