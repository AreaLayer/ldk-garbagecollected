...
export class ChannelMessageHandler extends CommonBase {
	...
	public peer_disconnected(their_node_id: Uint8Array): void {
		bindings.ChannelMessageHandler_peer_disconnected(this.ptr, bindings.encodeUint8Array(their_node_id));
	}
	...
	public peer_connected(their_node_id: Uint8Array, msg: Init, inbound: boolean): Result_NoneNoneZ {
		const ret: bigint = bindings.ChannelMessageHandler_peer_connected(this.ptr, bindings.encodeUint8Array(their_node_id), CommonBase.get_ptr_of(msg), inbound);
	...
	public provided_init_features(their_node_id: Uint8Array): InitFeatures {
		const ret: bigint = bindings.ChannelMessageHandler_provided_init_features(this.ptr, bindings.encodeUint8Array(their_node_id));
