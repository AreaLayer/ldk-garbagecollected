 ...
 */
export class LSPS2BuyResponse extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS2BuyResponse_free);
	}

	/**
	 * The intercept short channel id used by LSP to identify need to open channel.
	 */
	public get_jit_channel_scid(): LSPS2InterceptScid {
		const ret: bigint = bindings.LSPS2BuyResponse_get_jit_channel_scid(this.ptr);
		const ret_hu_conv: LSPS2InterceptScid = new LSPS2InterceptScid(null, ret);
	 ...
	 * The intercept short channel id used by LSP to identify need to open channel.
	 */
	public set_jit_channel_scid(val: LSPS2InterceptScid): void {
		bindings.LSPS2BuyResponse_set_jit_channel_scid(this.ptr, CommonBase.get_ptr_of(val));
	}

	/**
	 * The locktime expiry delta the lsp requires.
	 */
	public get_lsp_cltv_expiry_delta(): number {
		const ret: number = bindings.LSPS2BuyResponse_get_lsp_cltv_expiry_delta(this.ptr);
		return ret;
	}
	 ...
	 * The locktime expiry delta the lsp requires.
	 */
	public set_lsp_cltv_expiry_delta(val: number): void {
	 ...
	 */
	public get_client_trusts_lsp(): boolean {
		const ret: boolean = bindings.LSPS2BuyResponse_get_client_trusts_lsp(this.ptr);
		return ret;
	}
	 ...
	 * A flag that indicates who is trusting who.
	 */
	public set_client_trusts_lsp(val: boolean): void {
	 ...
	 */
	public static constructor_new(jit_channel_scid_arg: LSPS2InterceptScid, lsp_cltv_expiry_delta_arg: number, client_trusts_lsp_arg: boolean): LSPS2BuyResponse {
		const ret: bigint = bindings.LSPS2BuyResponse_new(CommonBase.get_ptr_of(jit_channel_scid_arg), lsp_cltv_expiry_delta_arg, client_trusts_lsp_arg);
		const ret_hu_conv: LSPS2BuyResponse = new LSPS2BuyResponse(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS2BuyResponse_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS2BuyResponse {
		const ret: bigint = bindings.LSPS2BuyResponse_clone(this.ptr);
		const ret_hu_conv: LSPS2BuyResponse = new LSPS2BuyResponse(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS2BuyResponse): boolean {
		const ret: boolean = bindings.LSPS2BuyResponse_eq(this.ptr, CommonBase.get_ptr_of(b));
