 ...
 */
export class LSPS1ClientConfig extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS1ClientConfig_free);
	}

	/**
	 * The maximally allowed channel fees.
	 */
	public get_max_channel_fees_msat(): Option_u64Z {
		const ret: bigint = bindings.LSPS1ClientConfig_get_max_channel_fees_msat(this.ptr);
	 ...
	 * The maximally allowed channel fees.
	 */
	public set_max_channel_fees_msat(val: Option_u64Z): void {
		bindings.LSPS1ClientConfig_set_max_channel_fees_msat(this.ptr, CommonBase.get_ptr_of(val));
	}

	/**
	 * Constructs a new LSPS1ClientConfig given each field
	 */
	public static constructor_new(max_channel_fees_msat_arg: Option_u64Z): LSPS1ClientConfig {
		const ret: bigint = bindings.LSPS1ClientConfig_new(CommonBase.get_ptr_of(max_channel_fees_msat_arg));
		const ret_hu_conv: LSPS1ClientConfig = new LSPS1ClientConfig(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS1ClientConfig_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS1ClientConfig {
		const ret: bigint = bindings.LSPS1ClientConfig_clone(this.ptr);
		const ret_hu_conv: LSPS1ClientConfig = new LSPS1ClientConfig(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
