...
export class PhantomKeysManager extends CommonBase {
	...
	public static constructor_new(seed: Uint8Array, starting_time_secs: bigint, starting_time_nanos: number, cross_node_seed: Uint8Array): PhantomKeysManager {
		const ret: bigint = bindings.PhantomKeysManager_new(bindings.encodeUint8Array(seed), starting_time_secs, starting_time_nanos, bindings.encodeUint8Array(cross_node_seed));
	...
	public derive_channel_keys(channel_value_satoshis: bigint, params: Uint8Array): InMemorySigner {
		const ret: bigint = bindings.PhantomKeysManager_derive_channel_keys(this.ptr, channel_value_satoshis, bindings.encodeUint8Array(params));
