...
export class SignerProvider extends CommonBase {
	...
	public static new_impl(arg: SignerProviderInterface): SignerProvider {
		...
		let structImplementation = {
			...
			derive_channel_signer (channel_value_satoshis: bigint, channel_keys_id: number): bigint {
				...
				const ret: EcdsaChannelSigner = arg.derive_channel_signer(channel_value_satoshis, channel_keys_id_conv);
			...
			read_chan_signer (reader: number): bigint {
				...
				const ret: Result_EcdsaChannelSignerDecodeErrorZ = arg.read_chan_signer(reader_conv);
				const result: bigint = ret.clone_ptr();
				return result;
			},
	 ...
	 * [`ChannelSigner::channel_keys_id`].
	 */
	public derive_channel_signer(channel_value_satoshis: bigint, channel_keys_id: Uint8Array): EcdsaChannelSigner {
		const ret: bigint = bindings.SignerProvider_derive_channel_signer(this.ptr, channel_value_satoshis, bindings.encodeUint8Array(channel_keys_id));
	 ...
	 * [`ChannelManager`]: crate::ln::channelmanager::ChannelManager
	 */
	public read_chan_signer(reader: Uint8Array): Result_EcdsaChannelSignerDecodeErrorZ {
		const ret: bigint = bindings.SignerProvider_read_chan_signer(this.ptr, bindings.encodeUint8Array(reader));
		const ret_hu_conv: Result_EcdsaChannelSignerDecodeErrorZ = Result_EcdsaChannelSignerDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
