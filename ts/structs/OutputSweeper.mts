...
export class OutputSweeper extends CommonBase {
	 ...
	 */
	public static constructor_new(best_block: BestBlock, broadcaster: BroadcasterInterface, fee_estimator: FeeEstimator, chain_data_source: Option_FilterZ, output_spender: OutputSpender, change_destination_source: ChangeDestinationSource, kv_store: KVStore, logger: Logger): OutputSweeper {
		const ret: bigint = bindings.OutputSweeper_new(CommonBase.get_ptr_of(best_block), CommonBase.get_ptr_of(broadcaster), CommonBase.get_ptr_of(fee_estimator), CommonBase.get_ptr_of(chain_data_source), CommonBase.get_ptr_of(output_spender), CommonBase.get_ptr_of(change_destination_source), CommonBase.get_ptr_of(kv_store), CommonBase.get_ptr_of(logger));
		const ret_hu_conv: OutputSweeper = new OutputSweeper(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, best_block);
	...
	public track_spendable_outputs(output_descriptors: SpendableOutputDescriptor[], channel_id: ChannelId|null, exclude_static_outputs: boolean, delay_until_height: Option_u32Z): Result_NoneNoneZ {
		const ret: bigint = bindings.OutputSweeper_track_spendable_outputs(this.ptr, bindings.encodeUint64Array(output_descriptors.map(output_descriptors_conv_27 => CommonBase.get_ptr_of(output_descriptors_conv_27))), channel_id == null ? 0n : CommonBase.get_ptr_of(channel_id), exclude_static_outputs, CommonBase.get_ptr_of(delay_until_height));
		const ret_hu_conv: Result_NoneNoneZ = Result_NoneNoneZ.constr_from_ptr(ret);
		output_descriptors.forEach((output_descriptors_conv_27: SpendableOutputDescriptor) => { CommonBase.add_ref_from(this, output_descriptors_conv_27); });
		CommonBase.add_ref_from(this, channel_id);
		CommonBase.add_ref_from(this, delay_until_height);
		return ret_hu_conv;
	}
	...
	public tracked_spendable_outputs(): TrackedSpendableOutput[] {
		const ret: number = bindings.OutputSweeper_tracked_spendable_outputs(this.ptr);
	...
	public current_best_block(): BestBlock {
		const ret: bigint = bindings.OutputSweeper_current_best_block(this.ptr);
	...
	public as_Listen(): Listen {
		const ret: bigint = bindings.OutputSweeper_as_Listen(this.ptr);
	...
	public as_Confirm(): Confirm {
		const ret: bigint = bindings.OutputSweeper_as_Confirm(this.ptr);
	 ...
	 */
	public static constructor_read(ser: Uint8Array, arg_a: BroadcasterInterface, arg_b: FeeEstimator, arg_c: Option_FilterZ, arg_d: OutputSpender, arg_e: ChangeDestinationSource, arg_f: KVStore, arg_g: Logger): Result_OutputSweeperDecodeErrorZ {
		const ret: bigint = bindings.OutputSweeper_read(bindings.encodeUint8Array(ser), CommonBase.get_ptr_of(arg_a), CommonBase.get_ptr_of(arg_b), CommonBase.get_ptr_of(arg_c), CommonBase.get_ptr_of(arg_d), CommonBase.get_ptr_of(arg_e), CommonBase.get_ptr_of(arg_f), CommonBase.get_ptr_of(arg_g));
		const ret_hu_conv: Result_OutputSweeperDecodeErrorZ = Result_OutputSweeperDecodeErrorZ.constr_from_ptr(ret);
