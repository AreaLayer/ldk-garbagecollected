...
export class WriteableEcdsaChannelSigner extends CommonBase {
	...
	public static new_impl(arg: WriteableEcdsaChannelSignerInterface, ecdsaChannelSigner_impl: EcdsaChannelSignerInterface, channelSigner_impl: ChannelSignerInterface, pubkeys: ChannelPublicKeys): WriteableEcdsaChannelSigner {
		...
		const ptr_idx: [bigint, number] = bindings.LDKWriteableEcdsaChannelSigner_new(structImplementation, ecdsaChannelSigner.instance_idx!, channelSigner.instance_idx!, pubkeys.clone_ptr());
