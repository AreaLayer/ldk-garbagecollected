 ...
 * A Tuple
 */
export class TwoTuple_OutPointCVec_u64ZZ extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.C2Tuple_OutPointCVec_u64ZZ_free);
	}
	...
	public get_a(): OutPoint {
		const ret: bigint = bindings.C2Tuple_OutPointCVec_u64ZZ_get_a(this.ptr);
	...
	public get_b(): BigUint64Array {
		const ret: number = bindings.C2Tuple_OutPointCVec_u64ZZ_get_b(this.ptr);
		const ret_conv: BigUint64Array = bindings.decodeUint64Array(ret);
		return ret_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.C2Tuple_OutPointCVec_u64ZZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): TwoTuple_OutPointCVec_u64ZZ {
		const ret: bigint = bindings.C2Tuple_OutPointCVec_u64ZZ_clone(this.ptr);
		const ret_hu_conv: TwoTuple_OutPointCVec_u64ZZ = new TwoTuple_OutPointCVec_u64ZZ(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_new(a: OutPoint, b: BigUint64Array): TwoTuple_OutPointCVec_u64ZZ {
		const ret: bigint = bindings.C2Tuple_OutPointCVec_u64ZZ_new(CommonBase.get_ptr_of(a), bindings.encodeUint64Array(b));
		const ret_hu_conv: TwoTuple_OutPointCVec_u64ZZ = new TwoTuple_OutPointCVec_u64ZZ(null, ret);
