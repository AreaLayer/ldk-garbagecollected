...
export class Splice extends CommonBase {
	...
	public get_channel_id(): ChannelId {
		const ret: bigint = bindings.Splice_get_channel_id(this.ptr);
	...
	public set_channel_id(val: ChannelId): void {
		bindings.Splice_set_channel_id(this.ptr, CommonBase.get_ptr_of(val));
	 ...
	 */
	public static constructor_new(channel_id_arg: ChannelId, chain_hash_arg: Uint8Array, relative_satoshis_arg: bigint, funding_feerate_perkw_arg: number, locktime_arg: number, funding_pubkey_arg: Uint8Array): Splice {
		const ret: bigint = bindings.Splice_new(CommonBase.get_ptr_of(channel_id_arg), bindings.encodeUint8Array(bindings.check_arr_len(chain_hash_arg, 32)), relative_satoshis_arg, funding_feerate_perkw_arg, locktime_arg, bindings.encodeUint8Array(bindings.check_arr_len(funding_pubkey_arg, 33)));
	...
	public eq(b: Splice): boolean {
		const ret: boolean = bindings.Splice_eq(this.ptr, CommonBase.get_ptr_of(b));
