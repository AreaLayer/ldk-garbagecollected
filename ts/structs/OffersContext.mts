...
export class OffersContext extends CommonBase {
	 ...
	 */
	public static constructor_outbound_payment(payment_id: Uint8Array, nonce: Nonce, hmac: Uint8Array): OffersContext {
		const ret: bigint = bindings.OffersContext_outbound_payment(bindings.encodeUint8Array(bindings.check_arr_len(payment_id, 32)), CommonBase.get_ptr_of(nonce), bindings.encodeUint8Array(bindings.check_arr_len(hmac, 32)));
		const ret_hu_conv: OffersContext = OffersContext.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_inbound_payment(payment_hash: Uint8Array, nonce: Nonce, hmac: Uint8Array): OffersContext {
		const ret: bigint = bindings.OffersContext_inbound_payment(bindings.encodeUint8Array(bindings.check_arr_len(payment_hash, 32)), CommonBase.get_ptr_of(nonce), bindings.encodeUint8Array(bindings.check_arr_len(hmac, 32)));
		const ret_hu_conv: OffersContext = OffersContext.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
...
export class OffersContext_OutboundPayment extends OffersContext {
	...
	public constructor(ptr: bigint) {
		...
		const nonce_hu_conv: Nonce = new Nonce(null, nonce);
			CommonBase.add_ref_from(nonce_hu_conv, this);
		this.nonce = nonce_hu_conv;
		const hmac: number = bindings.LDKOffersContext_OutboundPayment_get_hmac(ptr);
...
export class OffersContext_InboundPayment extends OffersContext {
	...
	public constructor(ptr: bigint) {
		...
		const nonce: bigint = bindings.LDKOffersContext_InboundPayment_get_nonce(ptr);
		const nonce_hu_conv: Nonce = new Nonce(null, nonce);
			CommonBase.add_ref_from(nonce_hu_conv, this);
		this.nonce = nonce_hu_conv;
		const hmac: number = bindings.LDKOffersContext_InboundPayment_get_hmac(ptr);
		const hmac_conv: Uint8Array = bindings.decodeUint8Array(hmac);
		this.hmac = hmac_conv;
	}
}
