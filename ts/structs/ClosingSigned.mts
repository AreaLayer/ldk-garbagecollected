...
export class ClosingSigned extends CommonBase {
	...
	public static constructor_new(channel_id_arg: ChannelId, fee_satoshis_arg: bigint, signature_arg: Uint8Array, fee_range_arg: ClosingSignedFeeRange|null): ClosingSigned {
		const ret: bigint = bindings.ClosingSigned_new(CommonBase.get_ptr_of(channel_id_arg), fee_satoshis_arg, bindings.encodeUint8Array(bindings.check_arr_len(signature_arg, 64)), fee_range_arg == null ? 0n : CommonBase.get_ptr_of(fee_range_arg));
