 ...
 */
export class LSPS1Options extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS1Options_free);
	}

	/**
	 * The smallest number of confirmations needed for the LSP to accept a channel as confirmed.
	 */
	public get_min_required_channel_confirmations(): number {
		const ret: number = bindings.LSPS1Options_get_min_required_channel_confirmations(this.ptr);
		return ret;
	}
	 ...
	 * The smallest number of confirmations needed for the LSP to accept a channel as confirmed.
	 */
	public set_min_required_channel_confirmations(val: number): void {
	 ...
	 */
	public get_min_funding_confirms_within_blocks(): number {
		const ret: number = bindings.LSPS1Options_get_min_funding_confirms_within_blocks(this.ptr);
		return ret;
	}
	 ...
	 * The smallest number of blocks in which the LSP can confirm the funding transaction.
	 */
	public set_min_funding_confirms_within_blocks(val: number): void {
	 ...
	 */
	public get_supports_zero_channel_reserve(): boolean {
		const ret: boolean = bindings.LSPS1Options_get_supports_zero_channel_reserve(this.ptr);
		return ret;
	}
	 ...
	 * Indicates if the LSP supports zero reserve.
	 */
	public set_supports_zero_channel_reserve(val: boolean): void {
	 ...
	 */
	public get_max_channel_expiry_blocks(): number {
		const ret: number = bindings.LSPS1Options_get_max_channel_expiry_blocks(this.ptr);
		return ret;
	}
	 ...
	 * The maximum number of blocks a channel can be leased for.
	 */
	public set_max_channel_expiry_blocks(val: number): void {
	 ...
	 */
	public get_min_initial_client_balance_sat(): bigint {
		const ret: bigint = bindings.LSPS1Options_get_min_initial_client_balance_sat(this.ptr);
		return ret;
	}
	 ...
	 * The minimum number of satoshi that the client MUST request.
	 */
	public set_min_initial_client_balance_sat(val: bigint): void {
	 ...
	 */
	public get_max_initial_client_balance_sat(): bigint {
		const ret: bigint = bindings.LSPS1Options_get_max_initial_client_balance_sat(this.ptr);
		return ret;
	}
	 ...
	 * The maximum number of satoshi that the client MUST request.
	 */
	public set_max_initial_client_balance_sat(val: bigint): void {
	 ...
	 */
	public get_min_initial_lsp_balance_sat(): bigint {
		const ret: bigint = bindings.LSPS1Options_get_min_initial_lsp_balance_sat(this.ptr);
		return ret;
	}
	 ...
	 * The minimum number of satoshi that the LSP will provide to the channel.
	 */
	public set_min_initial_lsp_balance_sat(val: bigint): void {
	 ...
	 */
	public get_max_initial_lsp_balance_sat(): bigint {
		const ret: bigint = bindings.LSPS1Options_get_max_initial_lsp_balance_sat(this.ptr);
		return ret;
	}
	 ...
	 * The maximum number of satoshi that the LSP will provide to the channel.
	 */
	public set_max_initial_lsp_balance_sat(val: bigint): void {
	 ...
	 */
	public get_min_channel_balance_sat(): bigint {
		const ret: bigint = bindings.LSPS1Options_get_min_channel_balance_sat(this.ptr);
		return ret;
	}
	 ...
	 * The minimal channel size.
	 */
	public set_min_channel_balance_sat(val: bigint): void {
	 ...
	 */
	public get_max_channel_balance_sat(): bigint {
		const ret: bigint = bindings.LSPS1Options_get_max_channel_balance_sat(this.ptr);
		return ret;
	}
	 ...
	 * The maximal channel size.
	 */
	public set_max_channel_balance_sat(val: bigint): void {
	 ...
	 */
	public clone(): LSPS1Options {
		const ret: bigint = bindings.LSPS1Options_clone(this.ptr);
		const ret_hu_conv: LSPS1Options = new LSPS1Options(null, ret);
	 ...
	 */
	public eq(b: LSPS1Options): boolean {
		const ret: boolean = bindings.LSPS1Options_eq(this.ptr, CommonBase.get_ptr_of(b));
