 ...
 */
export class LSPS1ClientEvent extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.LSPS1ClientEvent_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): LSPS1ClientEvent {
		const raw_ty: number = bindings.LDKLSPS1ClientEvent_ty_from_ptr(ptr);
		switch (raw_ty) {
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS1ClientEvent_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS1ClientEvent {
		const ret: bigint = bindings.LSPS1ClientEvent_clone(this.ptr);
		const ret_hu_conv: LSPS1ClientEvent = LSPS1ClientEvent.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_supported_options_ready(request_id: LSPSRequestId, counterparty_node_id: Uint8Array, supported_options: LSPS1Options): LSPS1ClientEvent {
		const ret: bigint = bindings.LSPS1ClientEvent_supported_options_ready(CommonBase.get_ptr_of(request_id), bindings.encodeUint8Array(counterparty_node_id), CommonBase.get_ptr_of(supported_options));
		const ret_hu_conv: LSPS1ClientEvent = LSPS1ClientEvent.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_supported_options_request_failed(request_id: LSPSRequestId, counterparty_node_id: Uint8Array, error: LSPSResponseError): LSPS1ClientEvent {
		const ret: bigint = bindings.LSPS1ClientEvent_supported_options_request_failed(CommonBase.get_ptr_of(request_id), bindings.encodeUint8Array(counterparty_node_id), CommonBase.get_ptr_of(error));
		const ret_hu_conv: LSPS1ClientEvent = LSPS1ClientEvent.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_order_created(request_id: LSPSRequestId, counterparty_node_id: Uint8Array, order_id: LSPS1OrderId, order: LSPS1OrderParams, payment: LSPS1PaymentInfo, channel: LSPS1ChannelInfo): LSPS1ClientEvent {
		const ret: bigint = bindings.LSPS1ClientEvent_order_created(CommonBase.get_ptr_of(request_id), bindings.encodeUint8Array(counterparty_node_id), CommonBase.get_ptr_of(order_id), CommonBase.get_ptr_of(order), CommonBase.get_ptr_of(payment), CommonBase.get_ptr_of(channel));
		const ret_hu_conv: LSPS1ClientEvent = LSPS1ClientEvent.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_order_status(request_id: LSPSRequestId, counterparty_node_id: Uint8Array, order_id: LSPS1OrderId, order: LSPS1OrderParams, payment: LSPS1PaymentInfo, channel: LSPS1ChannelInfo): LSPS1ClientEvent {
		const ret: bigint = bindings.LSPS1ClientEvent_order_status(CommonBase.get_ptr_of(request_id), bindings.encodeUint8Array(counterparty_node_id), CommonBase.get_ptr_of(order_id), CommonBase.get_ptr_of(order), CommonBase.get_ptr_of(payment), CommonBase.get_ptr_of(channel));
		const ret_hu_conv: LSPS1ClientEvent = LSPS1ClientEvent.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_order_request_failed(request_id: LSPSRequestId, counterparty_node_id: Uint8Array, error: LSPSResponseError): LSPS1ClientEvent {
		const ret: bigint = bindings.LSPS1ClientEvent_order_request_failed(CommonBase.get_ptr_of(request_id), bindings.encodeUint8Array(counterparty_node_id), CommonBase.get_ptr_of(error));
		const ret_hu_conv: LSPS1ClientEvent = LSPS1ClientEvent.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS1ClientEvent): boolean {
		const ret: boolean = bindings.LSPS1ClientEvent_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}

}
/** A LSPS1ClientEvent of type SupportedOptionsReady */
export class LSPS1ClientEvent_SupportedOptionsReady extends LSPS1ClientEvent {
	/**
	 ...
	 */
	public request_id: LSPSRequestId;
	/**
	 ...
	 */
	public supported_options: LSPS1Options;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const request_id: bigint = bindings.LDKLSPS1ClientEvent_SupportedOptionsReady_get_request_id(ptr);
		const request_id_hu_conv: LSPSRequestId = new LSPSRequestId(null, request_id);
			CommonBase.add_ref_from(request_id_hu_conv, this);
		this.request_id = request_id_hu_conv;
		const counterparty_node_id: number = bindings.LDKLSPS1ClientEvent_SupportedOptionsReady_get_counterparty_node_id(ptr);
		...
		const supported_options: bigint = bindings.LDKLSPS1ClientEvent_SupportedOptionsReady_get_supported_options(ptr);
		const supported_options_hu_conv: LSPS1Options = new LSPS1Options(null, supported_options);
			CommonBase.add_ref_from(supported_options_hu_conv, this);
		this.supported_options = supported_options_hu_conv;
	}
}
/** A LSPS1ClientEvent of type SupportedOptionsRequestFailed */
export class LSPS1ClientEvent_SupportedOptionsRequestFailed extends LSPS1ClientEvent {
	/**
	 * The identifier of the issued bLIP-51 / LSPS1 `get_info` request, as returned by
	 * [`LSPS1ClientHandler::request_supported_options`]
	 * 
	 ...
	 */
	public error: LSPSResponseError;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const request_id: bigint = bindings.LDKLSPS1ClientEvent_SupportedOptionsRequestFailed_get_request_id(ptr);
		const request_id_hu_conv: LSPSRequestId = new LSPSRequestId(null, request_id);
			CommonBase.add_ref_from(request_id_hu_conv, this);
		this.request_id = request_id_hu_conv;
		const counterparty_node_id: number = bindings.LDKLSPS1ClientEvent_SupportedOptionsRequestFailed_get_counterparty_node_id(ptr);
		const counterparty_node_id_conv: Uint8Array = bindings.decodeUint8Array(counterparty_node_id);
		this.counterparty_node_id = counterparty_node_id_conv;
		const error: bigint = bindings.LDKLSPS1ClientEvent_SupportedOptionsRequestFailed_get_error(ptr);
		const error_hu_conv: LSPSResponseError = new LSPSResponseError(null, error);
			CommonBase.add_ref_from(error_hu_conv, this);
		this.error = error_hu_conv;
	}
}
/** A LSPS1ClientEvent of type OrderCreated */
export class LSPS1ClientEvent_OrderCreated extends LSPS1ClientEvent {
	/**
	 ...
	 */
	public order_id: LSPS1OrderId;
	/**
	 * The order created by client and approved by LSP.
	 */
	public order: LSPS1OrderParams;
	/**
	 * The details regarding payment of the order
	 */
	public payment: LSPS1PaymentInfo;
	/**
	 * The details regarding state of the channel ordered.
	 * 
	 * Note that this (or a relevant inner pointer) may be NULL or all-0s to represent None
	 */
	public channel: LSPS1ChannelInfo;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const request_id: bigint = bindings.LDKLSPS1ClientEvent_OrderCreated_get_request_id(ptr);
		const request_id_hu_conv: LSPSRequestId = new LSPSRequestId(null, request_id);
			CommonBase.add_ref_from(request_id_hu_conv, this);
		this.request_id = request_id_hu_conv;
		const counterparty_node_id: number = bindings.LDKLSPS1ClientEvent_OrderCreated_get_counterparty_node_id(ptr);
		const counterparty_node_id_conv: Uint8Array = bindings.decodeUint8Array(counterparty_node_id);
		this.counterparty_node_id = counterparty_node_id_conv;
		const order_id: bigint = bindings.LDKLSPS1ClientEvent_OrderCreated_get_order_id(ptr);
		const order_id_hu_conv: LSPS1OrderId = new LSPS1OrderId(null, order_id);
			CommonBase.add_ref_from(order_id_hu_conv, this);
		this.order_id = order_id_hu_conv;
		const order: bigint = bindings.LDKLSPS1ClientEvent_OrderCreated_get_order(ptr);
		const order_hu_conv: LSPS1OrderParams = new LSPS1OrderParams(null, order);
			CommonBase.add_ref_from(order_hu_conv, this);
		this.order = order_hu_conv;
		const payment: bigint = bindings.LDKLSPS1ClientEvent_OrderCreated_get_payment(ptr);
		const payment_hu_conv: LSPS1PaymentInfo = new LSPS1PaymentInfo(null, payment);
			CommonBase.add_ref_from(payment_hu_conv, this);
		this.payment = payment_hu_conv;
		const channel: bigint = bindings.LDKLSPS1ClientEvent_OrderCreated_get_channel(ptr);
		const channel_hu_conv: LSPS1ChannelInfo = new LSPS1ChannelInfo(null, channel);
			CommonBase.add_ref_from(channel_hu_conv, this);
		this.channel = channel_hu_conv;
	}
}
/** A LSPS1ClientEvent of type OrderStatus */
export class LSPS1ClientEvent_OrderStatus extends LSPS1ClientEvent {
	/**
	...
	public constructor(ptr: bigint) {
		super(null, ptr);
		const request_id: bigint = bindings.LDKLSPS1ClientEvent_OrderStatus_get_request_id(ptr);
		const request_id_hu_conv: LSPSRequestId = new LSPSRequestId(null, request_id);
			CommonBase.add_ref_from(request_id_hu_conv, this);
		this.request_id = request_id_hu_conv;
		const counterparty_node_id: number = bindings.LDKLSPS1ClientEvent_OrderStatus_get_counterparty_node_id(ptr);
		const counterparty_node_id_conv: Uint8Array = bindings.decodeUint8Array(counterparty_node_id);
		this.counterparty_node_id = counterparty_node_id_conv;
		const order_id: bigint = bindings.LDKLSPS1ClientEvent_OrderStatus_get_order_id(ptr);
		const order_id_hu_conv: LSPS1OrderId = new LSPS1OrderId(null, order_id);
			CommonBase.add_ref_from(order_id_hu_conv, this);
		this.order_id = order_id_hu_conv;
		const order: bigint = bindings.LDKLSPS1ClientEvent_OrderStatus_get_order(ptr);
		const order_hu_conv: LSPS1OrderParams = new LSPS1OrderParams(null, order);
			CommonBase.add_ref_from(order_hu_conv, this);
		this.order = order_hu_conv;
		const payment: bigint = bindings.LDKLSPS1ClientEvent_OrderStatus_get_payment(ptr);
		const payment_hu_conv: LSPS1PaymentInfo = new LSPS1PaymentInfo(null, payment);
			CommonBase.add_ref_from(payment_hu_conv, this);
		this.payment = payment_hu_conv;
		const channel: bigint = bindings.LDKLSPS1ClientEvent_OrderStatus_get_channel(ptr);
		const channel_hu_conv: LSPS1ChannelInfo = new LSPS1ChannelInfo(null, channel);
			CommonBase.add_ref_from(channel_hu_conv, this);
		this.channel = channel_hu_conv;
	}
...
export class LSPS1ClientEvent_OrderRequestFailed extends LSPS1ClientEvent {
	/**
	...
	public constructor(ptr: bigint) {
		super(null, ptr);
		const request_id: bigint = bindings.LDKLSPS1ClientEvent_OrderRequestFailed_get_request_id(ptr);
		const request_id_hu_conv: LSPSRequestId = new LSPSRequestId(null, request_id);
			CommonBase.add_ref_from(request_id_hu_conv, this);
		this.request_id = request_id_hu_conv;
		const counterparty_node_id: number = bindings.LDKLSPS1ClientEvent_OrderRequestFailed_get_counterparty_node_id(ptr);
		const counterparty_node_id_conv: Uint8Array = bindings.decodeUint8Array(counterparty_node_id);
		this.counterparty_node_id = counterparty_node_id_conv;
		const error: bigint = bindings.LDKLSPS1ClientEvent_OrderRequestFailed_get_error(ptr);
		const error_hu_conv: LSPSResponseError = new LSPSResponseError(null, error);
			CommonBase.add_ref_from(error_hu_conv, this);
		this.error = error_hu_conv;
	}
