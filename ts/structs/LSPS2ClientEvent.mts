 ...
 */
export class LSPS2ClientEvent extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.LSPS2ClientEvent_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): LSPS2ClientEvent {
		const raw_ty: number = bindings.LDKLSPS2ClientEvent_ty_from_ptr(ptr);
		switch (raw_ty) {
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS2ClientEvent_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS2ClientEvent {
		const ret: bigint = bindings.LSPS2ClientEvent_clone(this.ptr);
		const ret_hu_conv: LSPS2ClientEvent = LSPS2ClientEvent.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_opening_parameters_ready(request_id: LSPSRequestId, counterparty_node_id: Uint8Array, opening_fee_params_menu: LSPS2OpeningFeeParams[]): LSPS2ClientEvent {
		const ret: bigint = bindings.LSPS2ClientEvent_opening_parameters_ready(CommonBase.get_ptr_of(request_id), bindings.encodeUint8Array(counterparty_node_id), bindings.encodeUint64Array(opening_fee_params_menu.map(opening_fee_params_menu_conv_23 => CommonBase.get_ptr_of(opening_fee_params_menu_conv_23))));
		const ret_hu_conv: LSPS2ClientEvent = LSPS2ClientEvent.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_invoice_parameters_ready(request_id: LSPSRequestId, counterparty_node_id: Uint8Array, intercept_scid: bigint, cltv_expiry_delta: number, payment_size_msat: Option_u64Z): LSPS2ClientEvent {
		const ret: bigint = bindings.LSPS2ClientEvent_invoice_parameters_ready(CommonBase.get_ptr_of(request_id), bindings.encodeUint8Array(counterparty_node_id), intercept_scid, cltv_expiry_delta, CommonBase.get_ptr_of(payment_size_msat));
		const ret_hu_conv: LSPS2ClientEvent = LSPS2ClientEvent.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS2ClientEvent): boolean {
		const ret: boolean = bindings.LSPS2ClientEvent_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}

}
/** A LSPS2ClientEvent of type OpeningParametersReady */
export class LSPS2ClientEvent_OpeningParametersReady extends LSPS2ClientEvent {
	/**
	 ...
	 */
	public opening_fee_params_menu: LSPS2OpeningFeeParams[];
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const request_id: bigint = bindings.LDKLSPS2ClientEvent_OpeningParametersReady_get_request_id(ptr);
		...
		const counterparty_node_id: number = bindings.LDKLSPS2ClientEvent_OpeningParametersReady_get_counterparty_node_id(ptr);
		...
		const opening_fee_params_menu: number = bindings.LDKLSPS2ClientEvent_OpeningParametersReady_get_opening_fee_params_menu(ptr);
		const opening_fee_params_menu_conv_23_len: number = bindings.getArrayLength(opening_fee_params_menu);
			const opening_fee_params_menu_conv_23_arr: LSPS2OpeningFeeParams[] = new Array(opening_fee_params_menu_conv_23_len).fill(null);
			for (var x = 0; x < opening_fee_params_menu_conv_23_len; x++) {
				const opening_fee_params_menu_conv_23: bigint = bindings.getU64ArrayElem(opening_fee_params_menu, x);
				const opening_fee_params_menu_conv_23_hu_conv: LSPS2OpeningFeeParams = new LSPS2OpeningFeeParams(null, opening_fee_params_menu_conv_23);
				CommonBase.add_ref_from(opening_fee_params_menu_conv_23_hu_conv, this);
				opening_fee_params_menu_conv_23_arr[x] = opening_fee_params_menu_conv_23_hu_conv;
			}
			bindings.freeWasmMemory(opening_fee_params_menu)
		this.opening_fee_params_menu = opening_fee_params_menu_conv_23_arr;
	}
}
/** A LSPS2ClientEvent of type InvoiceParametersReady */
export class LSPS2ClientEvent_InvoiceParametersReady extends LSPS2ClientEvent {
	/**
	 ...
	 */
	public payment_size_msat: Option_u64Z;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const request_id: bigint = bindings.LDKLSPS2ClientEvent_InvoiceParametersReady_get_request_id(ptr);
		const request_id_hu_conv: LSPSRequestId = new LSPSRequestId(null, request_id);
			CommonBase.add_ref_from(request_id_hu_conv, this);
		this.request_id = request_id_hu_conv;
		const counterparty_node_id: number = bindings.LDKLSPS2ClientEvent_InvoiceParametersReady_get_counterparty_node_id(ptr);
		const counterparty_node_id_conv: Uint8Array = bindings.decodeUint8Array(counterparty_node_id);
		this.counterparty_node_id = counterparty_node_id_conv;
		...
		const payment_size_msat: bigint = bindings.LDKLSPS2ClientEvent_InvoiceParametersReady_get_payment_size_msat(ptr);
		const payment_size_msat_hu_conv: Option_u64Z = Option_u64Z.constr_from_ptr(payment_size_msat);
