 ...
 */
export class LSPSDateTime extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPSDateTime_free);
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPSDateTime_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPSDateTime {
		const ret: bigint = bindings.LSPSDateTime_clone(this.ptr);
	 ...
	 */
	public eq(b: LSPSDateTime): boolean {
		const ret: boolean = bindings.LSPSDateTime_eq(this.ptr, CommonBase.get_ptr_of(b));
	 ...
	 */
	public hash(): bigint {
		const ret: bigint = bindings.LSPSDateTime_hash(this.ptr);
		return ret;
	}
	 ...
	 */
	public to_rfc3339(): string {
		const ret: number = bindings.LSPSDateTime_to_rfc3339(this.ptr);
	 ...
	 */
	public static constructor_from_str(s: string): Result_LSPSDateTimeNoneZ {
		const ret: bigint = bindings.LSPSDateTime_from_str(bindings.encodeString(s));
	...
	public to_str(): string {
		const ret: number = bindings.LSPSDateTime_to_str(this.ptr);
		const ret_conv: string = bindings.decodeString(ret);
		return ret_conv;
	}
