...
export class ForwardTlvs extends CommonBase {
	...
	public static constructor_new(short_channel_id_arg: bigint, payment_relay_arg: PaymentRelay, payment_constraints_arg: PaymentConstraints, features_arg: BlindedHopFeatures, next_blinding_override_arg: Uint8Array|null): ForwardTlvs {
		const ret: bigint = bindings.ForwardTlvs_new(short_channel_id_arg, CommonBase.get_ptr_of(payment_relay_arg), CommonBase.get_ptr_of(payment_constraints_arg), CommonBase.get_ptr_of(features_arg), bindings.encodeUint8Array(bindings.check_arr_len(next_blinding_override_arg, 33)));
