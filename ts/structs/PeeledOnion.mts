...
export class PeeledOnion extends CommonBase {
	 ...
	 */
	public static constructor_receive(a: ParsedOnionMessageContents, b: Option_MessageContextZ, c: BlindedMessagePath): PeeledOnion {
		const ret: bigint = bindings.PeeledOnion_receive(CommonBase.get_ptr_of(a), CommonBase.get_ptr_of(b), CommonBase.get_ptr_of(c));
		const ret_hu_conv: PeeledOnion = PeeledOnion.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
...
export class PeeledOnion_Receive extends PeeledOnion {
	...
	public _1: Option_MessageContextZ;
	/**
	...
	public constructor(ptr: bigint) {
		...
		const _0_hu_conv: ParsedOnionMessageContents = ParsedOnionMessageContents.constr_from_ptr(_0);
			CommonBase.add_ref_from(_0_hu_conv, this);
		this._0 = _0_hu_conv;
		const _1: bigint = bindings.LDKPeeledOnion_Receive_get__1(ptr);
		const _1_hu_conv: Option_MessageContextZ = Option_MessageContextZ.constr_from_ptr(_1);
			CommonBase.add_ref_from(_1_hu_conv, this);
		this._1 = _1_hu_conv;
