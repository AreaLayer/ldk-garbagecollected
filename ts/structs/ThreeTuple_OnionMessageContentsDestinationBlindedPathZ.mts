...
export class ThreeTuple_OnionMessageContentsDestinationBlindedPathZ extends CommonBase {
	...
	public static constructor_new(a: OnionMessageContents, b: Destination, c: BlindedPath): ThreeTuple_OnionMessageContentsDestinationBlindedPathZ {
		const ret: bigint = bindings.C3Tuple_OnionMessageContentsDestinationBlindedPathZ_new(CommonBase.get_ptr_of(a), CommonBase.get_ptr_of(b), CommonBase.get_ptr_of(c));
		const ret_hu_conv: ThreeTuple_OnionMessageContentsDestinationBlindedPathZ = new ThreeTuple_OnionMessageContentsDestinationBlindedPathZ(null, ret);
