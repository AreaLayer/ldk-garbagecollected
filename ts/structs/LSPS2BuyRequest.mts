 ...
 */
export class LSPS2BuyRequest extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS2BuyRequest_free);
	}

	/**
	 * The fee parameters you would like to use.
	 */
	public get_opening_fee_params(): LSPS2OpeningFeeParams {
		const ret: bigint = bindings.LSPS2BuyRequest_get_opening_fee_params(this.ptr);
	 ...
	 * The fee parameters you would like to use.
	 */
	public set_opening_fee_params(val: LSPS2OpeningFeeParams): void {
		bindings.LSPS2BuyRequest_set_opening_fee_params(this.ptr, CommonBase.get_ptr_of(val));
	}

	/**
	 * The size of the initial payment you expect to receive.
	 */
	public get_payment_size_msat(): Option_u64Z {
		const ret: bigint = bindings.LSPS2BuyRequest_get_payment_size_msat(this.ptr);
	 ...
	 * The size of the initial payment you expect to receive.
	 */
	public set_payment_size_msat(val: Option_u64Z): void {
		bindings.LSPS2BuyRequest_set_payment_size_msat(this.ptr, CommonBase.get_ptr_of(val));
	}

	/**
	 * Constructs a new LSPS2BuyRequest given each field
	 */
	public static constructor_new(opening_fee_params_arg: LSPS2OpeningFeeParams, payment_size_msat_arg: Option_u64Z): LSPS2BuyRequest {
		const ret: bigint = bindings.LSPS2BuyRequest_new(CommonBase.get_ptr_of(opening_fee_params_arg), CommonBase.get_ptr_of(payment_size_msat_arg));
		const ret_hu_conv: LSPS2BuyRequest = new LSPS2BuyRequest(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS2BuyRequest_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS2BuyRequest {
		const ret: bigint = bindings.LSPS2BuyRequest_clone(this.ptr);
		const ret_hu_conv: LSPS2BuyRequest = new LSPS2BuyRequest(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS2BuyRequest): boolean {
		const ret: boolean = bindings.LSPS2BuyRequest_eq(this.ptr, CommonBase.get_ptr_of(b));
