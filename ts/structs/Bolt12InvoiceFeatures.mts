...
export class Bolt12InvoiceFeatures extends CommonBase {
	...
	public eq(b: Bolt12InvoiceFeatures): boolean {
		const ret: boolean = bindings.Bolt12InvoiceFeatures_eq(this.ptr, CommonBase.get_ptr_of(b));
	 ...
	 */
	public required_unknown_bits_from(other: Bolt12InvoiceFeatures): bigint[] {
