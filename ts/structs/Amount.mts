...
export class Amount extends CommonBase {
	 ...
	 */
	public static constructor_currency(iso4217_code: Uint8Array, amount: bigint): Amount {
		const ret: bigint = bindings.Amount_currency(bindings.encodeUint8Array(bindings.check_arr_len(iso4217_code, 3)), amount);
		const ret_hu_conv: Amount = Amount.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
...
export class Amount_Currency extends Amount {
	 ...
	 */
	public iso4217_code: Uint8Array;
	/**
	...
	public constructor(ptr: bigint) {
		super(null, ptr);
		const iso4217_code: number = bindings.LDKAmount_Currency_get_iso4217_code(ptr);
		const iso4217_code_conv: Uint8Array = bindings.decodeUint8Array(iso4217_code);
