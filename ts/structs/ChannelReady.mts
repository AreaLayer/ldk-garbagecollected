...
export class ChannelReady extends CommonBase {
	...
	public static constructor_new(channel_id_arg: ChannelId, next_per_commitment_point_arg: Uint8Array, short_channel_id_alias_arg: Option_u64Z): ChannelReady {
		const ret: bigint = bindings.ChannelReady_new(CommonBase.get_ptr_of(channel_id_arg), bindings.encodeUint8Array(bindings.check_arr_len(next_per_commitment_point_arg, 33)), CommonBase.get_ptr_of(short_channel_id_alias_arg));
