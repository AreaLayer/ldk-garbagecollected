...
export class BlindedPath extends CommonBase {
	 ...
	 */
	public get_introduction_node(): IntroductionNode {
		const ret: bigint = bindings.BlindedPath_get_introduction_node(this.ptr);
	 ...
	 * [`encrypted_payload`]: BlindedHop::encrypted_payload
	 */
	public set_introduction_node(val: IntroductionNode): void {
		bindings.BlindedPath_set_introduction_node(this.ptr, CommonBase.get_ptr_of(val));
	...
	public set_blinded_hops(val: BlindedHop[]): void {
		bindings.BlindedPath_set_blinded_hops(this.ptr, bindings.encodeUint64Array(val.map(val_conv_12 => CommonBase.get_ptr_of(val_conv_12))));
	 ...
	 */
	public static constructor_new(introduction_node_arg: IntroductionNode, blinding_point_arg: Uint8Array, blinded_hops_arg: BlindedHop[]): BlindedPath {
		const ret: bigint = bindings.BlindedPath_new(CommonBase.get_ptr_of(introduction_node_arg), bindings.encodeUint8Array(bindings.check_arr_len(blinding_point_arg, 33)), bindings.encodeUint64Array(blinded_hops_arg.map(blinded_hops_arg_conv_12 => CommonBase.get_ptr_of(blinded_hops_arg_conv_12))));
		const ret_hu_conv: BlindedPath = new BlindedPath(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, introduction_node_arg);
	...
	public eq(b: BlindedPath): boolean {
		const ret: boolean = bindings.BlindedPath_eq(this.ptr, CommonBase.get_ptr_of(b));
	...
	public public_introduction_node_id(network_graph: ReadOnlyNetworkGraph): NodeId {
		const ret: bigint = bindings.BlindedPath_public_introduction_node_id(this.ptr, CommonBase.get_ptr_of(network_graph));
