...
export class LSPS1PaymentInfo extends CommonBase {
	 ...
	 */
	public get_bolt11(): LSPS1Bolt11PaymentInfo {
		const ret: bigint = bindings.LSPS1PaymentInfo_get_bolt11(this.ptr);
	 ...
	 */
	public set_bolt11(val: LSPS1Bolt11PaymentInfo|null): void {
	 ...
	 * Note that the return value (or a relevant inner pointer) may be NULL or all-0s to represent None
	 */
	public get_onchain(): LSPS1OnchainPaymentInfo {
		const ret: bigint = bindings.LSPS1PaymentInfo_get_onchain(this.ptr);
	 ...
	 * Note that val (or a relevant inner pointer) may be NULL or all-0s to represent None
	 */
	public set_onchain(val: LSPS1OnchainPaymentInfo|null): void {
	 ...
	 */
	public static constructor_new(bolt11_arg: LSPS1Bolt11PaymentInfo|null, onchain_arg: LSPS1OnchainPaymentInfo|null): LSPS1PaymentInfo {
		const ret: bigint = bindings.LSPS1PaymentInfo_new(bolt11_arg == null ? 0n : CommonBase.get_ptr_of(bolt11_arg), onchain_arg == null ? 0n : CommonBase.get_ptr_of(onchain_arg));
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS1PaymentInfo_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS1PaymentInfo {
		const ret: bigint = bindings.LSPS1PaymentInfo_clone(this.ptr);
		const ret_hu_conv: LSPS1PaymentInfo = new LSPS1PaymentInfo(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS1PaymentInfo): boolean {
		const ret: boolean = bindings.LSPS1PaymentInfo_eq(this.ptr, CommonBase.get_ptr_of(b));
