...
export class UnauthenticatedReceiveTlvs extends CommonBase {
	...
	public set_payment_secret(val: Uint8Array): void {
		bindings.UnauthenticatedReceiveTlvs_set_payment_secret(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 32)));
	}
	...
	public static constructor_new(payment_secret_arg: Uint8Array, payment_constraints_arg: PaymentConstraints, payment_context_arg: PaymentContext): UnauthenticatedReceiveTlvs {
		const ret: bigint = bindings.UnauthenticatedReceiveTlvs_new(bindings.encodeUint8Array(bindings.check_arr_len(payment_secret_arg, 32)), CommonBase.get_ptr_of(payment_constraints_arg), CommonBase.get_ptr_of(payment_context_arg));
