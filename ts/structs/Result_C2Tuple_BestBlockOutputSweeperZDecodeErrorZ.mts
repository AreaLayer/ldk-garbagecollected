...
export class Result_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o: TwoTuple_BestBlockOutputSweeperZ): Result_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ {
		const ret: bigint = bindings.CResult_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ {
		const ret: bigint = bindings.CResult_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ = Result_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

}
export class Result_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ_OK extends Result_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ {
	public res: TwoTuple_BestBlockOutputSweeperZ;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: TwoTuple_BestBlockOutputSweeperZ = new TwoTuple_BestBlockOutputSweeperZ(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ_Err extends Result_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ {
	public err: DecodeError;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_C2Tuple_BestBlockOutputSweeperZDecodeErrorZ_get_err(ptr);
