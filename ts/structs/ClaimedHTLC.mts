...
export class ClaimedHTLC extends CommonBase {
	 ...
	 */
	public static constructor_new(channel_id_arg: ChannelId, user_channel_id_arg: bigint, cltv_expiry_arg: number, value_msat_arg: bigint, counterparty_skimmed_fee_msat_arg: bigint): ClaimedHTLC {
		const ret: bigint = bindings.ClaimedHTLC_new(CommonBase.get_ptr_of(channel_id_arg), bindings.encodeUint128(user_channel_id_arg), cltv_expiry_arg, value_msat_arg, counterparty_skimmed_fee_msat_arg);
