...
export class PaymentContext extends CommonBase {
	 ...
	 */
	public static constructor_unknown(a: UnknownPaymentContext): PaymentContext {
		const ret: bigint = bindings.PaymentContext_unknown(CommonBase.get_ptr_of(a));
		const ret_hu_conv: PaymentContext = PaymentContext.constr_from_ptr(ret);
...
export class PaymentContext_Unknown extends PaymentContext {
	public unknown: UnknownPaymentContext;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const unknown: bigint = bindings.LDKPaymentContext_Unknown_get_unknown(ptr);
		const unknown_hu_conv: UnknownPaymentContext = new UnknownPaymentContext(null, unknown);
