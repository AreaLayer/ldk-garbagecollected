 ...
 */
export class LSPS2Request extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.LSPS2Request_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): LSPS2Request {
		const raw_ty: number = bindings.LDKLSPS2Request_ty_from_ptr(ptr);
		switch (raw_ty) {
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS2Request_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS2Request {
		const ret: bigint = bindings.LSPS2Request_clone(this.ptr);
		const ret_hu_conv: LSPS2Request = LSPS2Request.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_get_info(a: LSPS2GetInfoRequest): LSPS2Request {
		const ret: bigint = bindings.LSPS2Request_get_info(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS2Request = LSPS2Request.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_buy(a: LSPS2BuyRequest): LSPS2Request {
		const ret: bigint = bindings.LSPS2Request_buy(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS2Request = LSPS2Request.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS2Request): boolean {
		const ret: boolean = bindings.LSPS2Request_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}

}
/** A LSPS2Request of type GetInfo */
export class LSPS2Request_GetInfo extends LSPS2Request {
	public get_info: LSPS2GetInfoRequest;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const get_info: bigint = bindings.LDKLSPS2Request_GetInfo_get_get_info(ptr);
		const get_info_hu_conv: LSPS2GetInfoRequest = new LSPS2GetInfoRequest(null, get_info);
			CommonBase.add_ref_from(get_info_hu_conv, this);
		this.get_info = get_info_hu_conv;
	}
}
/** A LSPS2Request of type Buy */
export class LSPS2Request_Buy extends LSPS2Request {
	public buy: LSPS2BuyRequest;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const buy: bigint = bindings.LDKLSPS2Request_Buy_get_buy(ptr);
		const buy_hu_conv: LSPS2BuyRequest = new LSPS2BuyRequest(null, buy);
