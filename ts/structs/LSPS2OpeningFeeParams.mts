 ...
 */
export class LSPS2OpeningFeeParams extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS2OpeningFeeParams_free);
	}

	/**
	 * The minimum fee required for the channel open.
	 */
	public get_min_fee_msat(): bigint {
		const ret: bigint = bindings.LSPS2OpeningFeeParams_get_min_fee_msat(this.ptr);
		return ret;
	}
	 ...
	 * The minimum fee required for the channel open.
	 */
	public set_min_fee_msat(val: bigint): void {
	 ...
	 */
	public get_proportional(): number {
		const ret: number = bindings.LSPS2OpeningFeeParams_get_proportional(this.ptr);
		return ret;
	}
	 ...
	 * A fee proportional to the size of the initial payment.
	 */
	public set_proportional(val: number): void {
	 ...
	 */
	public get_valid_until(): LSPSDateTime {
		const ret: bigint = bindings.LSPS2OpeningFeeParams_get_valid_until(this.ptr);
	 ...
	 * An [`ISO8601`](https://www.iso.org/iso-8601-date-and-time-format.html) formatted date for which these params are valid.
	 */
	public set_valid_until(val: LSPSDateTime): void {
		bindings.LSPS2OpeningFeeParams_set_valid_until(this.ptr, CommonBase.get_ptr_of(val));
	}

	/**
	 * The number of blocks after confirmation that the LSP promises it will keep the channel alive without closing.
	 */
	public get_min_lifetime(): number {
		const ret: number = bindings.LSPS2OpeningFeeParams_get_min_lifetime(this.ptr);
		return ret;
	}
	 ...
	 * The number of blocks after confirmation that the LSP promises it will keep the channel alive without closing.
	 */
	public set_min_lifetime(val: number): void {
	 ...
	 */
	public get_max_client_to_self_delay(): number {
		const ret: number = bindings.LSPS2OpeningFeeParams_get_max_client_to_self_delay(this.ptr);
		return ret;
	}
	 ...
	 * The maximum number of blocks that the client is allowed to set its `to_self_delay` parameter.
	 */
	public set_max_client_to_self_delay(val: number): void {
	 ...
	 */
	public get_min_payment_size_msat(): bigint {
		const ret: bigint = bindings.LSPS2OpeningFeeParams_get_min_payment_size_msat(this.ptr);
		return ret;
	}
	 ...
	 * The minimum payment size that the LSP will accept when opening a channel.
	 */
	public set_min_payment_size_msat(val: bigint): void {
	 ...
	 */
	public get_max_payment_size_msat(): bigint {
		const ret: bigint = bindings.LSPS2OpeningFeeParams_get_max_payment_size_msat(this.ptr);
		return ret;
	}
	 ...
	 * The maximum payment size that the LSP will accept when opening a channel.
	 */
	public set_max_payment_size_msat(val: bigint): void {
	 ...
	 */
	public get_promise(): string {
		const ret: number = bindings.LSPS2OpeningFeeParams_get_promise(this.ptr);
	 ...
	 * The HMAC used to verify the authenticity of these parameters.
	 */
	public set_promise(val: string): void {
		bindings.LSPS2OpeningFeeParams_set_promise(this.ptr, bindings.encodeString(val));
	}

	/**
	 * Constructs a new LSPS2OpeningFeeParams given each field
	 */
	public static constructor_new(min_fee_msat_arg: bigint, proportional_arg: number, valid_until_arg: LSPSDateTime, min_lifetime_arg: number, max_client_to_self_delay_arg: number, min_payment_size_msat_arg: bigint, max_payment_size_msat_arg: bigint, promise_arg: string): LSPS2OpeningFeeParams {
		const ret: bigint = bindings.LSPS2OpeningFeeParams_new(min_fee_msat_arg, proportional_arg, CommonBase.get_ptr_of(valid_until_arg), min_lifetime_arg, max_client_to_self_delay_arg, min_payment_size_msat_arg, max_payment_size_msat_arg, bindings.encodeString(promise_arg));
		const ret_hu_conv: LSPS2OpeningFeeParams = new LSPS2OpeningFeeParams(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS2OpeningFeeParams_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS2OpeningFeeParams {
		const ret: bigint = bindings.LSPS2OpeningFeeParams_clone(this.ptr);
		const ret_hu_conv: LSPS2OpeningFeeParams = new LSPS2OpeningFeeParams(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS2OpeningFeeParams): boolean {
		const ret: boolean = bindings.LSPS2OpeningFeeParams_eq(this.ptr, CommonBase.get_ptr_of(b));
