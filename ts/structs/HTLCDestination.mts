...
export class HTLCDestination extends CommonBase {
	 ...
	 */
	public static constructor_next_hop_channel(node_id: Uint8Array, channel_id: ChannelId): HTLCDestination {
		const ret: bigint = bindings.HTLCDestination_next_hop_channel(bindings.encodeUint8Array(node_id), CommonBase.get_ptr_of(channel_id));
		const ret_hu_conv: HTLCDestination = HTLCDestination.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_invalid_onion(): HTLCDestination {
		const ret: bigint = bindings.HTLCDestination_invalid_onion();
		const ret_hu_conv: HTLCDestination = HTLCDestination.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public static constructor_failed_payment(payment_hash: Uint8Array): HTLCDestination {
		const ret: bigint = bindings.HTLCDestination_failed_payment(bindings.encodeUint8Array(payment_hash));
		const ret_hu_conv: HTLCDestination = HTLCDestination.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public eq(b: HTLCDestination): boolean {
		const ret: boolean = bindings.HTLCDestination_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}
...
export class HTLCDestination_NextHopChannel extends HTLCDestination {
	...
	public constructor(ptr: bigint) {
		...
		const channel_id: bigint = bindings.LDKHTLCDestination_NextHopChannel_get_channel_id(ptr);
