...
export interface NodeSignerInterface {
	 ...
	 */
	get_inbound_payment_key(): ExpandedKey;
...
export class NodeSigner extends CommonBase {
	...
	public static new_impl(arg: NodeSignerInterface): NodeSigner {
		...
		let structImplementation = {
			get_inbound_payment_key (): bigint {
				const ret: ExpandedKey = arg.get_inbound_payment_key();
	 ...
	 * [phantom node payments]: PhantomKeysManager
	 */
	public get_inbound_payment_key(): ExpandedKey {
		const ret: bigint = bindings.NodeSigner_get_inbound_payment_key(this.ptr);
