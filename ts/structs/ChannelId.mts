...
export class ChannelId extends CommonBase {
	...
	public static constructor_new(a_arg: Uint8Array): ChannelId {
		const ret: bigint = bindings.ChannelId_new(bindings.encodeUint8Array(bindings.check_arr_len(a_arg, 32)));
	...
	public static constructor_v1_from_funding_txid(txid: Uint8Array, output_index: number): ChannelId {
		const ret: bigint = bindings.ChannelId_v1_from_funding_txid(bindings.encodeUint8Array(bindings.check_arr_len(txid, 32)), output_index);
		const ret_hu_conv: ChannelId = new ChannelId(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public static constructor_from_bytes(data: Uint8Array): ChannelId {
		const ret: bigint = bindings.ChannelId_from_bytes(bindings.encodeUint8Array(bindings.check_arr_len(data, 32)));
		const ret_hu_conv: ChannelId = new ChannelId(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public to_str(): string {
		const ret: number = bindings.ChannelId_to_str(this.ptr);
