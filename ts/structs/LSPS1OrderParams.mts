 ...
 */
export class LSPS1OrderParams extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS1OrderParams_free);
	}

	/**
	 * Indicates how many satoshi the LSP will provide on their side.
	 */
	public get_lsp_balance_sat(): bigint {
		const ret: bigint = bindings.LSPS1OrderParams_get_lsp_balance_sat(this.ptr);
		return ret;
	}
	 ...
	 * Indicates how many satoshi the LSP will provide on their side.
	 */
	public set_lsp_balance_sat(val: bigint): void {
	 ...
	 * the channel.
	 */
	public get_client_balance_sat(): bigint {
		const ret: bigint = bindings.LSPS1OrderParams_get_client_balance_sat(this.ptr);
		return ret;
	}
	 ...
	 * the channel.
	 */
	public set_client_balance_sat(val: bigint): void {
	 ...
	 */
	public get_required_channel_confirmations(): number {
		const ret: number = bindings.LSPS1OrderParams_get_required_channel_confirmations(this.ptr);
		return ret;
	}
	 ...
	 * The number of confirmations the funding tx must have before the LSP sends `channel_ready`.
	 */
	public set_required_channel_confirmations(val: number): void {
	 ...
	 */
	public get_funding_confirms_within_blocks(): number {
		const ret: number = bindings.LSPS1OrderParams_get_funding_confirms_within_blocks(this.ptr);
		return ret;
	}
	 ...
	 * The maximum number of blocks the client wants to wait until the funding transaction is confirmed.
	 */
	public set_funding_confirms_within_blocks(val: number): void {
	 ...
	 */
	public get_channel_expiry_blocks(): number {
		const ret: number = bindings.LSPS1OrderParams_get_channel_expiry_blocks(this.ptr);
		return ret;
	}
	 ...
	 * Indicates how long the channel is leased for in block time.
	 */
	public set_channel_expiry_blocks(val: number): void {
	 ...
	 */
	public get_token(): Option_StrZ {
		const ret: bigint = bindings.LSPS1OrderParams_get_token(this.ptr);
	 ...
	 * May contain arbitrary associated data like a coupon code or a authentication token.
	 */
	public set_token(val: Option_StrZ): void {
		bindings.LSPS1OrderParams_set_token(this.ptr, CommonBase.get_ptr_of(val));
	}

	/**
	 * Indicates if the channel should be announced to the network.
	 */
	public get_announce_channel(): boolean {
		const ret: boolean = bindings.LSPS1OrderParams_get_announce_channel(this.ptr);
		return ret;
	}
	 ...
	 * Indicates if the channel should be announced to the network.
	 */
	public set_announce_channel(val: boolean): void {
	 ...
	 */
	public static constructor_new(lsp_balance_sat_arg: bigint, client_balance_sat_arg: bigint, required_channel_confirmations_arg: number, funding_confirms_within_blocks_arg: number, channel_expiry_blocks_arg: number, token_arg: Option_StrZ, announce_channel_arg: boolean): LSPS1OrderParams {
		const ret: bigint = bindings.LSPS1OrderParams_new(lsp_balance_sat_arg, client_balance_sat_arg, required_channel_confirmations_arg, funding_confirms_within_blocks_arg, channel_expiry_blocks_arg, CommonBase.get_ptr_of(token_arg), announce_channel_arg);
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS1OrderParams_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS1OrderParams {
		const ret: bigint = bindings.LSPS1OrderParams_clone(this.ptr);
		const ret_hu_conv: LSPS1OrderParams = new LSPS1OrderParams(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS1OrderParams): boolean {
		const ret: boolean = bindings.LSPS1OrderParams_eq(this.ptr, CommonBase.get_ptr_of(b));
