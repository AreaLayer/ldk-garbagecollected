...
export class Result_RawLSPSMessageDecodeErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_RawLSPSMessageDecodeErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_RawLSPSMessageDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o: RawLSPSMessage): Result_RawLSPSMessageDecodeErrorZ {
		const ret: bigint = bindings.CResult_RawLSPSMessageDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
		const ret_hu_conv: Result_RawLSPSMessageDecodeErrorZ = Result_RawLSPSMessageDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_RawLSPSMessageDecodeErrorZ {
		const ret: bigint = bindings.CResult_RawLSPSMessageDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_RawLSPSMessageDecodeErrorZ = Result_RawLSPSMessageDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_RawLSPSMessageDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_RawLSPSMessageDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_RawLSPSMessageDecodeErrorZ {
		const ret: bigint = bindings.CResult_RawLSPSMessageDecodeErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_RawLSPSMessageDecodeErrorZ = Result_RawLSPSMessageDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_RawLSPSMessageDecodeErrorZ_OK extends Result_RawLSPSMessageDecodeErrorZ {
	public res: RawLSPSMessage;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_RawLSPSMessageDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: RawLSPSMessage = new RawLSPSMessage(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_RawLSPSMessageDecodeErrorZ_Err extends Result_RawLSPSMessageDecodeErrorZ {
	public err: DecodeError;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_RawLSPSMessageDecodeErrorZ_get_err(ptr);
