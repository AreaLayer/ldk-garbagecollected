...
export class OnionMessage extends CommonBase {
	...
	public static constructor_new(blinding_point_arg: Uint8Array, onion_routing_packet_arg: Packet): OnionMessage {
		const ret: bigint = bindings.OnionMessage_new(bindings.encodeUint8Array(bindings.check_arr_len(blinding_point_arg, 33)), CommonBase.get_ptr_of(onion_routing_packet_arg));
