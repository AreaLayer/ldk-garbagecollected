 ...
 */
export class LSPS0ListProtocolsResponse extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS0ListProtocolsResponse_free);
	}
	 ...
	 */
	public get_protocols(): Uint16Array {
		const ret: number = bindings.LSPS0ListProtocolsResponse_get_protocols(this.ptr);
	 ...
	 * A list of supported protocols.
	 */
	public set_protocols(val: Uint16Array): void {
		bindings.LSPS0ListProtocolsResponse_set_protocols(this.ptr, bindings.encodeUint16Array(val));
	}

	/**
	 * Constructs a new LSPS0ListProtocolsResponse given each field
	 */
	public static constructor_new(protocols_arg: Uint16Array): LSPS0ListProtocolsResponse {
		const ret: bigint = bindings.LSPS0ListProtocolsResponse_new(bindings.encodeUint16Array(protocols_arg));
		const ret_hu_conv: LSPS0ListProtocolsResponse = new LSPS0ListProtocolsResponse(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS0ListProtocolsResponse_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS0ListProtocolsResponse {
		const ret: bigint = bindings.LSPS0ListProtocolsResponse_clone(this.ptr);
		const ret_hu_conv: LSPS0ListProtocolsResponse = new LSPS0ListProtocolsResponse(null, ret);
	 ...
	 */
	public eq(b: LSPS0ListProtocolsResponse): boolean {
		const ret: boolean = bindings.LSPS0ListProtocolsResponse_eq(this.ptr, CommonBase.get_ptr_of(b));
