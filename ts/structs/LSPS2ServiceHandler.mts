...
export class LSPS2ServiceHandler extends CommonBase {
	 ...
	 */
	public invalid_token_provided(counterparty_node_id: Uint8Array, request_id: LSPSRequestId): Result_NoneAPIErrorZ {
		const ret: bigint = bindings.LSPS2ServiceHandler_invalid_token_provided(this.ptr, bindings.encodeUint8Array(counterparty_node_id), CommonBase.get_ptr_of(request_id));
	 ...
	 * [`LSPS2ServiceEvent::GetInfo`]: crate::lsps2::event::LSPS2ServiceEvent::GetInfo
	 */
	public opening_fee_params_generated(counterparty_node_id: Uint8Array, request_id: LSPSRequestId, opening_fee_params_menu: LSPS2RawOpeningFeeParams[]): Result_NoneAPIErrorZ {
		const ret: bigint = bindings.LSPS2ServiceHandler_opening_fee_params_generated(this.ptr, bindings.encodeUint8Array(counterparty_node_id), CommonBase.get_ptr_of(request_id), bindings.encodeUint64Array(opening_fee_params_menu.map(opening_fee_params_menu_conv_26 => CommonBase.get_ptr_of(opening_fee_params_menu_conv_26))));
		const ret_hu_conv: Result_NoneAPIErrorZ = Result_NoneAPIErrorZ.constr_from_ptr(ret);
		opening_fee_params_menu.forEach((opening_fee_params_menu_conv_26: LSPS2RawOpeningFeeParams) => { CommonBase.add_ref_from(this, opening_fee_params_menu_conv_26);
	 ...
	 */
	public invoice_parameters_generated(counterparty_node_id: Uint8Array, request_id: LSPSRequestId, intercept_scid: bigint, cltv_expiry_delta: number, client_trusts_lsp: boolean, user_channel_id: bigint): Result_NoneAPIErrorZ {
		const ret: bigint = bindings.LSPS2ServiceHandler_invoice_parameters_generated(this.ptr, bindings.encodeUint8Array(counterparty_node_id), CommonBase.get_ptr_of(request_id), intercept_scid, cltv_expiry_delta, client_trusts_lsp, bindings.encodeUint128(user_channel_id));
		const ret_hu_conv: Result_NoneAPIErrorZ = Result_NoneAPIErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	 ...
	 */
	public htlc_intercepted(intercept_scid: bigint, intercept_id: Uint8Array, expected_outbound_amount_msat: bigint, payment_hash: Uint8Array): Result_NoneAPIErrorZ {
		const ret: bigint = bindings.LSPS2ServiceHandler_htlc_intercepted(this.ptr, intercept_scid, bindings.encodeUint8Array(intercept_id), expected_outbound_amount_msat, bindings.encodeUint8Array(payment_hash));
		const ret_hu_conv: Result_NoneAPIErrorZ = Result_NoneAPIErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	 ...
	 */
	public htlc_handling_failed(failed_next_destination: HTLCDestination): Result_NoneAPIErrorZ {
		const ret: bigint = bindings.LSPS2ServiceHandler_htlc_handling_failed(this.ptr, CommonBase.get_ptr_of(failed_next_destination));
		const ret_hu_conv: Result_NoneAPIErrorZ = Result_NoneAPIErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	 ...
	 */
	public payment_forwarded(next_channel_id: ChannelId): Result_NoneAPIErrorZ {
		const ret: bigint = bindings.LSPS2ServiceHandler_payment_forwarded(this.ptr, CommonBase.get_ptr_of(next_channel_id));
		const ret_hu_conv: Result_NoneAPIErrorZ = Result_NoneAPIErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	 ...
	 */
	public channel_ready(user_channel_id: bigint, channel_id: ChannelId, counterparty_node_id: Uint8Array): Result_NoneAPIErrorZ {
		const ret: bigint = bindings.LSPS2ServiceHandler_channel_ready(this.ptr, bindings.encodeUint128(user_channel_id), CommonBase.get_ptr_of(channel_id), bindings.encodeUint8Array(counterparty_node_id));
		const ret_hu_conv: Result_NoneAPIErrorZ = Result_NoneAPIErrorZ.constr_from_ptr(ret);
