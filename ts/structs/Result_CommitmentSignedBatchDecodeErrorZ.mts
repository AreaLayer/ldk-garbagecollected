...
export class Result_CommitmentSignedBatchDecodeErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_CommitmentSignedBatchDecodeErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_CommitmentSignedBatchDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o: CommitmentSignedBatch): Result_CommitmentSignedBatchDecodeErrorZ {
		const ret: bigint = bindings.CResult_CommitmentSignedBatchDecodeErrorZ_ok(CommonBase.get_ptr_of(o));
		const ret_hu_conv: Result_CommitmentSignedBatchDecodeErrorZ = Result_CommitmentSignedBatchDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_CommitmentSignedBatchDecodeErrorZ {
		const ret: bigint = bindings.CResult_CommitmentSignedBatchDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_CommitmentSignedBatchDecodeErrorZ = Result_CommitmentSignedBatchDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_CommitmentSignedBatchDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_CommitmentSignedBatchDecodeErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_CommitmentSignedBatchDecodeErrorZ {
		const ret: bigint = bindings.CResult_CommitmentSignedBatchDecodeErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_CommitmentSignedBatchDecodeErrorZ = Result_CommitmentSignedBatchDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_CommitmentSignedBatchDecodeErrorZ_OK extends Result_CommitmentSignedBatchDecodeErrorZ {
	public res: CommitmentSignedBatch;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_CommitmentSignedBatchDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: CommitmentSignedBatch = new CommitmentSignedBatch(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_CommitmentSignedBatchDecodeErrorZ_Err extends Result_CommitmentSignedBatchDecodeErrorZ {
	public err: DecodeError;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_CommitmentSignedBatchDecodeErrorZ_get_err(ptr);
