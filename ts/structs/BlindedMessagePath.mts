...
export class BlindedMessagePath extends CommonBase {
	 ...
	 */
	public static constructor_one_hop(recipient_node_id: Uint8Array, context: MessageContext, entropy_source: EntropySource): Result_BlindedMessagePathNoneZ {
		const ret: bigint = bindings.BlindedMessagePath_one_hop(bindings.encodeUint8Array(recipient_node_id), CommonBase.get_ptr_of(context), CommonBase.get_ptr_of(entropy_source));
		const ret_hu_conv: Result_BlindedMessagePathNoneZ = Result_BlindedMessagePathNoneZ.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_new(intermediate_nodes: MessageForwardNode[], recipient_node_id: Uint8Array, context: MessageContext, entropy_source: EntropySource): Result_BlindedMessagePathNoneZ {
		const ret: bigint = bindings.BlindedMessagePath_new(bindings.encodeUint64Array(intermediate_nodes.map(intermediate_nodes_conv_20 => CommonBase.get_ptr_of(intermediate_nodes_conv_20))), bindings.encodeUint8Array(recipient_node_id), CommonBase.get_ptr_of(context), CommonBase.get_ptr_of(entropy_source));
		const ret_hu_conv: Result_BlindedMessagePathNoneZ = Result_BlindedMessagePathNoneZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, entropy_source);
		return ret_hu_conv;
	}
