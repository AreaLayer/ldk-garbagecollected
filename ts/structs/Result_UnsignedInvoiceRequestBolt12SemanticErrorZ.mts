...
export class Result_UnsignedInvoiceRequestBolt12SemanticErrorZ extends CommonBase {
	...
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_UnsignedInvoiceRequestBolt12SemanticErrorZ {
	 ...
	 */
	public static constructor_ok(o: UnsignedInvoiceRequest): Result_UnsignedInvoiceRequestBolt12SemanticErrorZ {
		const ret: bigint = bindings.CResult_UnsignedInvoiceRequestBolt12SemanticErrorZ_ok(CommonBase.get_ptr_of(o));
		const ret_hu_conv: Result_UnsignedInvoiceRequestBolt12SemanticErrorZ = Result_UnsignedInvoiceRequestBolt12SemanticErrorZ.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_err(e: Bolt12SemanticError): Result_UnsignedInvoiceRequestBolt12SemanticErrorZ {
		const ret: bigint = bindings.CResult_UnsignedInvoiceRequestBolt12SemanticErrorZ_err(e);
		const ret_hu_conv: Result_UnsignedInvoiceRequestBolt12SemanticErrorZ = Result_UnsignedInvoiceRequestBolt12SemanticErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_UnsignedInvoiceRequestBolt12SemanticErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_UnsignedInvoiceRequestBolt12SemanticErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_UnsignedInvoiceRequestBolt12SemanticErrorZ {
		const ret: bigint = bindings.CResult_UnsignedInvoiceRequestBolt12SemanticErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_UnsignedInvoiceRequestBolt12SemanticErrorZ = Result_UnsignedInvoiceRequestBolt12SemanticErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
...
export class Result_UnsignedInvoiceRequestBolt12SemanticErrorZ_OK extends Result_UnsignedInvoiceRequestBolt12SemanticErrorZ {
	public res: UnsignedInvoiceRequest;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_UnsignedInvoiceRequestBolt12SemanticErrorZ_get_ok(ptr);
		const res_hu_conv: UnsignedInvoiceRequest = new UnsignedInvoiceRequest(null, res);
