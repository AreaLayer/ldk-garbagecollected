...
export interface AsyncPaymentsMessageHandlerInterface {
	 ...
	 */
	handle_held_htlc_available(message: HeldHtlcAvailable, responder: Responder): Option_C2Tuple_ReleaseHeldHtlcResponseInstructionZZ;
...
export class AsyncPaymentsMessageHandler extends CommonBase {
	...
	public static new_impl(arg: AsyncPaymentsMessageHandlerInterface): AsyncPaymentsMessageHandler {
		...
		let structImplementation = {
			handle_held_htlc_available (message: bigint, responder: bigint): bigint {
				...
				const ret: Option_C2Tuple_ReleaseHeldHtlcResponseInstructionZZ = arg.handle_held_htlc_available(message_hu_conv, responder_hu_conv);
	 ...
	 * Note that responder (or a relevant inner pointer) may be NULL or all-0s to represent None
	 */
	public handle_held_htlc_available(message: HeldHtlcAvailable, responder: Responder|null): Option_C2Tuple_ReleaseHeldHtlcResponseInstructionZZ {
		const ret: bigint = bindings.AsyncPaymentsMessageHandler_handle_held_htlc_available(this.ptr, CommonBase.get_ptr_of(message), responder == null ? 0n : CommonBase.get_ptr_of(responder));
