...
export class Balance extends CommonBase {
	 ...
	 */
	public static constructor_claimable_on_channel_close(amount_satoshis: bigint, transaction_fee_satoshis: bigint, outbound_payment_htlc_rounded_msat: bigint, outbound_forwarded_htlc_rounded_msat: bigint, inbound_claiming_htlc_rounded_msat: bigint, inbound_htlc_rounded_msat: bigint): Balance {
		const ret: bigint = bindings.Balance_claimable_on_channel_close(amount_satoshis, transaction_fee_satoshis, outbound_payment_htlc_rounded_msat, outbound_forwarded_htlc_rounded_msat, inbound_claiming_htlc_rounded_msat, inbound_htlc_rounded_msat);
		const ret_hu_conv: Balance = Balance.constr_from_ptr(ret);
	...
	public static constructor_maybe_timeout_claimable_htlc(amount_satoshis: bigint, claimable_height: number, payment_hash: Uint8Array, outbound_payment: boolean): Balance {
		const ret: bigint = bindings.Balance_maybe_timeout_claimable_htlc(amount_satoshis, claimable_height, bindings.encodeUint8Array(bindings.check_arr_len(payment_hash, 32)), outbound_payment);
		const ret_hu_conv: Balance = Balance.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
...
export class Balance_ClaimableOnChannelClose extends Balance {
	 ...
	 */
	public transaction_fee_satoshis: bigint;
	/**
