...
export class UpdateFulfillHTLC extends CommonBase {
	 ...
	 */
	public static constructor_new(channel_id_arg: ChannelId, htlc_id_arg: bigint, payment_preimage_arg: Uint8Array): UpdateFulfillHTLC {
		const ret: bigint = bindings.UpdateFulfillHTLC_new(CommonBase.get_ptr_of(channel_id_arg), htlc_id_arg, bindings.encodeUint8Array(bindings.check_arr_len(payment_preimage_arg, 32)));
