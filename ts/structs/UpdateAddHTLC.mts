...
export class UpdateAddHTLC extends CommonBase {
	 ...
	 */
	public static constructor_new(channel_id_arg: ChannelId, htlc_id_arg: bigint, amount_msat_arg: bigint, payment_hash_arg: Uint8Array, cltv_expiry_arg: number, skimmed_fee_msat_arg: Option_u64Z, onion_routing_packet_arg: OnionPacket, blinding_point_arg: Uint8Array|null): UpdateAddHTLC {
		const ret: bigint = bindings.UpdateAddHTLC_new(CommonBase.get_ptr_of(channel_id_arg), htlc_id_arg, amount_msat_arg, bindings.encodeUint8Array(payment_hash_arg), cltv_expiry_arg, CommonBase.get_ptr_of(skimmed_fee_msat_arg), CommonBase.get_ptr_of(onion_routing_packet_arg), bindings.encodeUint8Array(blinding_point_arg));
