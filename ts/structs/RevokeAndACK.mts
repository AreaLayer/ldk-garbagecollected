...
export class RevokeAndACK extends CommonBase {
	 ...
	 */
	public static constructor_new(channel_id_arg: ChannelId, per_commitment_secret_arg: Uint8Array, next_per_commitment_point_arg: Uint8Array): RevokeAndACK {
		const ret: bigint = bindings.RevokeAndACK_new(CommonBase.get_ptr_of(channel_id_arg), bindings.encodeUint8Array(bindings.check_arr_len(per_commitment_secret_arg, 32)), bindings.encodeUint8Array(bindings.check_arr_len(next_per_commitment_point_arg, 33)));
