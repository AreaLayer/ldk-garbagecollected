 ...
 */
export class LSPS1OrderId extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS1OrderId_free);
	}

	public get_a(): string {
		const ret: number = bindings.LSPS1OrderId_get_a(this.ptr);
		const ret_conv: string = bindings.decodeString(ret);
		return ret_conv;
	}

	public set_a(val: string): void {
		bindings.LSPS1OrderId_set_a(this.ptr, bindings.encodeString(val));
	}

	/**
	 * Constructs a new LSPS1OrderId given each field
	 */
	public static constructor_new(a_arg: string): LSPS1OrderId {
		const ret: bigint = bindings.LSPS1OrderId_new(bindings.encodeString(a_arg));
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS1OrderId_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS1OrderId {
		const ret: bigint = bindings.LSPS1OrderId_clone(this.ptr);
		const ret_hu_conv: LSPS1OrderId = new LSPS1OrderId(null, ret);
	 ...
	 */
	public eq(b: LSPS1OrderId): boolean {
		const ret: boolean = bindings.LSPS1OrderId_eq(this.ptr, CommonBase.get_ptr_of(b));
	 ...
	 */
	public hash(): bigint {
		const ret: bigint = bindings.LSPS1OrderId_hash(this.ptr);
		return ret;
	}
