...
export class CommitmentSigned extends CommonBase {
	 ...
	 */
	public get_batch(): CommitmentSignedBatch {
		const ret: bigint = bindings.CommitmentSigned_get_batch(this.ptr);
		const ret_hu_conv: CommitmentSignedBatch = new CommitmentSignedBatch(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public set_batch(val: CommitmentSignedBatch|null): void {
	 ...
	 */
	public static constructor_new(channel_id_arg: ChannelId, signature_arg: Uint8Array, htlc_signatures_arg: Uint8Array[], batch_arg: CommitmentSignedBatch|null): CommitmentSigned {
		const ret: bigint = bindings.CommitmentSigned_new(CommonBase.get_ptr_of(channel_id_arg), bindings.encodeUint8Array(signature_arg), bindings.encodeUint32Array(htlc_signatures_arg.map(htlc_signatures_arg_conv_12 => bindings.encodeUint8Array(htlc_signatures_arg_conv_12))), batch_arg == null ? 0n : CommonBase.get_ptr_of(batch_arg));
