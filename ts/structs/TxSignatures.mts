...
export class TxSignatures extends CommonBase {
	 ...
	 */
	public get_funding_outpoint_sig(): Option_ECDSASignatureZ {
		const ret: bigint = bindings.TxSignatures_get_funding_outpoint_sig(this.ptr);
	 ...
	 * Optional signature for the shared input -- the previous funding outpoint -- signed by both peers
	 */
	public set_funding_outpoint_sig(val: Option_ECDSASignatureZ): void {
		bindings.TxSignatures_set_funding_outpoint_sig(this.ptr, CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	 ...
	 */
	public static constructor_new(channel_id_arg: ChannelId, tx_hash_arg: Uint8Array, witnesses_arg: Uint8Array[], funding_outpoint_sig_arg: Option_ECDSASignatureZ): TxSignatures {
		const ret: bigint = bindings.TxSignatures_new(CommonBase.get_ptr_of(channel_id_arg), bindings.encodeUint8Array(bindings.check_arr_len(tx_hash_arg, 32)), bindings.encodeUint32Array(witnesses_arg.map(witnesses_arg_conv_12 => bindings.encodeUint8Array(witnesses_arg_conv_12))), CommonBase.get_ptr_of(funding_outpoint_sig_arg));
		const ret_hu_conv: TxSignatures = new TxSignatures(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, channel_id_arg);
		CommonBase.add_ref_from(ret_hu_conv, funding_outpoint_sig_arg);
		return ret_hu_conv;
	}
