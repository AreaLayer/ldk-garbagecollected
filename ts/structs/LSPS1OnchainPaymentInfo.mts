...
export class LSPS1OnchainPaymentInfo extends CommonBase {
	...
	public get_state(): LSPS1PaymentState {
		const ret: LSPS1PaymentState = bindings.LSPS1OnchainPaymentInfo_get_state(this.ptr);
		return ret;
	}
	...
	public get_expires_at(): LSPSDateTime {
		const ret: bigint = bindings.LSPS1OnchainPaymentInfo_get_expires_at(this.ptr);
	...
	public get_fee_total_sat(): bigint {
		const ret: bigint = bindings.LSPS1OnchainPaymentInfo_get_fee_total_sat(this.ptr);
		return ret;
	}
	...
	public get_order_total_sat(): bigint {
		const ret: bigint = bindings.LSPS1OnchainPaymentInfo_get_order_total_sat(this.ptr);
		return ret;
	}
	...
	public get_address(): Address {
		const ret: bigint = bindings.LSPS1OnchainPaymentInfo_get_address(this.ptr);
		const ret_conv: Address = new Address(null, ret);
		return ret_conv;
	}
	 ...
	 * opened.
	 */
	public set_address(val: Address): void {
	 ...
	 */
	public get_min_onchain_payment_confirmations(): Option_u16Z {
		const ret: bigint = bindings.LSPS1OnchainPaymentInfo_get_min_onchain_payment_confirmations(this.ptr);
	 ...
	 * considered confirmed.
	 */
	public set_min_onchain_payment_confirmations(val: Option_u16Z): void {
	 ...
	 */
	public get_refund_onchain_address(): Option_AddressZ {
		const ret: bigint = bindings.LSPS1OnchainPaymentInfo_get_refund_onchain_address(this.ptr);
	 ...
	 * The address where the LSP will send the funds if the order fails.
	 */
	public set_refund_onchain_address(val: Option_AddressZ): void {
		bindings.LSPS1OnchainPaymentInfo_set_refund_onchain_address(this.ptr, CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS1OnchainPaymentInfo_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS1OnchainPaymentInfo {
		const ret: bigint = bindings.LSPS1OnchainPaymentInfo_clone(this.ptr);
		const ret_hu_conv: LSPS1OnchainPaymentInfo = new LSPS1OnchainPaymentInfo(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS1OnchainPaymentInfo): boolean {
		const ret: boolean = bindings.LSPS1OnchainPaymentInfo_eq(this.ptr, CommonBase.get_ptr_of(b));
