...
export class SpliceInit extends CommonBase {
	...
	public get_funding_feerate_perkw(): number {
		const ret: number = bindings.SpliceInit_get_funding_feerate_perkw(this.ptr);
		return ret;
	}
	 ...
	 */
	public static constructor_new(channel_id_arg: ChannelId, funding_contribution_satoshis_arg: bigint, funding_feerate_perkw_arg: number, locktime_arg: number, funding_pubkey_arg: Uint8Array, require_confirmed_inputs_arg: COption_NoneZ): SpliceInit {
		const ret: bigint = bindings.SpliceInit_new(CommonBase.get_ptr_of(channel_id_arg), funding_contribution_satoshis_arg, funding_feerate_perkw_arg, locktime_arg, bindings.encodeUint8Array(bindings.check_arr_len(funding_pubkey_arg, 33)), require_confirmed_inputs_arg);
