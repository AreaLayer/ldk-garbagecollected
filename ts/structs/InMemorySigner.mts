...
export class InMemorySigner extends CommonBase {
	...
	public set_funding_key(val: Uint8Array): void {
		bindings.InMemorySigner_set_funding_key(this.ptr, bindings.encodeUint8Array(val));
	}
	...
	public set_payment_key(val: Uint8Array): void {
		bindings.InMemorySigner_set_payment_key(this.ptr, bindings.encodeUint8Array(val));
	}
	...
	public static constructor_new(funding_key: Uint8Array, revocation_base_key: Uint8Array, payment_key: Uint8Array, delayed_payment_base_key: Uint8Array, htlc_base_key: Uint8Array, commitment_seed: Uint8Array, channel_value_satoshis: bigint, channel_keys_id: Uint8Array, rand_bytes_unique_start: Uint8Array): InMemorySigner {
		const ret: bigint = bindings.InMemorySigner_new(bindings.encodeUint8Array(funding_key), bindings.encodeUint8Array(revocation_base_key), bindings.encodeUint8Array(payment_key), bindings.encodeUint8Array(delayed_payment_base_key), bindings.encodeUint8Array(htlc_base_key), bindings.encodeUint8Array(commitment_seed), channel_value_satoshis, bindings.encodeUint8Array(channel_keys_id), bindings.encodeUint8Array(rand_bytes_unique_start));
		const ret_hu_conv: InMemorySigner = new InMemorySigner(null, ret);
