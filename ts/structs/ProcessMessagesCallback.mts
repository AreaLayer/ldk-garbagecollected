...
export interface ProcessMessagesCallbackInterface {
...
class LDKProcessMessagesCallbackHolder {
	held: ProcessMessagesCallback|null = null;
}
...
export class ProcessMessagesCallback extends CommonBase {
	/* @internal */
	public bindings_instance: bindings.LDKProcessMessagesCallback|null;
	...
	public static new_impl(arg: ProcessMessagesCallbackInterface): ProcessMessagesCallback {
		const impl_holder: LDKProcessMessagesCallbackHolder = new LDKProcessMessagesCallbackHolder();
		let structImplementation = {
			call (): void {
				arg.call();
			},
		} as bindings.LDKProcessMessagesCallback;
		const ptr_idx: [bigint, number] = bindings.LDKProcessMessagesCallback_new(structImplementation);
