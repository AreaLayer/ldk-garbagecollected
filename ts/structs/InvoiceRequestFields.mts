...
export class InvoiceRequestFields extends CommonBase {
	 ...
	 */
	public get_payer_id(): Uint8Array {
		const ret: number = bindings.InvoiceRequestFields_get_payer_id(this.ptr);
	 ...
	 * A possibly transient pubkey used to sign the invoice request.
	 */
	public set_payer_id(val: Uint8Array): void {
	 ...
	 */
	public static constructor_new(payer_id_arg: Uint8Array, quantity_arg: Option_u64Z, payer_note_truncated_arg: UntrustedString|null): InvoiceRequestFields {
		const ret: bigint = bindings.InvoiceRequestFields_new(bindings.encodeUint8Array(bindings.check_arr_len(payer_id_arg, 33)), CommonBase.get_ptr_of(quantity_arg), payer_note_truncated_arg == null ? 0n : CommonBase.get_ptr_of(payer_note_truncated_arg));
		const ret_hu_conv: InvoiceRequestFields = new InvoiceRequestFields(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, quantity_arg);
		CommonBase.add_ref_from(ret_hu_conv, payer_note_truncated_arg);
		return ret_hu_conv;
	}
