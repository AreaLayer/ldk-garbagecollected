...
export class InvoiceRequestFields extends CommonBase {
	...
	public set_payer_signing_pubkey(val: Uint8Array): void {
		bindings.InvoiceRequestFields_set_payer_signing_pubkey(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(val, 33)));
	}
	...
	public static constructor_new(payer_signing_pubkey_arg: Uint8Array, quantity_arg: Option_u64Z, payer_note_truncated_arg: UntrustedString|null, human_readable_name_arg: HumanReadableName|null): InvoiceRequestFields {
		const ret: bigint = bindings.InvoiceRequestFields_new(bindings.encodeUint8Array(bindings.check_arr_len(payer_signing_pubkey_arg, 33)), CommonBase.get_ptr_of(quantity_arg), payer_note_truncated_arg == null ? 0n : CommonBase.get_ptr_of(payer_note_truncated_arg), human_readable_name_arg == null ? 0n : CommonBase.get_ptr_of(human_readable_name_arg));
