...
export class BlindedForward extends CommonBase {
	...
	public static constructor_new(inbound_blinding_point_arg: Uint8Array, failure_arg: BlindedFailure, next_blinding_override_arg: Uint8Array|null): BlindedForward {
		const ret: bigint = bindings.BlindedForward_new(bindings.encodeUint8Array(bindings.check_arr_len(inbound_blinding_point_arg, 33)), failure_arg, bindings.encodeUint8Array(bindings.check_arr_len(next_blinding_override_arg, 33)));
