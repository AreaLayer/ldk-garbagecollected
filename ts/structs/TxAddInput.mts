...
export class TxAddInput extends CommonBase {
	 ...
	 */
	public static constructor_new(channel_id_arg: ChannelId, serial_id_arg: bigint, prevtx_arg: TransactionU16LenLimited, prevtx_out_arg: number, sequence_arg: number, shared_input_txid_arg: Option_ThirtyTwoBytesZ): TxAddInput {
