...
export class TxAddInput extends CommonBase {
	 ...
	 */
	public static constructor_new(channel_id_arg: ChannelId, serial_id_arg: bigint, prevtx_arg: TransactionU16LenLimited, prevtx_out_arg: number, sequence_arg: number): TxAddInput {
		const ret: bigint = bindings.TxAddInput_new(CommonBase.get_ptr_of(channel_id_arg), serial_id_arg, CommonBase.get_ptr_of(prevtx_arg), prevtx_out_arg, sequence_arg);
