...
export class MigratableKVStore extends CommonBase {
	...
	public static new_impl(arg: MigratableKVStoreInterface, kVStore_impl: KVStoreInterface): MigratableKVStore {
		...
		const ptr_idx: [bigint, number] = bindings.LDKMigratableKVStore_new(structImplementation, kVStore.instance_idx!);
