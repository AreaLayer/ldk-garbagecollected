...
export class ThreeTuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ extends CommonBase {
	...
	public static constructor_new(a: Uint8Array, b: RecipientOnionFields, c: RouteParameters): ThreeTuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ {
		const ret: bigint = bindings.C3Tuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ_new(bindings.encodeUint8Array(a), CommonBase.get_ptr_of(b), CommonBase.get_ptr_of(c));
		const ret_hu_conv: ThreeTuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ = new ThreeTuple_ThirtyTwoBytesRecipientOnionFieldsRouteParametersZ(null, ret);
