...
export class ChainMonitor extends CommonBase {
	...
	public channel_monitor_updated(funding_txo: OutPoint, completed_update_id: MonitorUpdateId): Result_NoneAPIErrorZ {
		const ret: bigint = bindings.ChainMonitor_channel_monitor_updated(this.ptr, CommonBase.get_ptr_of(funding_txo), CommonBase.get_ptr_of(completed_update_id));
	...
	public signer_unblocked(monitor_opt: OutPoint|null): void {
		...
		CommonBase.add_ref_from(this, monitor_opt);
	}
