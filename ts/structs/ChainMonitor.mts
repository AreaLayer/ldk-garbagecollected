...
export class ChainMonitor extends CommonBase {
	...
	public get_monitor(funding_txo: OutPoint): Result_LockedChannelMonitorNoneZ {
		const ret: bigint = bindings.ChainMonitor_get_monitor(this.ptr, CommonBase.get_ptr_of(funding_txo));
	 ...
	 */
	public list_monitors(): TwoTuple_OutPointChannelIdZ[] {
		const ret: number = bindings.ChainMonitor_list_monitors(this.ptr);
		const ret_conv_29_len: number = bindings.getArrayLength(ret);
		const ret_conv_29_arr: TwoTuple_OutPointChannelIdZ[] = new Array(ret_conv_29_len).fill(null);
		for (var d = 0; d < ret_conv_29_len; d++) {
			const ret_conv_29: bigint = bindings.getU64ArrayElem(ret, d);
			const ret_conv_29_hu_conv: TwoTuple_OutPointChannelIdZ = new TwoTuple_OutPointChannelIdZ(null, ret_conv_29);
	 ...
	 */
	public list_pending_monitor_updates(): TwoTuple_OutPointCVec_u64ZZ[] {
		const ret: number = bindings.ChainMonitor_list_pending_monitor_updates(this.ptr);
		const ret_conv_29_len: number = bindings.getArrayLength(ret);
		const ret_conv_29_arr: TwoTuple_OutPointCVec_u64ZZ[] = new Array(ret_conv_29_len).fill(null);
		for (var d = 0; d < ret_conv_29_len; d++) {
			const ret_conv_29: bigint = bindings.getU64ArrayElem(ret, d);
			const ret_conv_29_hu_conv: TwoTuple_OutPointCVec_u64ZZ = new TwoTuple_OutPointCVec_u64ZZ(null, ret_conv_29);
			CommonBase.add_ref_from(ret_conv_29_hu_conv, this);
			ret_conv_29_arr[d] = ret_conv_29_hu_conv;
		}
		bindings.freeWasmMemory(ret)
	 ...
	 */
	public channel_monitor_updated(funding_txo: OutPoint, completed_update_id: bigint): Result_NoneAPIErrorZ {
		const ret: bigint = bindings.ChainMonitor_channel_monitor_updated(this.ptr, CommonBase.get_ptr_of(funding_txo), completed_update_id);
	 ...
	 */
	public signer_unblocked(monitor_opt: OutPoint|null): void {
