...
export class InvoiceRequestWithExplicitPayerIdBuilder extends CommonBase {
	 ...
	 */
	public build(): Result_UnsignedInvoiceRequestBolt12SemanticErrorZ {
		const ret: bigint = bindings.InvoiceRequestWithExplicitPayerIdBuilder_build(this.ptr);
	...
	public chain(network: Network): Result_NoneBolt12SemanticErrorZ {
		const ret: bigint = bindings.InvoiceRequestWithExplicitPayerIdBuilder_chain(this.ptr, network);
	...
	public amount_msats(amount_msats: bigint): Result_NoneBolt12SemanticErrorZ {
		const ret: bigint = bindings.InvoiceRequestWithExplicitPayerIdBuilder_amount_msats(this.ptr, amount_msats);
		const ret_hu_conv: Result_NoneBolt12SemanticErrorZ = Result_NoneBolt12SemanticErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public quantity(quantity: bigint): Result_NoneBolt12SemanticErrorZ {
		const ret: bigint = bindings.InvoiceRequestWithExplicitPayerIdBuilder_quantity(this.ptr, quantity);
		const ret_hu_conv: Result_NoneBolt12SemanticErrorZ = Result_NoneBolt12SemanticErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
