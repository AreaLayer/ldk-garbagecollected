...
export class NodeFeatures extends CommonBase {
	...
	public eq(b: NodeFeatures): boolean {
		const ret: boolean = bindings.NodeFeatures_eq(this.ptr, CommonBase.get_ptr_of(b));
	 ...
	 */
	public required_unknown_bits_from(other: NodeFeatures): bigint[] {
	 ...
	 */
	public clear_upfront_shutdown_script(): NodeFeatures {
		const ret: bigint = bindings.NodeFeatures_clear_upfront_shutdown_script(this.ptr);
		const ret_hu_conv: NodeFeatures = new NodeFeatures(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public clear_shutdown_anysegwit(): NodeFeatures {
		const ret: bigint = bindings.NodeFeatures_clear_shutdown_anysegwit(this.ptr);
		const ret_hu_conv: NodeFeatures = new NodeFeatures(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public clear_wumbo(): NodeFeatures {
		const ret: bigint = bindings.NodeFeatures_clear_wumbo(this.ptr);
		const ret_hu_conv: NodeFeatures = new NodeFeatures(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
