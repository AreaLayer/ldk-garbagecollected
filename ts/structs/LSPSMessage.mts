 ...
 */
export class LSPSMessage extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.LSPSMessage_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): LSPSMessage {
		const raw_ty: number = bindings.LDKLSPSMessage_ty_from_ptr(ptr);
		switch (raw_ty) {
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPSMessage_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPSMessage {
		const ret: bigint = bindings.LSPSMessage_clone(this.ptr);
		const ret_hu_conv: LSPSMessage = LSPSMessage.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_invalid(a: LSPSResponseError): LSPSMessage {
		const ret: bigint = bindings.LSPSMessage_invalid(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPSMessage = LSPSMessage.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_lsps0(a: LSPS0Message): LSPSMessage {
		const ret: bigint = bindings.LSPSMessage_lsps0(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPSMessage = LSPSMessage.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_lsps1(a: LSPS1Message): LSPSMessage {
		const ret: bigint = bindings.LSPSMessage_lsps1(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPSMessage = LSPSMessage.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_lsps2(a: LSPS2Message): LSPSMessage {
		const ret: bigint = bindings.LSPSMessage_lsps2(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPSMessage = LSPSMessage.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPSMessage): boolean {
		const ret: boolean = bindings.LSPSMessage_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}

}
/** A LSPSMessage of type Invalid */
export class LSPSMessage_Invalid extends LSPSMessage {
	public invalid: LSPSResponseError;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const invalid: bigint = bindings.LDKLSPSMessage_Invalid_get_invalid(ptr);
		const invalid_hu_conv: LSPSResponseError = new LSPSResponseError(null, invalid);
			CommonBase.add_ref_from(invalid_hu_conv, this);
		this.invalid = invalid_hu_conv;
	}
}
/** A LSPSMessage of type LSPS0 */
export class LSPSMessage_LSPS0 extends LSPSMessage {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}
...
export class LSPSMessage_LSPS1 extends LSPSMessage {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}
...
export class LSPSMessage_LSPS2 extends LSPSMessage {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}
