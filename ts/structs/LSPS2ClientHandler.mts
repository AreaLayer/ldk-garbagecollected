 ...
 */
export class LSPS2ClientHandler extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS2ClientHandler_free);
	}
	 ...
	 */
	public request_opening_params(counterparty_node_id: Uint8Array, token: Option_StrZ): LSPSRequestId {
		const ret: bigint = bindings.LSPS2ClientHandler_request_opening_params(this.ptr, bindings.encodeUint8Array(counterparty_node_id), CommonBase.get_ptr_of(token));
	 ...
	 */
	public select_opening_params(counterparty_node_id: Uint8Array, payment_size_msat: Option_u64Z, opening_fee_params: LSPS2OpeningFeeParams): Result_LSPSRequestIdAPIErrorZ {
		const ret: bigint = bindings.LSPS2ClientHandler_select_opening_params(this.ptr, bindings.encodeUint8Array(counterparty_node_id), CommonBase.get_ptr_of(payment_size_msat), CommonBase.get_ptr_of(opening_fee_params));
