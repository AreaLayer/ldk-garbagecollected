...
export class ChannelSigner extends CommonBase {
	...
	public static new_impl(arg: ChannelSignerInterface, pubkeys: ChannelPublicKeys): ChannelSigner {
		...
		const ptr_idx: [bigint, number] = bindings.LDKChannelSigner_new(structImplementation, pubkeys.clone_ptr());
	...
	public validate_holder_commitment(holder_tx: HolderCommitmentTransaction, outbound_htlc_preimages: Uint8Array[]): Result_NoneNoneZ {
		const ret: bigint = bindings.ChannelSigner_validate_holder_commitment(this.ptr, CommonBase.get_ptr_of(holder_tx), bindings.encodeUint32Array(outbound_htlc_preimages.map(outbound_htlc_preimages_conv_12 => bindings.encodeUint8Array(bindings.check_arr_len(outbound_htlc_preimages_conv_12, 32)))));
