 ...
 */
export class LSPS2GetInfoResponse extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS2GetInfoResponse_free);
	}

	/**
	 * A set of opening fee parameters.
	 */
	public get_opening_fee_params_menu(): LSPS2OpeningFeeParams[] {
		const ret: number = bindings.LSPS2GetInfoResponse_get_opening_fee_params_menu(this.ptr);
		const ret_conv_23_len: number = bindings.getArrayLength(ret);
		const ret_conv_23_arr: LSPS2OpeningFeeParams[] = new Array(ret_conv_23_len).fill(null);
		for (var x = 0; x < ret_conv_23_len; x++) {
			const ret_conv_23: bigint = bindings.getU64ArrayElem(ret, x);
			const ret_conv_23_hu_conv: LSPS2OpeningFeeParams = new LSPS2OpeningFeeParams(null, ret_conv_23);
	 ...
	 * A set of opening fee parameters.
	 */
	public set_opening_fee_params_menu(val: LSPS2OpeningFeeParams[]): void {
		bindings.LSPS2GetInfoResponse_set_opening_fee_params_menu(this.ptr, bindings.encodeUint64Array(val.map(val_conv_23 => CommonBase.get_ptr_of(val_conv_23))));
	}

	/**
	 * Constructs a new LSPS2GetInfoResponse given each field
	 */
	public static constructor_new(opening_fee_params_menu_arg: LSPS2OpeningFeeParams[]): LSPS2GetInfoResponse {
		const ret: bigint = bindings.LSPS2GetInfoResponse_new(bindings.encodeUint64Array(opening_fee_params_menu_arg.map(opening_fee_params_menu_arg_conv_23 => CommonBase.get_ptr_of(opening_fee_params_menu_arg_conv_23))));
		const ret_hu_conv: LSPS2GetInfoResponse = new LSPS2GetInfoResponse(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS2GetInfoResponse_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS2GetInfoResponse {
		const ret: bigint = bindings.LSPS2GetInfoResponse_clone(this.ptr);
		const ret_hu_conv: LSPS2GetInfoResponse = new LSPS2GetInfoResponse(null, ret);
	 ...
	 */
	public eq(b: LSPS2GetInfoResponse): boolean {
		const ret: boolean = bindings.LSPS2GetInfoResponse_eq(this.ptr, CommonBase.get_ptr_of(b));
