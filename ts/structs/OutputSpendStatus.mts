...
export class OutputSpendStatus extends CommonBase {
	...
	public static constructor_pending_initial_broadcast(delayed_until_height: Option_u32Z): OutputSpendStatus {
		...
		CommonBase.add_ref_from(ret_hu_conv, delayed_until_height);
		return ret_hu_conv;
	}
	...
	public static constructor_pending_first_confirmation(first_broadcast_hash: Uint8Array, latest_broadcast_height: number, latest_spending_tx: Uint8Array): OutputSpendStatus {
		const ret: bigint = bindings.OutputSpendStatus_pending_first_confirmation(bindings.encodeUint8Array(bindings.check_arr_len(first_broadcast_hash, 32)), latest_broadcast_height, bindings.encodeUint8Array(latest_spending_tx));
		const ret_hu_conv: OutputSpendStatus = OutputSpendStatus.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	...
	public static constructor_pending_threshold_confirmations(first_broadcast_hash: Uint8Array, latest_broadcast_height: number, latest_spending_tx: Uint8Array, confirmation_height: number, confirmation_hash: Uint8Array): OutputSpendStatus {
		const ret: bigint = bindings.OutputSpendStatus_pending_threshold_confirmations(bindings.encodeUint8Array(bindings.check_arr_len(first_broadcast_hash, 32)), latest_broadcast_height, bindings.encodeUint8Array(latest_spending_tx), confirmation_height, bindings.encodeUint8Array(bindings.check_arr_len(confirmation_hash, 32)));
		const ret_hu_conv: OutputSpendStatus = OutputSpendStatus.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
