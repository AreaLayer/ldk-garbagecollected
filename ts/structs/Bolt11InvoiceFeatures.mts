...
export class Bolt11InvoiceFeatures extends CommonBase {
	...
	public eq(b: Bolt11InvoiceFeatures): boolean {
		const ret: boolean = bindings.Bolt11InvoiceFeatures_eq(this.ptr, CommonBase.get_ptr_of(b));
	 ...
	 */
	public required_unknown_bits_from(other: Bolt11InvoiceFeatures): bigint[] {
