...
export class MonitorName extends CommonBase {
	...
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.MonitorName_free);
	}
	 ...
	 */
	public static constructor_new(name: string): Result_MonitorNameIOErrorZ {
		const ret: bigint = bindings.MonitorName_new(bindings.encodeString(name));
	...
	public as_str(): string {
		const ret: number = bindings.MonitorName_as_str(this.ptr);
