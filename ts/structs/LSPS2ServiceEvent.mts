...
export class LSPS2ServiceEvent extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.LSPS2ServiceEvent_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): LSPS2ServiceEvent {
		const raw_ty: number = bindings.LDKLSPS2ServiceEvent_ty_from_ptr(ptr);
		switch (raw_ty) {
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS2ServiceEvent_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS2ServiceEvent {
		const ret: bigint = bindings.LSPS2ServiceEvent_clone(this.ptr);
		const ret_hu_conv: LSPS2ServiceEvent = LSPS2ServiceEvent.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_get_info(request_id: LSPSRequestId, counterparty_node_id: Uint8Array, token: Option_StrZ): LSPS2ServiceEvent {
		const ret: bigint = bindings.LSPS2ServiceEvent_get_info(CommonBase.get_ptr_of(request_id), bindings.encodeUint8Array(counterparty_node_id), CommonBase.get_ptr_of(token));
		const ret_hu_conv: LSPS2ServiceEvent = LSPS2ServiceEvent.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_buy_request(request_id: LSPSRequestId, counterparty_node_id: Uint8Array, opening_fee_params: LSPS2OpeningFeeParams, payment_size_msat: Option_u64Z): LSPS2ServiceEvent {
		const ret: bigint = bindings.LSPS2ServiceEvent_buy_request(CommonBase.get_ptr_of(request_id), bindings.encodeUint8Array(counterparty_node_id), CommonBase.get_ptr_of(opening_fee_params), CommonBase.get_ptr_of(payment_size_msat));
		const ret_hu_conv: LSPS2ServiceEvent = LSPS2ServiceEvent.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_open_channel(their_network_key: Uint8Array, amt_to_forward_msat: bigint, opening_fee_msat: bigint, user_channel_id: bigint, intercept_scid: bigint): LSPS2ServiceEvent {
		const ret: bigint = bindings.LSPS2ServiceEvent_open_channel(bindings.encodeUint8Array(their_network_key), amt_to_forward_msat, opening_fee_msat, bindings.encodeUint128(user_channel_id), intercept_scid);
		const ret_hu_conv: LSPS2ServiceEvent = LSPS2ServiceEvent.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS2ServiceEvent): boolean {
		const ret: boolean = bindings.LSPS2ServiceEvent_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}
...
export class LSPS2ServiceEvent_GetInfo extends LSPS2ServiceEvent {
	 ...
	 */
	public token: Option_StrZ;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const request_id: bigint = bindings.LDKLSPS2ServiceEvent_GetInfo_get_request_id(ptr);
		...
		const counterparty_node_id: number = bindings.LDKLSPS2ServiceEvent_GetInfo_get_counterparty_node_id(ptr);
		...
		const token: bigint = bindings.LDKLSPS2ServiceEvent_GetInfo_get_token(ptr);
		const token_hu_conv: Option_StrZ = Option_StrZ.constr_from_ptr(token);
...
export class LSPS2ServiceEvent_BuyRequest extends LSPS2ServiceEvent {
	 ...
	 */
	public opening_fee_params: LSPS2OpeningFeeParams;
	/**
	...
	public constructor(ptr: bigint) {
		super(null, ptr);
		const request_id: bigint = bindings.LDKLSPS2ServiceEvent_BuyRequest_get_request_id(ptr);
		const request_id_hu_conv: LSPSRequestId = new LSPSRequestId(null, request_id);
			CommonBase.add_ref_from(request_id_hu_conv, this);
		this.request_id = request_id_hu_conv;
		const counterparty_node_id: number = bindings.LDKLSPS2ServiceEvent_BuyRequest_get_counterparty_node_id(ptr);
		const counterparty_node_id_conv: Uint8Array = bindings.decodeUint8Array(counterparty_node_id);
		this.counterparty_node_id = counterparty_node_id_conv;
		const opening_fee_params: bigint = bindings.LDKLSPS2ServiceEvent_BuyRequest_get_opening_fee_params(ptr);
		const opening_fee_params_hu_conv: LSPS2OpeningFeeParams = new LSPS2OpeningFeeParams(null, opening_fee_params);
			CommonBase.add_ref_from(opening_fee_params_hu_conv, this);
		this.opening_fee_params = opening_fee_params_hu_conv;
		const payment_size_msat: bigint = bindings.LDKLSPS2ServiceEvent_BuyRequest_get_payment_size_msat(ptr);
...
export class LSPS2ServiceEvent_OpenChannel extends LSPS2ServiceEvent {
	 ...
	 */
	public their_network_key: Uint8Array;
	/**
	 * The amount to forward after fees.
	 */
	public amt_to_forward_msat: bigint;
	/**
	 * The fee earned for opening the channel.
	 */
	public opening_fee_msat: bigint;
	/**
	...
	public constructor(ptr: bigint) {
		super(null, ptr);
		const their_network_key: number = bindings.LDKLSPS2ServiceEvent_OpenChannel_get_their_network_key(ptr);
		const their_network_key_conv: Uint8Array = bindings.decodeUint8Array(their_network_key);
		...
		const user_channel_id: number = bindings.LDKLSPS2ServiceEvent_OpenChannel_get_user_channel_id(ptr);
