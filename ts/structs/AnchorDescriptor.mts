...
export class AnchorDescriptor extends CommonBase {
	...
	public static constructor_new(channel_derivation_parameters_arg: ChannelDerivationParameters, outpoint_arg: OutPoint): AnchorDescriptor {
		const ret: bigint = bindings.AnchorDescriptor_new(CommonBase.get_ptr_of(channel_derivation_parameters_arg), CommonBase.get_ptr_of(outpoint_arg));
	 ...
	 */
	public derive_channel_signer(signer_provider: SignerProvider): EcdsaChannelSigner {
