...
export class LSPS1GetInfoResponse extends CommonBase {
	 ...
	 */
	public get_options(): LSPS1Options {
		const ret: bigint = bindings.LSPS1GetInfoResponse_get_options(this.ptr);
	 ...
	 * All options supported by the LSP.
	 */
	public set_options(val: LSPS1Options): void {
	 ...
	 */
	public static constructor_new(options_arg: LSPS1Options): LSPS1GetInfoResponse {
		const ret: bigint = bindings.LSPS1GetInfoResponse_new(CommonBase.get_ptr_of(options_arg));
		const ret_hu_conv: LSPS1GetInfoResponse = new LSPS1GetInfoResponse(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS1GetInfoResponse_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS1GetInfoResponse {
		const ret: bigint = bindings.LSPS1GetInfoResponse_clone(this.ptr);
		const ret_hu_conv: LSPS1GetInfoResponse = new LSPS1GetInfoResponse(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS1GetInfoResponse): boolean {
		const ret: boolean = bindings.LSPS1GetInfoResponse_eq(this.ptr, CommonBase.get_ptr_of(b));
