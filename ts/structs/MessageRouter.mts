...
export class MessageRouter extends CommonBase {
	...
	public create_blinded_paths(recipient: Uint8Array, context: MessageContext, peers: Uint8Array[]): Result_CVec_BlindedMessagePathZNoneZ {
		const ret: bigint = bindings.MessageRouter_create_blinded_paths(this.ptr, bindings.encodeUint8Array(recipient), CommonBase.get_ptr_of(context), bindings.encodeUint32Array(peers.map(peers_conv_12 => bindings.encodeUint8Array(peers_conv_12))));
	...
	public create_compact_blinded_paths(recipient: Uint8Array, context: MessageContext, peers: MessageForwardNode[]): Result_CVec_BlindedMessagePathZNoneZ {
		const ret: bigint = bindings.MessageRouter_create_compact_blinded_paths(this.ptr, bindings.encodeUint8Array(recipient), CommonBase.get_ptr_of(context), bindings.encodeUint64Array(peers.map(peers_conv_20 => CommonBase.get_ptr_of(peers_conv_20))));
		const ret_hu_conv: Result_CVec_BlindedMessagePathZNoneZ = Result_CVec_BlindedMessagePathZNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
