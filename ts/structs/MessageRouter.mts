...
export class MessageRouter extends CommonBase {
	...
	public static new_impl(arg: MessageRouterInterface): MessageRouter {
		...
		let structImplementation = {
			...
			create_blinded_paths (recipient: number, context: bigint, peers: number): bigint {
				...
				bindings.freeWasmMemory(peers)
				const ret: Result_CVec_BlindedMessagePathZNoneZ = arg.create_blinded_paths(recipient_conv, context_hu_conv, peers_conv_12_arr);
				const result: bigint = ret.clone_ptr();
				return result;
			},
			create_compact_blinded_paths (recipient: number, context: bigint, peers: number): bigint {
				...
				bindings.freeWasmMemory(peers)
				const ret: Result_CVec_BlindedMessagePathZNoneZ = arg.create_compact_blinded_paths(recipient_conv, context_hu_conv, peers_conv_20_arr);
				const result: bigint = ret.clone_ptr();
				return result;
			},
	 ...
	 * be direct peers with the `recipient`.
	 */
	public create_blinded_paths(recipient: Uint8Array, context: MessageContext, peers: Uint8Array[]): Result_CVec_BlindedMessagePathZNoneZ {
		const ret: bigint = bindings.MessageRouter_create_blinded_paths(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(recipient, 33)), CommonBase.get_ptr_of(context), bindings.encodeUint32Array(peers.map(peers_conv_12 => bindings.encodeUint8Array(bindings.check_arr_len(peers_conv_12, 33)))));
	 ...
	 * ignoring the short channel ids.
	 */
	public create_compact_blinded_paths(recipient: Uint8Array, context: MessageContext, peers: MessageForwardNode[]): Result_CVec_BlindedMessagePathZNoneZ {
		const ret: bigint = bindings.MessageRouter_create_compact_blinded_paths(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(recipient, 33)), CommonBase.get_ptr_of(context), bindings.encodeUint64Array(peers.map(peers_conv_20 => CommonBase.get_ptr_of(peers_conv_20))));
		const ret_hu_conv: Result_CVec_BlindedMessagePathZNoneZ = Result_CVec_BlindedMessagePathZNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
