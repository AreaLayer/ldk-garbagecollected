...
export class FourTuple_OutPointChannelIdCVec_MonitorEventZPublicKeyZ extends CommonBase {
	...
	public static constructor_new(a: OutPoint, b: ChannelId, c: MonitorEvent[], d: Uint8Array): FourTuple_OutPointChannelIdCVec_MonitorEventZPublicKeyZ {
		const ret: bigint = bindings.C4Tuple_OutPointChannelIdCVec_MonitorEventZPublicKeyZ_new(CommonBase.get_ptr_of(a), CommonBase.get_ptr_of(b), bindings.encodeUint64Array(c.map(c_conv_14 => CommonBase.get_ptr_of(c_conv_14))), bindings.encodeUint8Array(bindings.check_arr_len(d, 33)));
		const ret_hu_conv: FourTuple_OutPointChannelIdCVec_MonitorEventZPublicKeyZ = new FourTuple_OutPointChannelIdCVec_MonitorEventZPublicKeyZ(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, a);
		CommonBase.add_ref_from(ret_hu_conv, b);
		c.forEach((c_conv_14: MonitorEvent) => { CommonBase.add_ref_from(ret_hu_conv, c_conv_14); });
		return ret_hu_conv;
	}
