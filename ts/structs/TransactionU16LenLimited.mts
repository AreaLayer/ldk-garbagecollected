...
export class TransactionU16LenLimited extends CommonBase {
	...
	public eq(b: TransactionU16LenLimited): boolean {
		const ret: boolean = bindings.TransactionU16LenLimited_eq(this.ptr, CommonBase.get_ptr_of(b));
	 ...
	 */
	public as_transaction(): Uint8Array {
		const ret: number = bindings.TransactionU16LenLimited_as_transaction(this.ptr);
		const ret_conv: Uint8Array = bindings.decodeUint8Array(ret);
		return ret_conv;
	}
