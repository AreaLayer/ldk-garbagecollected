...
export class HeldHtlcAvailable extends CommonBase {
	 ...
	 */
	public get_payment_release_secret(): Uint8Array {
		const ret: number = bindings.HeldHtlcAvailable_get_payment_release_secret(this.ptr);
	 ...
	 * The secret that will be used by the recipient of this message to release the held HTLC.
	 */
	public set_payment_release_secret(val: Uint8Array): void {
	 ...
	 */
	public static constructor_new(payment_release_secret_arg: Uint8Array): HeldHtlcAvailable {
		const ret: bigint = bindings.HeldHtlcAvailable_new(bindings.encodeUint8Array(bindings.check_arr_len(payment_release_secret_arg, 32)));
