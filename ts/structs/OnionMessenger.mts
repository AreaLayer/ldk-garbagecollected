...
export class OnionMessenger extends CommonBase {
	 ...
	 */
	public static constructor_new(entropy_source: EntropySource, node_signer: NodeSigner, logger: Logger, node_id_lookup: NodeIdLookUp, message_router: MessageRouter, offers_handler: OffersMessageHandler, async_payments_handler: AsyncPaymentsMessageHandler, custom_handler: CustomOnionMessageHandler): OnionMessenger {
	...
	public forward_onion_message(message: OnionMessage, peer_node_id: Uint8Array): Result_NoneSendErrorZ {
		const ret: bigint = bindings.OnionMessenger_forward_onion_message(this.ptr, CommonBase.get_ptr_of(message), bindings.encodeUint8Array(bindings.check_arr_len(peer_node_id, 33)));
