...
export class Watch extends CommonBase {
	...
	public watch_channel(funding_txo: OutPoint, monitor: ChannelMonitor): Result_ChannelMonitorUpdateStatusNoneZ {
		const ret: bigint = bindings.Watch_watch_channel(this.ptr, CommonBase.get_ptr_of(funding_txo), CommonBase.get_ptr_of(monitor));
	...
	public update_channel(funding_txo: OutPoint, update: ChannelMonitorUpdate): ChannelMonitorUpdateStatus {
		const ret: ChannelMonitorUpdateStatus = bindings.Watch_update_channel(this.ptr, CommonBase.get_ptr_of(funding_txo), CommonBase.get_ptr_of(update));
