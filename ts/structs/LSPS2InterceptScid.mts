 ...
 */
export class LSPS2InterceptScid extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS2InterceptScid_free);
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS2InterceptScid_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS2InterceptScid {
		const ret: bigint = bindings.LSPS2InterceptScid_clone(this.ptr);
	 ...
	 */
	public eq(b: LSPS2InterceptScid): boolean {
		const ret: boolean = bindings.LSPS2InterceptScid_eq(this.ptr, CommonBase.get_ptr_of(b));
	 ...
	 */
	public to_scid(): Result_u64NoneZ {
		const ret: bigint = bindings.LSPS2InterceptScid_to_scid(this.ptr);
