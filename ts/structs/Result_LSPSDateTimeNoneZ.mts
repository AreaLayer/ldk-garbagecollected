...
export class Result_LSPSDateTimeNoneZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_LSPSDateTimeNoneZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_LSPSDateTimeNoneZ {
	 ...
	 */
	public static constructor_ok(o: LSPSDateTime): Result_LSPSDateTimeNoneZ {
		const ret: bigint = bindings.CResult_LSPSDateTimeNoneZ_ok(CommonBase.get_ptr_of(o));
		const ret_hu_conv: Result_LSPSDateTimeNoneZ = Result_LSPSDateTimeNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_err(): Result_LSPSDateTimeNoneZ {
		const ret: bigint = bindings.CResult_LSPSDateTimeNoneZ_err();
		const ret_hu_conv: Result_LSPSDateTimeNoneZ = Result_LSPSDateTimeNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_LSPSDateTimeNoneZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_LSPSDateTimeNoneZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_LSPSDateTimeNoneZ {
		const ret: bigint = bindings.CResult_LSPSDateTimeNoneZ_clone(this.ptr);
		const ret_hu_conv: Result_LSPSDateTimeNoneZ = Result_LSPSDateTimeNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_LSPSDateTimeNoneZ_OK extends Result_LSPSDateTimeNoneZ {
	public res: LSPSDateTime;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_LSPSDateTimeNoneZ_get_ok(ptr);
		const res_hu_conv: LSPSDateTime = new LSPSDateTime(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_LSPSDateTimeNoneZ_Err extends Result_LSPSDateTimeNoneZ {
