...
export class ReceiveTlvs extends CommonBase {
	...
	public get_payment_context(): PaymentContext {
		const ret: bigint = bindings.ReceiveTlvs_get_payment_context(this.ptr);
	 ...
	 */
	public static constructor_new(payment_secret_arg: Uint8Array, payment_constraints_arg: PaymentConstraints, payment_context_arg: PaymentContext): ReceiveTlvs {
		const ret: bigint = bindings.ReceiveTlvs_new(bindings.encodeUint8Array(bindings.check_arr_len(payment_secret_arg, 32)), CommonBase.get_ptr_of(payment_constraints_arg), CommonBase.get_ptr_of(payment_context_arg));
		...
		CommonBase.add_ref_from(ret_hu_conv, payment_context_arg);
		return ret_hu_conv;
	}
