 ...
 */
export class LSPS2GetInfoRequest extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS2GetInfoRequest_free);
	}
	...
	public get_token(): Option_StrZ {
		const ret: bigint = bindings.LSPS2GetInfoRequest_get_token(this.ptr);
	...
	public set_token(val: Option_StrZ): void {
		bindings.LSPS2GetInfoRequest_set_token(this.ptr, CommonBase.get_ptr_of(val));
	}

	/**
	 * Constructs a new LSPS2GetInfoRequest given each field
	 */
	public static constructor_new(token_arg: Option_StrZ): LSPS2GetInfoRequest {
		const ret: bigint = bindings.LSPS2GetInfoRequest_new(CommonBase.get_ptr_of(token_arg));
		const ret_hu_conv: LSPS2GetInfoRequest = new LSPS2GetInfoRequest(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS2GetInfoRequest_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS2GetInfoRequest {
		const ret: bigint = bindings.LSPS2GetInfoRequest_clone(this.ptr);
		const ret_hu_conv: LSPS2GetInfoRequest = new LSPS2GetInfoRequest(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS2GetInfoRequest): boolean {
		const ret: boolean = bindings.LSPS2GetInfoRequest_eq(this.ptr, CommonBase.get_ptr_of(b));
