...
export class InvoiceRequest extends CommonBase {
	...
	public respond_with_no_std(payment_paths: TwoTuple_BlindedPayInfoBlindedPathZ[], payment_hash: Uint8Array, created_at: bigint): Result_InvoiceWithExplicitSigningPubkeyBuilderBolt12SemanticErrorZ {
		const ret: bigint = bindings.InvoiceRequest_respond_with_no_std(this.ptr, bindings.encodeUint64Array(payment_paths.map(payment_paths_conv_37 => CommonBase.get_ptr_of(payment_paths_conv_37))), bindings.encodeUint8Array(bindings.check_arr_len(payment_hash, 32)), created_at);
	...
	public verify(key: ExpandedKey): Result_VerifiedInvoiceRequestNoneZ {
		const ret: bigint = bindings.InvoiceRequest_verify(this.ptr, CommonBase.get_ptr_of(key));
