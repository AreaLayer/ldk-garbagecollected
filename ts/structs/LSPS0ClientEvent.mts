 ...
 */
export class LSPS0ClientEvent extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.LSPS0ClientEvent_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): LSPS0ClientEvent {
		const raw_ty: number = bindings.LDKLSPS0ClientEvent_ty_from_ptr(ptr);
		switch (raw_ty) {
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS0ClientEvent_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS0ClientEvent {
		const ret: bigint = bindings.LSPS0ClientEvent_clone(this.ptr);
		const ret_hu_conv: LSPS0ClientEvent = LSPS0ClientEvent.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_list_protocols_response(counterparty_node_id: Uint8Array, protocols: Uint16Array): LSPS0ClientEvent {
		const ret: bigint = bindings.LSPS0ClientEvent_list_protocols_response(bindings.encodeUint8Array(counterparty_node_id), bindings.encodeUint16Array(protocols));
		const ret_hu_conv: LSPS0ClientEvent = LSPS0ClientEvent.constr_from_ptr(ret);
	 ...
	 */
	public eq(b: LSPS0ClientEvent): boolean {
		const ret: boolean = bindings.LSPS0ClientEvent_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}

}
/** A LSPS0ClientEvent of type ListProtocolsResponse */
export class LSPS0ClientEvent_ListProtocolsResponse extends LSPS0ClientEvent {
	/**
	 ...
	 */
	public protocols: Uint16Array;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const counterparty_node_id: number = bindings.LDKLSPS0ClientEvent_ListProtocolsResponse_get_counterparty_node_id(ptr);
		...
		const protocols: number = bindings.LDKLSPS0ClientEvent_ListProtocolsResponse_get_protocols(ptr);
		const protocols_conv: Uint16Array = bindings.decodeUint16Array(protocols);
