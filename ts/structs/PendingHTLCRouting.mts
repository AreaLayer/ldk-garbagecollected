...
export class PendingHTLCRouting extends CommonBase {
	 ...
	 */
	public static constructor_receive_keysend(payment_data: FinalOnionHopData, payment_preimage: Uint8Array, payment_metadata: Option_CVec_u8ZZ, incoming_cltv_expiry: number, custom_tlvs: TwoTuple_u64CVec_u8ZZ[], requires_blinded_error: boolean, has_recipient_created_payment_secret: boolean): PendingHTLCRouting {
