 ...
 */
export class LSPS1GetOrderRequest extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS1GetOrderRequest_free);
	}
	...
	public get_order_id(): LSPS1OrderId {
		const ret: bigint = bindings.LSPS1GetOrderRequest_get_order_id(this.ptr);
	...
	public set_order_id(val: LSPS1OrderId): void {
		bindings.LSPS1GetOrderRequest_set_order_id(this.ptr, CommonBase.get_ptr_of(val));
	}

	/**
	 * Constructs a new LSPS1GetOrderRequest given each field
	 */
	public static constructor_new(order_id_arg: LSPS1OrderId): LSPS1GetOrderRequest {
		const ret: bigint = bindings.LSPS1GetOrderRequest_new(CommonBase.get_ptr_of(order_id_arg));
		const ret_hu_conv: LSPS1GetOrderRequest = new LSPS1GetOrderRequest(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS1GetOrderRequest_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS1GetOrderRequest {
		const ret: bigint = bindings.LSPS1GetOrderRequest_clone(this.ptr);
		const ret_hu_conv: LSPS1GetOrderRequest = new LSPS1GetOrderRequest(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS1GetOrderRequest): boolean {
		const ret: boolean = bindings.LSPS1GetOrderRequest_eq(this.ptr, CommonBase.get_ptr_of(b));
