...
export class Result_OutputSweeperDecodeErrorZ extends CommonBase {
	...
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_OutputSweeperDecodeErrorZ {
	 ...
	 */
	public static constructor_ok(o_best_block: BestBlock, o_broadcaster: BroadcasterInterface, o_fee_estimator: FeeEstimator, o_chain_data_source: Option_FilterZ, o_output_spender: OutputSpender, o_change_destination_source: ChangeDestinationSource, o_kv_store: KVStore, o_logger: Logger): Result_OutputSweeperDecodeErrorZ {
		const ret: bigint = bindings.CResult_OutputSweeperDecodeErrorZ_ok(bindings.OutputSweeper_new(CommonBase.get_ptr_of(o_best_block), CommonBase.get_ptr_of(o_broadcaster), CommonBase.get_ptr_of(o_fee_estimator), CommonBase.get_ptr_of(o_chain_data_source), CommonBase.get_ptr_of(o_output_spender), CommonBase.get_ptr_of(o_change_destination_source), CommonBase.get_ptr_of(o_kv_store), CommonBase.get_ptr_of(o_logger)));
		const ret_hu_conv: Result_OutputSweeperDecodeErrorZ = Result_OutputSweeperDecodeErrorZ.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, o_best_block);
	 ...
	 */
	public static constructor_err(e: DecodeError): Result_OutputSweeperDecodeErrorZ {
		const ret: bigint = bindings.CResult_OutputSweeperDecodeErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_OutputSweeperDecodeErrorZ = Result_OutputSweeperDecodeErrorZ.constr_from_ptr(ret);
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_OutputSweeperDecodeErrorZ_is_ok(this.ptr);
		return ret;
	}

}
export class Result_OutputSweeperDecodeErrorZ_OK extends Result_OutputSweeperDecodeErrorZ {
	public res: OutputSweeper;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_OutputSweeperDecodeErrorZ_get_ok(ptr);
		const res_hu_conv: OutputSweeper = new OutputSweeper(null, res);
...
export class Result_OutputSweeperDecodeErrorZ_Err extends Result_OutputSweeperDecodeErrorZ {
	...
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_OutputSweeperDecodeErrorZ_get_err(ptr);
