...
export class LSPS2RawOpeningFeeParams extends CommonBase {
	...
	public get_min_fee_msat(): bigint {
		const ret: bigint = bindings.LSPS2RawOpeningFeeParams_get_min_fee_msat(this.ptr);
		return ret;
	}
	...
	public get_proportional(): number {
		const ret: number = bindings.LSPS2RawOpeningFeeParams_get_proportional(this.ptr);
		return ret;
	}
	...
	public get_valid_until(): LSPSDateTime {
		const ret: bigint = bindings.LSPS2RawOpeningFeeParams_get_valid_until(this.ptr);
	...
	public get_min_lifetime(): number {
		const ret: number = bindings.LSPS2RawOpeningFeeParams_get_min_lifetime(this.ptr);
		return ret;
	}
	...
	public get_max_client_to_self_delay(): number {
		const ret: number = bindings.LSPS2RawOpeningFeeParams_get_max_client_to_self_delay(this.ptr);
		return ret;
	}
	...
	public get_min_payment_size_msat(): bigint {
		const ret: bigint = bindings.LSPS2RawOpeningFeeParams_get_min_payment_size_msat(this.ptr);
		return ret;
	}
	...
	public get_max_payment_size_msat(): bigint {
		const ret: bigint = bindings.LSPS2RawOpeningFeeParams_get_max_payment_size_msat(this.ptr);
		return ret;
	}
	 ...
	 */
	public static constructor_new(min_fee_msat_arg: bigint, proportional_arg: number, valid_until_arg: LSPSDateTime, min_lifetime_arg: number, max_client_to_self_delay_arg: number, min_payment_size_msat_arg: bigint, max_payment_size_msat_arg: bigint): LSPS2RawOpeningFeeParams {
		const ret: bigint = bindings.LSPS2RawOpeningFeeParams_new(min_fee_msat_arg, proportional_arg, CommonBase.get_ptr_of(valid_until_arg), min_lifetime_arg, max_client_to_self_delay_arg, min_payment_size_msat_arg, max_payment_size_msat_arg);
		const ret_hu_conv: LSPS2RawOpeningFeeParams = new LSPS2RawOpeningFeeParams(null, ret);
