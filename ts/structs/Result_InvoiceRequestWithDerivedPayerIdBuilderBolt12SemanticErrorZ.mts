...
export class Result_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ extends CommonBase {
	...
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ {
	 ...
	 */
	public static constructor_ok(o: InvoiceRequestWithDerivedPayerIdBuilder): Result_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ {
		const ret: bigint = bindings.CResult_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ_ok(CommonBase.get_ptr_of(o));
	 ...
	 */
	public static constructor_err(e: Bolt12SemanticError): Result_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ {
		const ret: bigint = bindings.CResult_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ_err(e);
		const ret_hu_conv: Result_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ = Result_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ_is_ok(this.ptr);
		return ret;
	}
...
export class Result_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ_OK extends Result_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ {
	public res: InvoiceRequestWithDerivedPayerIdBuilder;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_InvoiceRequestWithDerivedPayerIdBuilderBolt12SemanticErrorZ_get_ok(ptr);
		const res_hu_conv: InvoiceRequestWithDerivedPayerIdBuilder = new InvoiceRequestWithDerivedPayerIdBuilder(null, res);
