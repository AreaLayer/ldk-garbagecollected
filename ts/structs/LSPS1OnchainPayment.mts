 ...
 */
export class LSPS1OnchainPayment extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPS1OnchainPayment_free);
	}

	/**
	 * The outpoint of the payment.
	 */
	public get_outpoint(): string {
		const ret: number = bindings.LSPS1OnchainPayment_get_outpoint(this.ptr);
	 ...
	 * The outpoint of the payment.
	 */
	public set_outpoint(val: string): void {
		bindings.LSPS1OnchainPayment_set_outpoint(this.ptr, bindings.encodeString(val));
	}

	/**
	 * The amount of satoshi paid.
	 */
	public get_sat(): bigint {
		const ret: bigint = bindings.LSPS1OnchainPayment_get_sat(this.ptr);
		return ret;
	}
	 ...
	 * The amount of satoshi paid.
	 */
	public set_sat(val: bigint): void {
	 ...
	 */
	public get_confirmed(): boolean {
		const ret: boolean = bindings.LSPS1OnchainPayment_get_confirmed(this.ptr);
		return ret;
	}
	 ...
	 * Indicates if the LSP regards the transaction as sufficiently confirmed.
	 */
	public set_confirmed(val: boolean): void {
	 ...
	 */
	public static constructor_new(outpoint_arg: string, sat_arg: bigint, confirmed_arg: boolean): LSPS1OnchainPayment {
		const ret: bigint = bindings.LSPS1OnchainPayment_new(bindings.encodeString(outpoint_arg), sat_arg, confirmed_arg);
		const ret_hu_conv: LSPS1OnchainPayment = new LSPS1OnchainPayment(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS1OnchainPayment_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS1OnchainPayment {
		const ret: bigint = bindings.LSPS1OnchainPayment_clone(this.ptr);
		const ret_hu_conv: LSPS1OnchainPayment = new LSPS1OnchainPayment(null, ret);
	 ...
	 */
	public eq(b: LSPS1OnchainPayment): boolean {
		const ret: boolean = bindings.LSPS1OnchainPayment_eq(this.ptr, CommonBase.get_ptr_of(b));
