 ...
 */
export class LiquidityEvent extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.LiquidityEvent_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): LiquidityEvent {
		const raw_ty: number = bindings.LDKLiquidityEvent_ty_from_ptr(ptr);
		switch (raw_ty) {
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LiquidityEvent_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LiquidityEvent {
		const ret: bigint = bindings.LiquidityEvent_clone(this.ptr);
		const ret_hu_conv: LiquidityEvent = LiquidityEvent.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_lsps0_client(a: LSPS0ClientEvent): LiquidityEvent {
		const ret: bigint = bindings.LiquidityEvent_lsps0_client(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LiquidityEvent = LiquidityEvent.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_lsps1_client(a: LSPS1ClientEvent): LiquidityEvent {
		const ret: bigint = bindings.LiquidityEvent_lsps1_client(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LiquidityEvent = LiquidityEvent.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_lsps2_client(a: LSPS2ClientEvent): LiquidityEvent {
		const ret: bigint = bindings.LiquidityEvent_lsps2_client(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LiquidityEvent = LiquidityEvent.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_lsps2_service(a: LSPS2ServiceEvent): LiquidityEvent {
		const ret: bigint = bindings.LiquidityEvent_lsps2_service(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LiquidityEvent = LiquidityEvent.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LiquidityEvent): boolean {
		const ret: boolean = bindings.LiquidityEvent_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}

}
/** A LiquidityEvent of type LSPS0Client */
export class LiquidityEvent_LSPS0Client extends LiquidityEvent {
	/* @internal */
...
export class LiquidityEvent_LSPS1Client extends LiquidityEvent {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}
...
export class LiquidityEvent_LSPS2Client extends LiquidityEvent {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}
...
export class LiquidityEvent_LSPS2Service extends LiquidityEvent {
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
	}
