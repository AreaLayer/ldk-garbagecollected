 ...
 */
export class RawLSPSMessage extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.RawLSPSMessage_free);
	}

	/**
	 * The raw string payload that holds the actual message.
	 */
	public get_payload(): string {
		const ret: number = bindings.RawLSPSMessage_get_payload(this.ptr);
	 ...
	 * The raw string payload that holds the actual message.
	 */
	public set_payload(val: string): void {
		bindings.RawLSPSMessage_set_payload(this.ptr, bindings.encodeString(val));
	}

	/**
	 * Constructs a new RawLSPSMessage given each field
	 */
	public static constructor_new(payload_arg: string): RawLSPSMessage {
		const ret: bigint = bindings.RawLSPSMessage_new(bindings.encodeString(payload_arg));
		const ret_hu_conv: RawLSPSMessage = new RawLSPSMessage(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.RawLSPSMessage_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): RawLSPSMessage {
		const ret: bigint = bindings.RawLSPSMessage_clone(this.ptr);
		const ret_hu_conv: RawLSPSMessage = new RawLSPSMessage(null, ret);
	 ...
	 */
	public eq(b: RawLSPSMessage): boolean {
		const ret: boolean = bindings.RawLSPSMessage_eq(this.ptr, CommonBase.get_ptr_of(b));
	...
	public write(): Uint8Array {
		const ret: number = bindings.RawLSPSMessage_write(this.ptr);
	 ...
	 */
	public static constructor_read(ser: Uint8Array): Result_RawLSPSMessageDecodeErrorZ {
		const ret: bigint = bindings.RawLSPSMessage_read(bindings.encodeUint8Array(ser));
	 ...
	 */
	public as_Type(): Type {
		const ret: bigint = bindings.RawLSPSMessage_as_Type(this.ptr);
