 ...
 */
export class LSPS2Response extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.LSPS2Response_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): LSPS2Response {
		const raw_ty: number = bindings.LDKLSPS2Response_ty_from_ptr(ptr);
		switch (raw_ty) {
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS2Response_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS2Response {
		const ret: bigint = bindings.LSPS2Response_clone(this.ptr);
		const ret_hu_conv: LSPS2Response = LSPS2Response.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_get_info(a: LSPS2GetInfoResponse): LSPS2Response {
		const ret: bigint = bindings.LSPS2Response_get_info(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS2Response = LSPS2Response.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_get_info_error(a: LSPSResponseError): LSPS2Response {
		const ret: bigint = bindings.LSPS2Response_get_info_error(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS2Response = LSPS2Response.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_buy(a: LSPS2BuyResponse): LSPS2Response {
		const ret: bigint = bindings.LSPS2Response_buy(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS2Response = LSPS2Response.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_buy_error(a: LSPSResponseError): LSPS2Response {
		const ret: bigint = bindings.LSPS2Response_buy_error(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS2Response = LSPS2Response.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS2Response): boolean {
		const ret: boolean = bindings.LSPS2Response_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}

}
/** A LSPS2Response of type GetInfo */
export class LSPS2Response_GetInfo extends LSPS2Response {
	public get_info: LSPS2GetInfoResponse;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const get_info: bigint = bindings.LDKLSPS2Response_GetInfo_get_get_info(ptr);
		const get_info_hu_conv: LSPS2GetInfoResponse = new LSPS2GetInfoResponse(null, get_info);
			CommonBase.add_ref_from(get_info_hu_conv, this);
		this.get_info = get_info_hu_conv;
	}
}
/** A LSPS2Response of type GetInfoError */
export class LSPS2Response_GetInfoError extends LSPS2Response {
	public get_info_error: LSPSResponseError;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const get_info_error: bigint = bindings.LDKLSPS2Response_GetInfoError_get_get_info_error(ptr);
...
export class LSPS2Response_Buy extends LSPS2Response {
	public buy: LSPS2BuyResponse;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const buy: bigint = bindings.LDKLSPS2Response_Buy_get_buy(ptr);
		const buy_hu_conv: LSPS2BuyResponse = new LSPS2BuyResponse(null, buy);
			CommonBase.add_ref_from(buy_hu_conv, this);
		this.buy = buy_hu_conv;
	}
}
/** A LSPS2Response of type BuyError */
export class LSPS2Response_BuyError extends LSPS2Response {
	public buy_error: LSPSResponseError;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const buy_error: bigint = bindings.LDKLSPS2Response_BuyError_get_buy_error(ptr);
		const buy_error_hu_conv: LSPSResponseError = new LSPSResponseError(null, buy_error);
			CommonBase.add_ref_from(buy_error_hu_conv, this);
