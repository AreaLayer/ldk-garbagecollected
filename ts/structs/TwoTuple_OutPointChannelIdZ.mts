 ...
 * A Tuple
 */
export class TwoTuple_OutPointChannelIdZ extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.C2Tuple_OutPointChannelIdZ_free);
	}
	...
	public get_a(): OutPoint {
		const ret: bigint = bindings.C2Tuple_OutPointChannelIdZ_get_a(this.ptr);
	...
	public get_b(): ChannelId {
		const ret: bigint = bindings.C2Tuple_OutPointChannelIdZ_get_b(this.ptr);
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.C2Tuple_OutPointChannelIdZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): TwoTuple_OutPointChannelIdZ {
		const ret: bigint = bindings.C2Tuple_OutPointChannelIdZ_clone(this.ptr);
		const ret_hu_conv: TwoTuple_OutPointChannelIdZ = new TwoTuple_OutPointChannelIdZ(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_new(a: OutPoint, b: ChannelId): TwoTuple_OutPointChannelIdZ {
		const ret: bigint = bindings.C2Tuple_OutPointChannelIdZ_new(CommonBase.get_ptr_of(a), CommonBase.get_ptr_of(b));
		const ret_hu_conv: TwoTuple_OutPointChannelIdZ = new TwoTuple_OutPointChannelIdZ(null, ret);
