...
export class InvoiceRequestFeatures extends CommonBase {
	...
	public eq(b: InvoiceRequestFeatures): boolean {
		const ret: boolean = bindings.InvoiceRequestFeatures_eq(this.ptr, CommonBase.get_ptr_of(b));
	 ...
	 */
	public required_unknown_bits_from(other: InvoiceRequestFeatures): bigint[] {
