...
export class ProbabilisticScorer extends CommonBase {
	...
	public historical_estimated_payment_success_probability(scid: bigint, target: NodeId, amount_msat: bigint, params: ProbabilisticScoringFeeParameters): Option_f64Z {
		const ret: bigint = bindings.ProbabilisticScorer_historical_estimated_payment_success_probability(this.ptr, scid, CommonBase.get_ptr_of(target), amount_msat, CommonBase.get_ptr_of(params));
