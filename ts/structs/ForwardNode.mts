...
export class ForwardNode extends CommonBase {
	...
	public set_tlvs(val: ForwardTlvs): void {
		bindings.ForwardNode_set_tlvs(this.ptr, CommonBase.get_ptr_of(val));
	...
	public static constructor_new(tlvs_arg: ForwardTlvs, node_id_arg: Uint8Array, htlc_maximum_msat_arg: bigint): ForwardNode {
		const ret: bigint = bindings.ForwardNode_new(CommonBase.get_ptr_of(tlvs_arg), bindings.encodeUint8Array(bindings.check_arr_len(node_id_arg, 33)), htlc_maximum_msat_arg);
