...
export class NodeAnnouncementInfo extends CommonBase {
	...
	public set_features(val: NodeFeatures): void {
		bindings.NodeAnnouncementInfo_set_features(this.ptr, CommonBase.get_ptr_of(val));
	...
	public set_alias(val: NodeAlias): void {
		bindings.NodeAnnouncementInfo_set_alias(this.ptr, CommonBase.get_ptr_of(val));
		CommonBase.add_ref_from(this, val);
	}
	...
	public static constructor_new(features_arg: NodeFeatures, last_update_arg: number, rgb_arg: Uint8Array, alias_arg: NodeAlias, announcement_message_arg: NodeAnnouncement|null): NodeAnnouncementInfo {
		const ret: bigint = bindings.NodeAnnouncementInfo_new(CommonBase.get_ptr_of(features_arg), last_update_arg, bindings.encodeUint8Array(bindings.check_arr_len(rgb_arg, 3)), CommonBase.get_ptr_of(alias_arg), announcement_message_arg == null ? 0n : CommonBase.get_ptr_of(announcement_message_arg));
