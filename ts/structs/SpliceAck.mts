...
export class SpliceAck extends CommonBase {
	 ...
	 */
	public static constructor_new(channel_id_arg: ChannelId, chain_hash_arg: Uint8Array, relative_satoshis_arg: bigint, funding_pubkey_arg: Uint8Array): SpliceAck {
		const ret: bigint = bindings.SpliceAck_new(CommonBase.get_ptr_of(channel_id_arg), bindings.encodeUint8Array(bindings.check_arr_len(chain_hash_arg, 32)), relative_satoshis_arg, bindings.encodeUint8Array(bindings.check_arr_len(funding_pubkey_arg, 33)));
