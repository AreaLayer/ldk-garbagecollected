...
export class Verification extends CommonBase {
	...
	public verify_for_offer_payment(hmac: Uint8Array, nonce: Nonce, expanded_key: ExpandedKey): Result_NoneNoneZ {
		const ret: bigint = bindings.Verification_verify_for_offer_payment(this.ptr, bindings.encodeUint8Array(bindings.check_arr_len(hmac, 32)), CommonBase.get_ptr_of(nonce), CommonBase.get_ptr_of(expanded_key));
