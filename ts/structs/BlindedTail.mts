...
export class BlindedTail extends CommonBase {
	...
	public static constructor_new(hops_arg: BlindedHop[], blinding_point_arg: Uint8Array, excess_final_cltv_expiry_delta_arg: number, final_value_msat_arg: bigint): BlindedTail {
		const ret: bigint = bindings.BlindedTail_new(bindings.encodeUint64Array(hops_arg.map(hops_arg_conv_12 => CommonBase.get_ptr_of(hops_arg_conv_12))), bindings.encodeUint8Array(blinding_point_arg), excess_final_cltv_expiry_delta_arg, final_value_msat_arg);
