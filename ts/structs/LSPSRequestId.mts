 ...
 * more information.
 */
export class LSPSRequestId extends CommonBase {
	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.LSPSRequestId_free);
	}

	public get_a(): string {
		const ret: number = bindings.LSPSRequestId_get_a(this.ptr);
		const ret_conv: string = bindings.decodeString(ret);
		return ret_conv;
	}

	public set_a(val: string): void {
		bindings.LSPSRequestId_set_a(this.ptr, bindings.encodeString(val));
	}

	/**
	 * Constructs a new LSPSRequestId given each field
	 */
	public static constructor_new(a_arg: string): LSPSRequestId {
		const ret: bigint = bindings.LSPSRequestId_new(bindings.encodeString(a_arg));
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPSRequestId_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPSRequestId {
		const ret: bigint = bindings.LSPSRequestId_clone(this.ptr);
		const ret_hu_conv: LSPSRequestId = new LSPSRequestId(null, ret);
	 ...
	 */
	public eq(b: LSPSRequestId): boolean {
		const ret: boolean = bindings.LSPSRequestId_eq(this.ptr, CommonBase.get_ptr_of(b));
	 ...
	 */
	public hash(): bigint {
		const ret: bigint = bindings.LSPSRequestId_hash(this.ptr);
		return ret;
	}
