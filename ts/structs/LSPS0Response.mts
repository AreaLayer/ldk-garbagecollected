 ...
 */
export class LSPS0Response extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.LSPS0Response_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): LSPS0Response {
		const raw_ty: number = bindings.LDKLSPS0Response_ty_from_ptr(ptr);
		switch (raw_ty) {
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS0Response_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS0Response {
		const ret: bigint = bindings.LSPS0Response_clone(this.ptr);
		const ret_hu_conv: LSPS0Response = LSPS0Response.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_list_protocols(a: LSPS0ListProtocolsResponse): LSPS0Response {
		const ret: bigint = bindings.LSPS0Response_list_protocols(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS0Response = LSPS0Response.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_list_protocols_error(a: LSPSResponseError): LSPS0Response {
		const ret: bigint = bindings.LSPS0Response_list_protocols_error(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS0Response = LSPS0Response.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS0Response): boolean {
		const ret: boolean = bindings.LSPS0Response_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}

}
/** A LSPS0Response of type ListProtocols */
export class LSPS0Response_ListProtocols extends LSPS0Response {
	public list_protocols: LSPS0ListProtocolsResponse;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const list_protocols: bigint = bindings.LDKLSPS0Response_ListProtocols_get_list_protocols(ptr);
		const list_protocols_hu_conv: LSPS0ListProtocolsResponse = new LSPS0ListProtocolsResponse(null, list_protocols);
...
export class LSPS0Response_ListProtocolsError extends LSPS0Response {
	public list_protocols_error: LSPSResponseError;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const list_protocols_error: bigint = bindings.LDKLSPS0Response_ListProtocolsError_get_list_protocols_error(ptr);
		const list_protocols_error_hu_conv: LSPSResponseError = new LSPSResponseError(null, list_protocols_error);
			CommonBase.add_ref_from(list_protocols_error_hu_conv, this);
