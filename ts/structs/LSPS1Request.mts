 ...
 */
export class LSPS1Request extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) { super(ptr, bindings.LSPS1Request_free); }
	/* @internal */
	public static constr_from_ptr(ptr: bigint): LSPS1Request {
		const raw_ty: number = bindings.LDKLSPS1Request_ty_from_ptr(ptr);
		switch (raw_ty) {
	...
	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPS1Request_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPS1Request {
		const ret: bigint = bindings.LSPS1Request_clone(this.ptr);
		const ret_hu_conv: LSPS1Request = LSPS1Request.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_get_info(a: LSPS1GetInfoRequest): LSPS1Request {
		const ret: bigint = bindings.LSPS1Request_get_info(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS1Request = LSPS1Request.constr_from_ptr(ret);
	 ...
	 */
	public static constructor_create_order(a: LSPS1CreateOrderRequest): LSPS1Request {
		const ret: bigint = bindings.LSPS1Request_create_order(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS1Request = LSPS1Request.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_get_order(a: LSPS1GetOrderRequest): LSPS1Request {
		const ret: bigint = bindings.LSPS1Request_get_order(CommonBase.get_ptr_of(a));
		const ret_hu_conv: LSPS1Request = LSPS1Request.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPS1Request): boolean {
		const ret: boolean = bindings.LSPS1Request_eq(this.ptr, CommonBase.get_ptr_of(b));
		return ret;
	}

}
/** A LSPS1Request of type GetInfo */
export class LSPS1Request_GetInfo extends LSPS1Request {
	public get_info: LSPS1GetInfoRequest;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const get_info: bigint = bindings.LDKLSPS1Request_GetInfo_get_get_info(ptr);
		const get_info_hu_conv: LSPS1GetInfoRequest = new LSPS1GetInfoRequest(null, get_info);
			CommonBase.add_ref_from(get_info_hu_conv, this);
		this.get_info = get_info_hu_conv;
	}
}
/** A LSPS1Request of type CreateOrder */
export class LSPS1Request_CreateOrder extends LSPS1Request {
	public create_order: LSPS1CreateOrderRequest;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const create_order: bigint = bindings.LDKLSPS1Request_CreateOrder_get_create_order(ptr);
		const create_order_hu_conv: LSPS1CreateOrderRequest = new LSPS1CreateOrderRequest(null, create_order);
			CommonBase.add_ref_from(create_order_hu_conv, this);
		this.create_order = create_order_hu_conv;
	}
}
/** A LSPS1Request of type GetOrder */
export class LSPS1Request_GetOrder extends LSPS1Request {
	public get_order: LSPS1GetOrderRequest;
	/* @internal */
	public constructor(ptr: bigint) {
		super(null, ptr);
		const get_order: bigint = bindings.LDKLSPS1Request_GetOrder_get_get_order(ptr);
		const get_order_hu_conv: LSPS1GetOrderRequest = new LSPS1GetOrderRequest(null, get_order);
