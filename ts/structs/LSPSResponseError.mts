...
export class LSPSResponseError extends CommonBase {
	...
	public get_message(): string {
		const ret: number = bindings.LSPSResponseError_get_message(this.ptr);
	 ...
	 * A string providing a short description of the error.
	 */
	public set_message(val: string): void {
	 ...
	 */
	public get_data(): Option_StrZ {
		const ret: bigint = bindings.LSPSResponseError_get_data(this.ptr);
	 ...
	 * A primitive or structured value that contains additional information about the error.
	 */
	public set_data(val: Option_StrZ): void {
		bindings.LSPSResponseError_set_data(this.ptr, CommonBase.get_ptr_of(val));
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.LSPSResponseError_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): LSPSResponseError {
		const ret: bigint = bindings.LSPSResponseError_clone(this.ptr);
		const ret_hu_conv: LSPSResponseError = new LSPSResponseError(null, ret);
		CommonBase.add_ref_from(ret_hu_conv, this);
		return ret_hu_conv;
	}
	 ...
	 */
	public eq(b: LSPSResponseError): boolean {
		const ret: boolean = bindings.LSPSResponseError_eq(this.ptr, CommonBase.get_ptr_of(b));
