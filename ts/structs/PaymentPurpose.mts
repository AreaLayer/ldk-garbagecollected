...
export class PaymentPurpose extends CommonBase {
	...
	public static constructor_bolt11_invoice_payment(payment_preimage: Option_ThirtyTwoBytesZ, payment_secret: Uint8Array): PaymentPurpose {
		const ret: bigint = bindings.PaymentPurpose_bolt11_invoice_payment(CommonBase.get_ptr_of(payment_preimage), bindings.encodeUint8Array(bindings.check_arr_len(payment_secret, 32)));
		const ret_hu_conv: PaymentPurpose = PaymentPurpose.constr_from_ptr(ret);
	...
	public static constructor_bolt12_offer_payment(payment_preimage: Option_ThirtyTwoBytesZ, payment_secret: Uint8Array, payment_context: Bolt12OfferContext): PaymentPurpose {
		const ret: bigint = bindings.PaymentPurpose_bolt12_offer_payment(CommonBase.get_ptr_of(payment_preimage), bindings.encodeUint8Array(bindings.check_arr_len(payment_secret, 32)), CommonBase.get_ptr_of(payment_context));
		const ret_hu_conv: PaymentPurpose = PaymentPurpose.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, payment_preimage);
		CommonBase.add_ref_from(ret_hu_conv, payment_context);
		return ret_hu_conv;
	}
	...
	public static constructor_bolt12_refund_payment(payment_preimage: Option_ThirtyTwoBytesZ, payment_secret: Uint8Array, payment_context: Bolt12RefundContext): PaymentPurpose {
		const ret: bigint = bindings.PaymentPurpose_bolt12_refund_payment(CommonBase.get_ptr_of(payment_preimage), bindings.encodeUint8Array(bindings.check_arr_len(payment_secret, 32)), CommonBase.get_ptr_of(payment_context));
		const ret_hu_conv: PaymentPurpose = PaymentPurpose.constr_from_ptr(ret);
		CommonBase.add_ref_from(ret_hu_conv, ret_hu_conv);
		CommonBase.add_ref_from(ret_hu_conv, payment_preimage);
		CommonBase.add_ref_from(ret_hu_conv, payment_context);
