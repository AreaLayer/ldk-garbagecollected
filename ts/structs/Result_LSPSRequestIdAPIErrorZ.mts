...
export class Result_LSPSRequestIdAPIErrorZ extends CommonBase {
	protected constructor(_dummy: null, ptr: bigint) {
		super(ptr, bindings.CResult_LSPSRequestIdAPIErrorZ_free);
	}
	/* @internal */
	public static constr_from_ptr(ptr: bigint): Result_LSPSRequestIdAPIErrorZ {
	 ...
	 */
	public static constructor_ok(o: LSPSRequestId): Result_LSPSRequestIdAPIErrorZ {
		const ret: bigint = bindings.CResult_LSPSRequestIdAPIErrorZ_ok(CommonBase.get_ptr_of(o));
		const ret_hu_conv: Result_LSPSRequestIdAPIErrorZ = Result_LSPSRequestIdAPIErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	 ...
	 */
	public static constructor_err(e: APIError): Result_LSPSRequestIdAPIErrorZ {
		const ret: bigint = bindings.CResult_LSPSRequestIdAPIErrorZ_err(CommonBase.get_ptr_of(e));
		const ret_hu_conv: Result_LSPSRequestIdAPIErrorZ = Result_LSPSRequestIdAPIErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	...
	public is_ok(): boolean {
		const ret: boolean = bindings.CResult_LSPSRequestIdAPIErrorZ_is_ok(this.ptr);
		return ret;
	}

	public clone_ptr(): bigint {
		const ret: bigint = bindings.CResult_LSPSRequestIdAPIErrorZ_clone_ptr(this.ptr);
		return ret;
	}
	 ...
	 */
	public clone(): Result_LSPSRequestIdAPIErrorZ {
		const ret: bigint = bindings.CResult_LSPSRequestIdAPIErrorZ_clone(this.ptr);
		const ret_hu_conv: Result_LSPSRequestIdAPIErrorZ = Result_LSPSRequestIdAPIErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}

}
export class Result_LSPSRequestIdAPIErrorZ_OK extends Result_LSPSRequestIdAPIErrorZ {
	public res: LSPSRequestId;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const res: bigint = bindings.CResult_LSPSRequestIdAPIErrorZ_get_ok(ptr);
		const res_hu_conv: LSPSRequestId = new LSPSRequestId(null, res);
		CommonBase.add_ref_from(res_hu_conv, this);
		this.res = res_hu_conv;
	}
}
export class Result_LSPSRequestIdAPIErrorZ_Err extends Result_LSPSRequestIdAPIErrorZ {
	public err: APIError;

	/* @internal */
	public constructor(_dummy: null, ptr: bigint) {
		super(_dummy, ptr);
		const err: bigint = bindings.CResult_LSPSRequestIdAPIErrorZ_get_err(ptr);
