 ...
 */
public class LSPS1Message : CommonBase {
	protected LSPS1Message(object _dummy, long ptr) : base(ptr) { }
	~LSPS1Message() {
		if (ptr != 0) { bindings.LSPS1Message_free(ptr); }
	}

	internal static LSPS1Message constr_from_ptr(long ptr) {
		long raw_ty = bindings.LDKLSPS1Message_ty_from_ptr(ptr);
		switch (raw_ty) {
	...
	public class LSPS1Message_Request : LSPS1Message {
		public org.ldk.structs.LSPSRequestId _0;
		public org.ldk.structs.LSPS1Request _1;
		internal LSPS1Message_Request(long ptr) : base(null, ptr) {
			long _0 = bindings.LDKLSPS1Message_Request_get__0(ptr);
			...
			this._0 = _0_hu_conv;
			long _1 = bindings.LDKLSPS1Message_Request_get__1(ptr);
	...
	public class LSPS1Message_Response : LSPS1Message {
		public org.ldk.structs.LSPSRequestId _0;
		public org.ldk.structs.LSPS1Response _1;
		internal LSPS1Message_Response(long ptr) : base(null, ptr) {
			long _0 = bindings.LDKLSPS1Message_Response_get__0(ptr);
			org.ldk.structs.LSPSRequestId _0_hu_conv = null; if (_0 < 0 || _0 > 4096) { _0_hu_conv = new org.ldk.structs.LSPSRequestId(null, _0); }
			if (_0_hu_conv != null) { _0_hu_conv.ptrs_to.AddLast(this); };
			this._0 = _0_hu_conv;
			long _1 = bindings.LDKLSPS1Message_Response_get__1(ptr);
	 ...
	 */
	public org.ldk.structs.LSPS1Message clone() {
	 ...
	 */
	public static org.ldk.structs.LSPS1Message request(org.ldk.structs.LSPSRequestId a, org.ldk.structs.LSPS1Request b) {
	 ...
	 */
	public static org.ldk.structs.LSPS1Message response(org.ldk.structs.LSPSRequestId a, org.ldk.structs.LSPS1Response b) {
	 ...
	 */
	public bool eq(org.ldk.structs.LSPS1Message b) {
		bool ret = bindings.LSPS1Message_eq(this.ptr, b.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(b);
		return ret;
	}
	...
	public override bool Equals(object o) {
		if (!(o is LSPS1Message)) return false;
