 ...
 */
public class LSPS1GetInfoResponse : CommonBase {
	internal LSPS1GetInfoResponse(object _dummy, long ptr) : base(ptr) { }
	 ...
	 */
	public org.ldk.structs.LSPS1Options get_options() {
	 ...
	 */
	public static org.ldk.structs.LSPS1GetInfoResponse of(org.ldk.structs.LSPS1Options options_arg) {
		long ret = bindings.LSPS1GetInfoResponse_new(options_arg.ptr);
		GC.KeepAlive(options_arg);
		if (ret >= 0 && ret <= 4096) { return null; }
	 ...
	 */
	public org.ldk.structs.LSPS1GetInfoResponse clone() {
	 ...
	 */
	public bool eq(org.ldk.structs.LSPS1GetInfoResponse b) {
		bool ret = bindings.LSPS1GetInfoResponse_eq(this.ptr, b.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(b);
	...
	public override bool Equals(object o) {
		if (!(o is LSPS1GetInfoResponse)) return false;
