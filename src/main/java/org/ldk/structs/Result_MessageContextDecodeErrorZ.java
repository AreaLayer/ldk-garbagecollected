...
public class Result_MessageContextDecodeErrorZ extends CommonBase {
	private Result_MessageContextDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	protected void finalize() throws Throwable {
		if (ptr != 0) { bindings.CResult_MessageContextDecodeErrorZ_free(ptr); } super.finalize();
	}

	protected void force_free() {
		if (ptr != 0) { bindings.CResult_MessageContextDecodeErrorZ_free(ptr); ptr = 0; }
	}

	static Result_MessageContextDecodeErrorZ constr_from_ptr(long ptr) {
	...
	public static final class Result_MessageContextDecodeErrorZ_OK extends Result_MessageContextDecodeErrorZ {
		public final MessageContext res;
		private Result_MessageContextDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_MessageContextDecodeErrorZ_Err extends Result_MessageContextDecodeErrorZ {
		public final DecodeError err;
		private Result_MessageContextDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_MessageContextDecodeErrorZ_is_ok(this.ptr);
