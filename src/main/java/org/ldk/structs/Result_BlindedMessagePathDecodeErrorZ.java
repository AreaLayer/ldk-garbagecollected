...
public class Result_BlindedMessagePathDecodeErrorZ extends CommonBase {
	private Result_BlindedMessagePathDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	protected void finalize() throws Throwable {
		if (ptr != 0) { bindings.CResult_BlindedMessagePathDecodeErrorZ_free(ptr); } super.finalize();
	}

	protected void force_free() {
		if (ptr != 0) { bindings.CResult_BlindedMessagePathDecodeErrorZ_free(ptr); ptr = 0; }
	}

	static Result_BlindedMessagePathDecodeErrorZ constr_from_ptr(long ptr) {
	...
	public static final class Result_BlindedMessagePathDecodeErrorZ_OK extends Result_BlindedMessagePathDecodeErrorZ {
		public final BlindedMessagePath res;
		private Result_BlindedMessagePathDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_BlindedMessagePathDecodeErrorZ_Err extends Result_BlindedMessagePathDecodeErrorZ {
		public final DecodeError err;
		private Result_BlindedMessagePathDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_BlindedMessagePathDecodeErrorZ_is_ok(this.ptr);
