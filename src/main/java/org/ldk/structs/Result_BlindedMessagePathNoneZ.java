...
public class Result_BlindedMessagePathNoneZ extends CommonBase {
	private Result_BlindedMessagePathNoneZ(Object _dummy, long ptr) { super(ptr); }
	protected void finalize() throws Throwable {
		if (ptr != 0) { bindings.CResult_BlindedMessagePathNoneZ_free(ptr); } super.finalize();
	}

	protected void force_free() {
		if (ptr != 0) { bindings.CResult_BlindedMessagePathNoneZ_free(ptr); ptr = 0; }
	}

	static Result_BlindedMessagePathNoneZ constr_from_ptr(long ptr) {
	...
	public static final class Result_BlindedMessagePathNoneZ_OK extends Result_BlindedMessagePathNoneZ {
		...
		private Result_BlindedMessagePathNoneZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_BlindedMessagePathNoneZ_Err extends Result_BlindedMessagePathNoneZ {
		private Result_BlindedMessagePathNoneZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
		}
	}
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_BlindedMessagePathNoneZ_is_ok(this.ptr);
