...
public class Result_HeldHtlcAvailableDecodeErrorZ extends CommonBase {
	private Result_HeldHtlcAvailableDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	protected void finalize() throws Throwable {
		if (ptr != 0) { bindings.CResult_HeldHtlcAvailableDecodeErrorZ_free(ptr); } super.finalize();
	}

	protected void force_free() {
		if (ptr != 0) { bindings.CResult_HeldHtlcAvailableDecodeErrorZ_free(ptr); ptr = 0; }
	}

	static Result_HeldHtlcAvailableDecodeErrorZ constr_from_ptr(long ptr) {
	...
	public static final class Result_HeldHtlcAvailableDecodeErrorZ_OK extends Result_HeldHtlcAvailableDecodeErrorZ {
		public final HeldHtlcAvailable res;
		private Result_HeldHtlcAvailableDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_HeldHtlcAvailableDecodeErrorZ_Err extends Result_HeldHtlcAvailableDecodeErrorZ {
		public final DecodeError err;
		private Result_HeldHtlcAvailableDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_HeldHtlcAvailableDecodeErrorZ_is_ok(this.ptr);
