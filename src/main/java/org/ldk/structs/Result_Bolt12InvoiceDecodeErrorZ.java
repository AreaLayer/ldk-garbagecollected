...
public class Result_Bolt12InvoiceDecodeErrorZ extends CommonBase {
	private Result_Bolt12InvoiceDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	protected void finalize() throws Throwable {
		if (ptr != 0) { bindings.CResult_Bolt12InvoiceDecodeErrorZ_free(ptr); } super.finalize();
	}

	protected void force_free() {
		if (ptr != 0) { bindings.CResult_Bolt12InvoiceDecodeErrorZ_free(ptr); ptr = 0; }
	}

	static Result_Bolt12InvoiceDecodeErrorZ constr_from_ptr(long ptr) {
	...
	public static final class Result_Bolt12InvoiceDecodeErrorZ_OK extends Result_Bolt12InvoiceDecodeErrorZ {
		public final Bolt12Invoice res;
		private Result_Bolt12InvoiceDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_Bolt12InvoiceDecodeErrorZ_Err extends Result_Bolt12InvoiceDecodeErrorZ {
		public final DecodeError err;
		private Result_Bolt12InvoiceDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_Bolt12InvoiceDecodeErrorZ_is_ok(this.ptr);
