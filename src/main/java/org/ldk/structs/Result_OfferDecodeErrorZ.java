...
public class Result_OfferDecodeErrorZ extends CommonBase {
	private Result_OfferDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	protected void finalize() throws Throwable {
		if (ptr != 0) { bindings.CResult_OfferDecodeErrorZ_free(ptr); } super.finalize();
	}

	protected void force_free() {
		if (ptr != 0) { bindings.CResult_OfferDecodeErrorZ_free(ptr); ptr = 0; }
	}

	static Result_OfferDecodeErrorZ constr_from_ptr(long ptr) {
	...
	public static final class Result_OfferDecodeErrorZ_OK extends Result_OfferDecodeErrorZ {
		public final Offer res;
		private Result_OfferDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_OfferDecodeErrorZ_Err extends Result_OfferDecodeErrorZ {
		public final DecodeError err;
		private Result_OfferDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_OfferDecodeErrorZ_is_ok(this.ptr);
