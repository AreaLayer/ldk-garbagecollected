...
public class Result_AsyncPaymentsMessageDecodeErrorZ extends CommonBase {
	private Result_AsyncPaymentsMessageDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	protected void finalize() throws Throwable {
		if (ptr != 0) { bindings.CResult_AsyncPaymentsMessageDecodeErrorZ_free(ptr); } super.finalize();
	}

	protected void force_free() {
		if (ptr != 0) { bindings.CResult_AsyncPaymentsMessageDecodeErrorZ_free(ptr); ptr = 0; }
	}

	static Result_AsyncPaymentsMessageDecodeErrorZ constr_from_ptr(long ptr) {
	...
	public static final class Result_AsyncPaymentsMessageDecodeErrorZ_OK extends Result_AsyncPaymentsMessageDecodeErrorZ {
		public final AsyncPaymentsMessage res;
		private Result_AsyncPaymentsMessageDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_AsyncPaymentsMessageDecodeErrorZ_Err extends Result_AsyncPaymentsMessageDecodeErrorZ {
		public final DecodeError err;
		private Result_AsyncPaymentsMessageDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_AsyncPaymentsMessageDecodeErrorZ_is_ok(this.ptr);
