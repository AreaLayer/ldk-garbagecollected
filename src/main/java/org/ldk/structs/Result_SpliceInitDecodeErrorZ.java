...
public class Result_SpliceInitDecodeErrorZ extends CommonBase {
	private Result_SpliceInitDecodeErrorZ(Object _dummy, long ptr) { super(ptr); }
	protected void finalize() throws Throwable {
		if (ptr != 0) { bindings.CResult_SpliceInitDecodeErrorZ_free(ptr); } super.finalize();
	}

	protected void force_free() {
		if (ptr != 0) { bindings.CResult_SpliceInitDecodeErrorZ_free(ptr); ptr = 0; }
	}

	static Result_SpliceInitDecodeErrorZ constr_from_ptr(long ptr) {
	...
	public static final class Result_SpliceInitDecodeErrorZ_OK extends Result_SpliceInitDecodeErrorZ {
		public final SpliceInit res;
		private Result_SpliceInitDecodeErrorZ_OK(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public static final class Result_SpliceInitDecodeErrorZ_Err extends Result_SpliceInitDecodeErrorZ {
		public final DecodeError err;
		private Result_SpliceInitDecodeErrorZ_Err(Object _dummy, long ptr) {
			super(_dummy, ptr);
	...
	public boolean is_ok() {
		boolean ret = bindings.CResult_SpliceInitDecodeErrorZ_is_ok(this.ptr);
